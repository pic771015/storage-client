  ...
  function($scope, taggingSvc, $modal, localData) {
    ...
    $scope.openConfirm = function () {
      var modalInstance = $modal.open({
        templateUrl: "partials/tagging/delete-confirm.html",
    ...
    $scope.tagNameOrderFunction = function(tag) {
      return tag.name && tag.name.toLowerCase();
    };

    $scope.tagValuesOrderFunction = function(tag) {
      return tag.values && tag.values.join(", ").toString();
    };

    $scope.orderByAttributeLookup = $scope.tagNameOrderFunction;
    $scope.orderByAttributeFreeform = $scope.tagNameOrderFunction;
  }]);
