...
}]),angular.module("template/modal/window.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/modal/window.html",'<div tabindex="-1" role="dialog" class="modal fade" ng-class="{in: animate}" ng-style="{\'z-index\': 1050 + index*10, display: \'block\'}" ng-click="close($event)">\n    <div class="modal-dialog" ng-class="{\'modal-sm\': size == \'sm\', \'modal-lg\': size == \'lg\'}"><div class="modal-content" modal-transclude></div></div>\n</div>')}]),angular.module("template/pagination/pager.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/pagination/pager.html",'<ul class="pager">\n  <li ng-class="{disabled: noPrevious(), previous: align}"><a href ng-click="selectPage(page - 1)">{{getText(\'previous\')}}</a></li>\n  <li ng-class="{disabled: noNext(), next: align}"><a href ng-click="selectPage(page + 1)">{{getText(\'next\')}}</a></li>\n</ul>')}]),angular.module("template/pagination/pagination.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/pagination/pagination.html",'<ul class="pagination">\n  <li ng-if="boundaryLinks" ng-class="{disabled: noPrevious()}"><a href ng-click="selectPage(1)">{{getText(\'first\')}}</a></li>\n  <li ng-if="directionLinks" ng-class="{disabled: noPrevious()}"><a href ng-click="selectPage(page - 1)">{{getText(\'previous\')}}</a></li>\n  <li ng-repeat="page in pages track by $index" ng-class="{active: page.active}"><a href ng-click="selectPage(page.number)">{{page.text}}</a></li>\n  <li ng-if="directionLinks" ng-class="{disabled: noNext()}"><a href ng-click="selectPage(page + 1)">{{getText(\'next\')}}</a></li>\n  <li ng-if="boundaryLinks" ng-class="{disabled: noNext()}"><a href ng-click="selectPage(totalPages)">{{getText(\'last\')}}</a></li>\n</ul>')}]),angular.module("template/tooltip/tooltip-html-unsafe-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tooltip/tooltip-html-unsafe-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" bind-html-unsafe="content"></div>\n</div>\n')}]),angular.module("template/tooltip/tooltip-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tooltip/tooltip-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" ng-bind="content"></div>\n</div>\n')}]),angular.module("template/popover/popover.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/popover/popover.html",'<div class="popover {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="arrow"></div>\n\n  <div class="popover-inner">\n      <h3 class="popover-title" ng-bind="title" ng-show="title"></h3>\n      <div class="popover-content" ng-bind="content"></div>\n  </div>\n</div>\n')}]),angular.module("template/progressbar/bar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/bar.html",'<div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: percent + \'%\'}" aria-valuetext="{{percent | number:0}}%" ng-transclude></div>')}]),angular.module("template/progressbar/progress.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progress.html",'<div class="progress" ng-transclude></div>')}]),angular.module("template/progressbar/progressbar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progressbar.html",'<div class="progress">\n  <div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: percent + \'%\'}" aria-valuetext="{{percent | number:0}}%" ng-transclude></div>\n</div>')}]),angular.module("template/rating/rating.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/rating/rating.html",'<span ng-mouseleave="reset()" ng-keydown="onKeydown($event)" tabindex="0" role="slider" aria-valuemin="0" aria-valuemax="{{range.length}}" aria-valuenow="{{value}}">\n    <i ng-repeat="r in range track by $index" ng-mouseenter="enter($index + 1)" ng-click="rate($index + 1)" class="glyphicon" ng-class="$index < value && (r.stateOn || \'glyphicon-star\') || (r.stateOff || \'glyphicon-star-empty\')">\n        <span class="sr-only">({{ $index < value ? \'*\' : \' \' }})</span>\n    </i>\n</span>')}]),angular.module("template/tabs/tab.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tab.html",'<li ng-class="{active: active, disabled: disabled}">\n  <a ng-click="select()" tab-heading-transclude>{{heading}}</a>\n</li>\n')}]),angular.module("template/tabs/tabset.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tabset.html",'<div>\n  <ul class="nav nav-{{type || \'tabs\'}}" ng-class="{\'nav-stacked\': vertical, \'nav-justified\': justified}" ng-transclude></ul>\n  <div class="tab-content">\n    <div class="tab-pane" \n         ng-repeat="tab in tabs" \n         ng-class="{active: tab.active}"\n         tab-content-transclude="tab">\n    </div>\n  </div>\n</div>\n')}]),angular.module("template/timepicker/timepicker.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/timepicker/timepicker.html",'<table>\n	<tbody>\n		<tr class="text-center">\n			<td><a ng-click="incrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="incrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n		<tr>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidHours}">\n				<input type="text" ng-model="hours" ng-change="updateHours()" class="form-control text-center" ng-mousewheel="incrementHours()" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td>:</td>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidMinutes}">\n				<input type="text" ng-model="minutes" ng-change="updateMinutes()" class="form-control text-center" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td ng-show="showMeridian"><button type="button" class="btn btn-default text-center" ng-click="toggleMeridian()">{{meridian}}</button></td>\n		</tr>\n		<tr class="text-center">\n			<td><a ng-click="decrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="decrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n	</tbody>\n</table>\n')}]),angular.module("template/typeahead/typeahead-match.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-match.html",'<a tabindex="-1" bind-html-unsafe="match.label | typeaheadHighlight:query"></a>')}]),angular.module("template/typeahead/typeahead-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-popup.html",'<ul class="dropdown-menu" ng-show="isOpen()" ng-style="{top: position.top+\'px\', left: position.left+\'px\'}" style="display: block;" role="listbox" aria-hidden="{{!isOpen()}}">\n    <li ng-repeat="match in matches track by $index" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)" ng-click="selectMatch($index)" role="option" id="{{match.id}}">\n        <div typeahead-match index="$index" match="match" query="query" template-url="templateUrl"></div>\n    </li>\n</ul>\n')}]),angular.module("risevision.common.i18n.config",[]).constant("LOCALES_PREFIX","locales/translation_").constant("LOCALES_SUFIX",".json"),angular.module("pascalprecht.translate").factory("$translateStaticFilesLoader",["$q","$http",function($q,$http){function loadTranslationFile(options,deferred){$http(angular.extend({url:[options.prefix,options.key.toLowerCase(),options.suffix].join(""),method:"GET",params:""},options.$http)).success(function(data){deferred.resolve(data)}).error(function(){if(options.key.indexOf("_")>=0){var key=options.key.substr(0,options.key.lastIndexOf("_")),opts=angular.extend({},options,{key:key});loadTranslationFile(opts,deferred)}else deferred.resolve("{}")})}return function(options){if(!options||!angular.isString(options.prefix)||!angular.isString(options.suffix))throw new Error('Couldn"t load static files, no prefix or suffix specified!');var deferred=$q.defer();return loadTranslationFile(options,deferred),deferred.promise}}]),angular.module("risevision.common.i18n",["pascalprecht.translate","risevision.common.i18n.config"]).config(["$translateProvider","LOCALES_PREFIX","LOCALES_SUFIX",function($translateProvider,LOCALES_PREFIX,LOCALES_SUFIX){var getLocale=function(){var nav=window.navigator;return((angular.isArray(nav.languages)?nav.languages[0]:nav.language||nav.browserLanguage||nav.systemLanguage||nav.userLanguage)||"").split("-").join("_")};$translateProvider.useStaticFilesLoader({prefix:LOCALES_PREFIX,suffix:LOCALES_SUFIX}),$translateProvider.determinePreferredLanguage(getLocale).fallbackLanguage("en")}]),angular.module("risevision.widget.common",[]),angular.module("risevision.widget.common").controller("settingsController",["$scope","settingsSaver","settingsGetter","settingsCloser",function($scope,settingsSaver,settingsGetter,settingsCloser){$scope.settings={params:{},additionalParams:{}},$scope.alerts=[],$scope.getAdditionalParam=function(name,defaultVal){var val=$scope.settings.additionalParams[name];return angular.isUndefined(val)?defaultVal:val},$scope.setAdditionalParam=function(name,val){$scope.settings.additionalParams[name]=val},$scope.loadAdditionalParams=function(){settingsGetter.getAdditionalParams().then(function(additionalParams){$scope.settings.additionalParams=additionalParams,$scope.$broadcast("loadAdditionalParams",additionalParams)},function(err){alert(err)})},$scope.setAdditionalParams=function(name,val){$scope.settings.additionalParams[name]=val},$scope.saveSettings=function(){$scope.alerts=[],$scope.$broadcast("collectAdditionalParams"),settingsSaver.saveSettings($scope.settings).then(function(){},function(err){$scope.alerts=err.alerts})},$scope.closeSettings=function(){settingsCloser.closeSettings().then(function(){},function(err){$scope.alerts=err.alerts})},$scope.settings.params=settingsGetter.getParams(),$scope.loadAdditionalParams()}]).directive("scrollOnAlerts",function(){return{restrict:"A",scope:!1,link:function($scope,$elm){$scope.$watchCollection("alerts",function(newAlerts,oldAlerts){newAlerts.length>0&&0===oldAlerts.length&&$("body").animate({scrollTop:$elm.offset().top},"fast")})}}}),angular.module("risevision.widget.common").factory("commonSettings",["$log",function($log){$log.debug("Initializing new RiseVision common settings instance...")}]),angular.module("risevision.widget.common").factory("gadgetsApi",["$window",function($window){return $window.gadgets}]),angular.module("risevision.widget.common").service("i18nLoader",["$window","$q",function($window,$q){var deferred=$q.defer();$window.i18n.init({fallbackLng:"en"},function(){deferred.resolve($window.i18n)}),this.get=function(){return deferred.promise}}]),angular.module("risevision.widget.common").service("settingsSaver",["$q","$log","gadgetsApi","settingsParser",function($q,$log,gadgetsApi,settingsParser){function processSettings(settings){var newSettings=angular.copy(settings);return delete newSettings.params.id,delete newSettings.params.companyId,delete newSettings.params.rsW,delete newSettings.params.rsH,newSettings}this.saveSettings=function(settings,validator){var deferred=$q.defer(),alerts=[],str="";settings=processSettings(settings),validator&&(alerts=validator(settings)),alerts.length>0&&($log.debug("Validation failed.",alerts),deferred.reject({alerts:alerts})),settings.params.hasOwnProperty("layoutURL")&&(str+=settings.params.layoutURL+"?",delete settings.params.layoutURL),str+=settingsParser.encodeParams(settings.params);var additionalParamsStr=settingsParser.encodeAdditionalParams(settings.additionalParams);return gadgetsApi.rpc.call("","rscmd_saveSettings",function(result){$log.debug("encoded settings",JSON.stringify(result)),$log.debug("Settings saved. ",settings),deferred.resolve(result)},{params:str,additionalParams:additionalParamsStr}),deferred.promise}}]).service("settingsGetter",["$q","gadgetsApi","$log","settingsParser","$window","defaultSettings",function($q,gadgetsApi,$log,settingsParser,$window,defaultSettings){this.getAdditionalParams=function(){var deferred=$q.defer(),defaultAdditionalParams=defaultSettings.additionalParams||{};return gadgetsApi.rpc.call("","rscmd_getAdditionalParams",function(result){result=result?settingsParser.parseAdditionalParams(result):{},$log.debug("getAdditionalParams returns ",result),deferred.resolve(angular.extend(defaultAdditionalParams,result))}),deferred.promise},this.getParams=function(){var defaultParams=defaultSettings.params||{};return angular.extend(defaultParams,settingsParser.parseParams($window.location.search))}}]).service("settingsParser",[function(){function stripPrefix(name){return 0===name.indexOf("up_")?name.slice(3):null}this.parseAdditionalParams=function(additionalParamsStr){return additionalParamsStr?JSON.parse(additionalParamsStr):{}},this.encodeAdditionalParams=function(additionalParams){return JSON.stringify(additionalParams)},this.encodeParams=function(params){var str=[];for(var p in params)if(params.hasOwnProperty(p)){var value;value="object"==typeof params[p]?JSON.stringify(params[p]):params[p],str.push("up_"+encodeURIComponent(p)+"="+encodeURIComponent(value))}return str.join("&")},this.parseParams=function(paramsStr){"?"===paramsStr[0]&&(paramsStr=paramsStr.slice(1));for(var result={},vars=paramsStr.split("&"),i=0;i<vars.length;i++){var pair=vars[i].split("="),name=stripPrefix(decodeURIComponent(pair[0]));if(name)try{result[name]=JSON.parse(decodeURIComponent(pair[1]))}catch(e){result[name]=decodeURIComponent(pair[1])}}return result}}]).service("settingsCloser",["$q","$log","gadgetsApi",function($q,$log,gadgetsApi){this.closeSettings=function(){var deferred=$q.defer();return gadgetsApi.rpc.call("","rscmd_closeSettings",function(){deferred.resolve(!0)}),deferred.promise}}]).value("defaultSettings",{}),function(angular){"use strict";angular.module("risevision.widget.common.visualization",[]).factory("visualizationApi",["$q","$window",function($q,$window){var promise,deferred=$q.defer(),factory={get:function(){return promise||(promise=deferred.promise,$window.google.visualization?deferred.resolve($window.google.visualization):$window.google.setOnLoadCallback(function(){deferred.resolve($window.google.visualization)})),promise}};return factory}])}(angular),function(){"use strict";try{angular.module("risevision.common.config")}catch(err){angular.module("risevision.common.config",[])}angular.module("risevision.common.config").value("STORE_URL","https://store.risevision.com/").value("STORE_SERVER_URL","https://store-dot-rvaserver2.appspot.com/"),angular.module("risevision.widget.common.subscription-status.config",[]).value("IN_RVA_PATH","?up_id=iframeId&parent=parentUrl#/product/productId/?inRVA&cid=companyId").value("PATH_URL","v1/company/companyId/product/status?pc=")}(),function(){"use strict";angular.module("risevision.widget.common.subscription-status",["risevision.common.config","risevision.widget.common.subscription-status.config","risevision.widget.common.subscription-status.service","risevision.widget.common","risevision.common.i18n"])}(),function(){"use strict";angular.module("risevision.widget.common.subscription-status").directive("appSubscriptionStatus",["$templateCache","subscriptionStatusService","$document","$compile",function($templateCache,subscriptionStatusService,$document,$compile){return{restrict:"AE",require:"?ngModel",scope:{productId:"@",productCode:"@",companyId:"@",productPrice:"@"},template:$templateCache.get("app-subscription-status-template.html"),link:function($scope,elm,attrs,ctrl){function checkSubscriptionStatus(){$scope.productCode&&$scope.productId&&$scope.companyId&&subscriptionStatusService.get($scope.productCode,$scope.companyId).then(function(subscriptionStatus){subscriptionStatus&&($scope.subscriptionStatus=subscriptionStatus)},function(){})}function initStoreModal(){if(!storeModalInitialized){var body=$document.find("body").eq(0),angularDomEl=angular.element("<div store-modal></div>");angularDomEl.attr({id:"store-modal",animate:"animate","show-store-modal":"showStoreModal","company-id":"{{companyId}}","product-id":"{{productId}}"});var modalDomEl=$compile(angularDomEl)($scope);body.append(modalDomEl),storeModalInitialized=!0}}var storeModalInitialized=!1;$scope.subscriptionStatus={status:"N/A",statusCode:"na",subscribed:!1,expiry:null},$scope.$watch("companyId",function(){checkSubscriptionStatus()}),ctrl&&$scope.$watch("subscriptionStatus",function(subscriptionStatus){ctrl.$setViewValue(subscriptionStatus)});var watch=$scope.$watch("showStoreModal",function(show){show&&(initStoreModal(),watch())});$scope.$on("store-dialog-save",function(){checkSubscriptionStatus()})}}}])}(),function(){"use strict";angular.module("risevision.widget.common.subscription-status").directive("storeModal",["$templateCache","$location","gadgetsApi","STORE_URL","IN_RVA_PATH",function($templateCache,$location,gadgetsApi,STORE_URL,IN_RVA_PATH){return{restrict:"AE",scope:{showStoreModal:"=",productId:"@",companyId:"@"},template:$templateCache.get("store-modal-template.html"),link:function($scope,elm){function registerRPC(){!$scope.rpcRegistered&&gadgetsApi&&($scope.rpcRegistered=!0,gadgetsApi.rpc.register("rscmd_saveSettings",saveSettings),gadgetsApi.rpc.register("rscmd_closeSettings",closeSettings),gadgetsApi.rpc.setupReceiver("store-modal-frame"))}function saveSettings(){$scope.$emit("store-dialog-save"),closeSettings()}function closeSettings(){$scope.$apply(function(){$scope.showStoreModal=!1})}var $elm=$(elm);$scope.showStoreModal=!0,$scope.$watch("showStoreModal",function(showStoreModal){if(showStoreModal){registerRPC();var url=STORE_URL+IN_RVA_PATH.replace("productId",$scope.productId).replace("companyId",$scope.companyId).replace("iframeId","store-modal-frame").replace("parentUrl",encodeURIComponent($location.$$absUrl));$elm.find("#store-modal-frame").attr("src",url)}})}}}])}(),function(){"use strict";angular.module("risevision.widget.common.subscription-status").directive("subscriptionStatus",["$templateCache","subscriptionStatusService","$document","$compile",function($templateCache,subscriptionStatusService,$document,$compile){return{restrict:"AE",require:"?ngModel",scope:{productId:"@",productCode:"@",companyId:"@",showStoreModal:"="},template:$templateCache.get("subscription-status-template.html"),link:function($scope,elm,attrs,ctrl){function checkSubscriptionStatus(){$scope.productCode&&$scope.productId&&$scope.companyId&&subscriptionStatusService.get($scope.productCode,$scope.companyId).then(function(subscriptionStatus){subscriptionStatus&&($scope.subscriptionStatus=subscriptionStatus)},function(){})}function initStoreModal(){if(!storeModalInitialized){var body=$document.find("body").eq(0),angularDomEl=angular.element("<div store-modal></div>");angularDomEl.attr({id:"store-modal",animate:"animate","show-store-modal":"showStoreModal","company-id":"{{companyId}}","product-id":"{{productId}}"});var modalDomEl=$compile(angularDomEl)($scope);body.append(modalDomEl),storeModalInitialized=!0}}var storeModalInitialized=!1;$scope.subscriptionStatus={status:"N/A",statusCode:"na",subscribed:!1,expiry:null},$scope.$watch("companyId",function(){checkSubscriptionStatus()}),ctrl&&$scope.$watch("subscriptionStatus",function(subscriptionStatus){ctrl.$setViewValue(subscriptionStatus)});var watch=$scope.$watch("showStoreModal",function(show){show&&(initStoreModal(),watch())});$scope.$on("store-dialog-save",function(){checkSubscriptionStatus()})}}}])}(),angular.module("risevision.widget.common.subscription-status").filter("productTrialDaysToExpiry",["$interpolate","$translate",function($interpolate,$translate){var expiresToday=null,expiresIn=null;return $translate(["subscription-status.expires-today","subscription-status.expires-in"],{days:"{{days}}"}).then(function(values){expiresToday=$interpolate(values["subscription-status.expires-today"]),expiresIn=$interpolate(values["subscription-status.expires-in"])}),function(subscriptionExpiry){var msg="";try{var oneDay=864e5,timeInMs=new Date(subscriptionExpiry).getTime()-(new Date).getTime(),days=Math.floor(timeInMs/oneDay),params={days:days};msg=0===days?null!==expiresToday?expiresToday(params):"":days>0?null!==expiresIn?expiresIn(params):"":null!==expiresToday?expiresToday(params):""}catch(e){msg=null!==expiresToday?expiresToday(params):""}return msg}}]),function(){"use strict";angular.module("risevision.widget.common.subscription-status.service",["risevision.common.config","risevision.widget.common.subscription-status.config"]).service("subscriptionStatusService",["$http","$q","STORE_SERVER_URL","PATH_URL",function($http,$q,STORE_SERVER_URL,PATH_URL){var responseType=["On Trial","Trial Expired","Subscribed","Suspended","Cancelled","Free","Not Subscribed","Product Not Found","Company Not Found","Error"],responseCode=["on-trial","trial-expired","subscribed","suspended","cancelled","free","not-subscribed","product-not-found","company-not-found","error"];this.get=function(productCode,companyId){var deferred=$q.defer(),url=STORE_SERVER_URL+PATH_URL.replace("companyId",companyId)+productCode;return $http.get(url).then(function(response){if(response&&response.data&&response.data.length){var subscriptionStatus=response.data[0],statusIndex=responseType.indexOf(subscriptionStatus.status);statusIndex>=0&&(subscriptionStatus.statusCode=responseCode[statusIndex]),""===subscriptionStatus.status?(subscriptionStatus.status="N/A",subscriptionStatus.statusCode="na",subscriptionStatus.subscribed=!1):subscriptionStatus.subscribed=subscriptionStatus.status===responseType[0]||subscriptionStatus.status===responseType[2]||subscriptionStatus.status===responseType[5]?!0:!1,"not-subscribed"===subscriptionStatus.statusCode&&subscriptionStatus.trialPeriod&&subscriptionStatus.trialPeriod>0&&(subscriptionStatus.statusCode="trial-available",subscriptionStatus.subscribed=!0),deferred.resolve(subscriptionStatus)}else deferred.reject("No response")}),deferred.promise}}])}(),function(){try{app=angular.module("risevision.widget.common.subscription-status")}catch(err){app=angular.module("risevision.widget.common.subscription-status",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("app-subscription-status-template.html",'<a id="app-subscription-status" href=""\n  ng-click="showStoreModal = true" class="store-link">\n    <div class="rate">\n      <strong>${{productPrice}}</strong>\n    </div>\n    <div class="subscribe">\n      <strong ng-if="!subscriptionStatus.subscribed"><span translate="subscription-status.get-subscription"></span></strong>\n      <strong ng-if="subscriptionStatus.subscribed"><span translate="subscription-status.continue-to-app"></span></strong>\n    </div>\n</a>\n')}])}(),function(){try{app=angular.module("risevision.widget.common.subscription-status")}catch(err){app=angular.module("risevision.widget.common.subscription-status",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("store-modal-template.html",'<div class="widget" ng-show="showStoreModal">\n  <div class="overlay" ng-click="showStoreModal = false"></div>\n  <div class="settings-center">\n    <div class="wrapper container modal-content">\n      <iframe id="store-modal-frame" name="store-modal-frame" class="modal-content full-screen-modal">\n        \n      </iframe>\n    </div>\n  </div>\n</div>')}])}(),function(){try{app=angular.module("risevision.widget.common.subscription-status")}catch(err){app=angular.module("risevision.widget.common.subscription-status",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("subscription-status-template.html",'<h3>\n  <a href="" ng-click="showStoreModal = true;">\n      <i class="fa fa-info-circle icon-left"></i>\n  </a>\n  <span class="font-weight-normal">{{\'subscription-status.heading\' | translate}}</span>\n  <span class="hidden-xs font-weight-normal"> |</span>\n  <div class="visible-xs clearfix"></div>\n  \n  <a href="" ng-click="showStoreModal = true;">\n    <span ng-class="{\'product-trial\':subscriptionStatus.subscribed, \'product-expired\':!subscriptionStatus.subscribed}">\n        {{ \'subscription-status.\' + subscriptionStatus.statusCode | translate:subscriptionStatus }}\n        <span ng-if="subscriptionStatus.statusCode === \'on-trial\'"> - {{ subscriptionStatus.expiry | productTrialDaysToExpiry }}</span>\n    </span>\n  </a>\n</h3>')}])}(),angular.module("risevision.common.config").value("GAPI_CLIENT_ID","614513768474.apps.googleusercontent.com").value("GAPI_SCOPES","https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile").value("COOKIE_CHECK_URL","http://storage-dot-rvacore-test.appspot.com").value("STORAGE_URL","https://storage-dot-rvacore-test.appspot.com/_ah/api").value("STORAGE_API_URL","https://www.googleapis.com/download/storage/v1/b/").value("STORE_PRODUCT_CODE","b0cba08a4baa0c62b8cdc621b6f6a124f89a03db").value("STORE_PRODUCT_ID","24").value("STORAGE_CLIENT_API","https://www.googleapis.com/storage/v1/b/"),angular.module("gapi",[]).factory("gapiClientService",["$q",function($q){var svc={},defer=$q.defer();return svc.get=function(){return defer.promise},svc.fulfill=function(gapiClient){return defer.resolve(gapiClient)},svc}]),angular.module("cookieTester",[]).service("cookieTester",["$q","$document","$http","COOKIE_CHECK_URL",function($q,$document,$http,COOKIE_CHECK_URL){var svc={};return svc.status={message:"Checking local and third party cookies",passed:void 0},svc.checkCookies=function(){return $q.all([svc.checkLocalCookiePermission(),svc.checkThirdPartyCookiePermission()]).then(function(){svc.status.message="Cookie enablement verified",svc.status.passed=!0},function(){return svc.status.passed=!1,svc.status.message="Third party cookies are blocked. Check your browser settings and firewalls.",$q.reject(!1)})},svc.checkLocalCookiePermission=function(){return $document[0].cookie="rv-test-local-cookie=yes",$document[0].cookie.indexOf("rv-test-local-cookie")>-1?$q.when(!0):$q.reject(!1)},svc.checkThirdPartyCookiePermission=function(){return $http.get(COOKIE_CHECK_URL+"/createThirdPartyCookie",{withCredentials:!0}).then(function(){return $http.get(COOKIE_CHECK_URL+"/checkThirdPartyCookie",{withCredentials:!0})}).then(function(resp){return"true"===resp.data.check?!0:$q.reject()}).then(null,function(){return console.log("check third party Cookie get request failed."),$q.reject(!1)})},svc}]),angular.module("cookieTester").controller("cookieTesterController",["cookieTester",function(cookieTester){this.status=cookieTester.status}]),angular.module("gapi-auth",["risevision.common.config","gapi"]).service("OAuthAuthorizationService",["$window","$interval","$q","gapiClientService","GAPI_CLIENT_ID","GAPI_SCOPES",function($window,$interval,$q,gapiClient,GAPI_CLIENT_ID,GAPI_SCOPES){var autoRefreshHandle=null,self=this;this.authorize=function(silentCheck){var deferred=$q.defer();return gapiClient.get().then(function(){$window.gapi.auth.authorize({client_id:GAPI_CLIENT_ID,scope:GAPI_SCOPES,immediate:silentCheck},function(authResult){silentCheck&&!authResult.error&&(autoRefreshHandle=$interval(function(){$interval.cancel(autoRefreshHandle),self.authorize(!0)},33e5)),authResult.error?deferred.reject(authResult):deferred.resolve(authResult)})}),deferred.promise}}]),angular.module("medialibraryServices",["ngResource"]).factory("MediaFiles",function($resource){return $resource("/getFiles?companyId=:companyId",{},{query:{method:"GET",params:{companyId:""},isArray:!1},remove:{method:"POST",params:{companyId:""},isArray:!1}})}).factory("LocalFiles",function($resource){return $resource("/files/files.json",{},{query:{method:"GET",params:{},isArray:!0}})}),angular.module("medialibrary",["risevision.common.config","ui.router","ui.bootstrap","medialibraryFilters","medialibraryServices","gapi-auth","cookieTester","gapi-file","angularFileUpload","multi-download","risevision.widget.common.subscription-status","risevision.common.i18n"]),angular.module("medialibrary").config(["$urlRouterProvider","$stateProvider",function($urlRouterProvider,$stateProvider){$urlRouterProvider.otherwise("/files/local"),$stateProvider.state("main",{url:"/files",templateUrl:"partials/main.html"}).state("main.local",{url:"/local",templateUrl:"partials/file-items.html"}).state("main.company-root",{url:"/:companyId",templateUrl:"partials/file-items.html"}).state("main.company-folders",{url:"/:companyId/*folderPath",templateUrl:"partials/file-items.html"})}]).config(function($provide){$provide.value("FULLSCREEN",window.location.href.indexOf("storageFullscreen=true")>-1)}),angular.module("multi-download",[]).factory("DownloadService",["$timeout","$window","GAPIRequestService","$stateParams",function($timeout,$window,requestor,$stateParams){var svc={};return svc.rejectedUploads=[],svc.downloadFiles=function(files,bucketName,delay){$timeout(function(){if(0!==files.length){var file=files.shift(),fileName=file.name;if("/"!==fileName.substr(-1)){var params={companyId:$stateParams.companyId,fileName:encodeURIComponent(file.name),fileType:file.type};requestor.executeRequest("storage.getSignedDownloadURI",params).then(function(resp){if(resp.result){var header="&response-content-disposition=attachment;filename="+encodeURIComponent(file.name.replace("--TRASH--/",""));$window.location.assign(resp.message+header)}else console.log(resp.message),file.rejectedUploadMessage=resp.message,svc.rejectedUploads.push(file)})}svc.downloadFiles(files,bucketName,1e3)}},delay,!1)},svc}]),angular.module("medialibrary").controller("ModalWindowController",["$scope",function($scope){$scope.closeButtonClick=function(){gadgets.rpc.call("","rscmd_closeSettings",null)}}]).controller("CopyUrlCtrl",["$scope","$modalInstance","copyFile",function($scope,$modalInstance,copyFile){$scope.copyFile=copyFile,$scope.ok=function(){$modalInstance.close()},$scope.cancel=function(){$modalInstance.dismiss("cancel")}}]).controller("DeleteInstanceCtrl",["$scope","$modalInstance","confirmationMessage",function($scope,$modalInstance,confirmationMessage){$scope.confirmationMessage=confirmationMessage,$scope.ok=function(){$modalInstance.close()},$scope.cancel=function(){$modalInstance.dismiss("cancel")}}]).controller("NewFolderCtrl",["$scope","$modalInstance","FileListService",function($scope,$modalInstance,listSvc){$scope.duplicateFolderSpecified=!1,$scope.ok=function(){return $scope.folderName||($scope.folderName=""),$scope.folderName=$scope.folderName.replace(/\//g,""),listSvc.getFileNameIndex($scope.folderName+"/")>-1?void($scope.duplicateFolderSpecified=!0):void $modalInstance.close($scope.folderName)},$scope.cancel=function(){$modalInstance.dismiss("cancel")}}]).controller("ButtonsController",["$scope","$stateParams","$window","$modal","$log","$timeout","$filter","FileListService","GAPIRequestService","STORAGE_API_URL","DownloadService","$q","$translate","$state","STORAGE_CLIENT_API","FULLSCREEN",function($scope,$stateParams,$window,$modal,$log,$timeout,$filter,listSvc,requestSvc,STORAGE_API_URL,downloadSvc,$q,$translate,$state,STORAGE_CLIENT_API,FULLSCREEN){function getSelectedFiles(){for(var selectedFiles=[],i=0;i<$scope.filesDetails.files.length;++i)$scope.filesDetails.files[i].isChecked&&selectedFiles.push($scope.filesDetails.files[i]);
return selectedFiles}function getActivePendingOperations(){for(var ops=$scope.pendingOperations,activeOps=[],i=0;i<ops.length;i++)ops[i].failed||activeOps.push(ops[i]);return activeOps}$scope.storageModal=$window.location.href.indexOf("storage-modal.html")>-1;var bucketName="risemedialibrary-"+$stateParams.companyId,bucketUrl=STORAGE_API_URL+bucketName+"/",folderSelfLinkUrl=STORAGE_CLIENT_API+bucketName+"/o?prefix=";$scope.storageModal=$window.location.href.indexOf("storage-modal.html")>-1,$scope.storageFull=FULLSCREEN,$scope.showCloseButton=!$scope.storageFull,$scope.filesDetails=listSvc.filesDetails,$scope.fileListStatus=listSvc.statusDetails,$scope.statusDetails={code:200,message:""},$scope.isPOCollapsed=!0,$scope.pendingOperations=[],$scope.leavePageMessage="",$scope.rejectedUploads=downloadSvc.rejectedUploads,$scope.isRUCollapsed=!1,$translate("storage-client.pending-ops-leave-page").then(function(value){$scope.leavePageMessage=value}),$window.addEventListener("beforeunload",function(e){return getActivePendingOperations().length>0?((e||window.event).returnValue=$scope.leavePageMessage,$scope.leavePageMessage):void 0}),$scope.isTrashFolder=function(){return $scope.fileListStatus.folder&&0===$scope.fileListStatus.folder.indexOf("--TRASH--/")},$scope.showYourFiles=function(){$state.go("main.company-folders",{folderPath:"",companyId:$stateParams.companyId})},$scope.showTrash=function(){$state.go("main.company-folders",{folderPath:"--TRASH--/",companyId:$stateParams.companyId})},$scope.resetStatus=function(){$scope.statusDetails.code=200},$("#deleteForm").submit(function(event){event.preventDefault(),$scope.deleteButtonClick()}),$scope.cancelButtonClick=function(){console.log("Cancel selected: Posting close message"),$window.parent.postMessage("close","*")},$scope.uploadButtonClick=function(){$("#file").click()},$scope.downloadButtonClick=function(){listSvc.filesDetails.files.forEach(function(file){"/"===file.name.substr(-1)&&(file.isChecked=!1)}),downloadSvc.downloadFiles(getSelectedFiles(),bucketName,100)},$scope.deleteButtonClick=function(size){$scope.confirmDeleteFilesAction(size)},$scope.trashButtonClick=function(){$scope.processFilesAction("trash")},$scope.restoreButtonClick=function(){$scope.processFilesAction("restore")},$scope.removePendingOperation=function(file){var position=$scope.pendingOperations.indexOf(file);position>=0&&$scope.pendingOperations.splice(position,1)},$scope.removeRejectedDownload=function(file){var position=$scope.rejectedUploads.indexOf(file);position>=0&&$scope.rejectedUploads.splice(position,1)},$scope.selectButtonClick=function(){var fileUrls=[],data={};data.params=[],getSelectedFiles().forEach(function(file){var copyUrl="folder"===file.kind?folderSelfLinkUrl+encodeURIComponent(file.name):bucketUrl+"o/"+encodeURIComponent(file.name)+"?&alt=media";fileUrls.push(copyUrl),data.params.push(copyUrl)}),$window.parent.postMessage(fileUrls,"*"),gadgets.rpc.call("","rscmd_saveSettings",null,data)},$scope.copyUrlButtonClick=function(size){var copyFile=getSelectedFiles()[0],modalInstance=$modal.open({templateUrl:"copyUrl.html",controller:"CopyUrlCtrl",size:size,resolve:{copyFile:function(){return copyFile}}});modalInstance.opened.then(function(){setTimeout(function(){var copyUrl="folder"===copyFile.kind?folderSelfLinkUrl+encodeURIComponent(copyFile.name):bucketUrl+"o/"+encodeURIComponent(copyFile.name)+"?&alt=media";$("#copyUrlInput").val(copyUrl),$("#copyUrlInput").focus(function(){$(this).select()}),$("#copyUrlInput").focus()},0)}),modalInstance.result.then(function(){},function(){$log.info("Modal dismissed at: "+new Date)})},$scope.confirmDeleteFilesAction=function(){$scope.shouldBeOpen=!0;var message,selectedFileNames=getSelectedFiles().map(function(file){return file.name}),filesSelected=!1,foldersSelected=!1;selectedFileNames.forEach(function(val){"/"===val.substr(-1)?foldersSelected=!0:filesSelected=!0}),message=filesSelected&&foldersSelected?"delete-files-folders":foldersSelected?"delete-folders":"delete-files",message="storage-client."+message+"-"+(1===selectedFileNames.length?"singular":"plural"),$translate(message,{count:selectedFileNames.length}).then(function(confirmationMessage){$scope.modalInstance=$modal.open({templateUrl:"deleteModal.html",controller:"DeleteInstanceCtrl",windowClass:"modal-custom",resolve:{confirmationMessage:function(){return confirmationMessage}}}),$scope.modalInstance.result.then(function(){$scope.processFilesAction("delete")},function(){$log.info("Modal dismissed at: "+new Date),$scope.shouldBeOpen=!1})})},$scope.processFilesAction=function(action){var selectedFiles=getSelectedFiles(),selectedFileNames=selectedFiles.map(function(file){return file.name});selectedFiles.forEach(function(file){file.action=action,$scope.pendingOperations.push(file)}),listSvc.removeFiles(selectedFiles),listSvc.resetSelections(),$scope.isPOCollapsed=!0;var apiMethod="storage.files.delete";"trash"===action?apiMethod="storage.trash.move":"restore"===action&&(apiMethod="storage.trash.restore");var requestParams={companyId:$stateParams.companyId,files:selectedFileNames};requestSvc.executeRequest(apiMethod,requestParams).then(function(resp){if(resp.result)for(var i=$scope.pendingOperations.length-1;i>=0;i--){var file=$scope.pendingOperations[i];selectedFiles.indexOf(file)>=0&&$scope.pendingOperations.splice(i,1)}else $scope.statusDetails.code=resp.code,$translate("storage-client."+resp.message,{email:resp.userEmail}).then(function(msg){$scope.statusDetails.message=msg}),selectedFiles.forEach(function(file){file.actionFailed=!0,$scope.filesDetails.files.push(file)}),listSvc.resetSelections();$scope.shouldBeOpen=!1})},$scope.newFolderButtonClick=function(size){$scope.shouldBeOpen=!0,$scope.modalInstance=$modal.open({templateUrl:"newFolderModal.html",controller:"NewFolderCtrl",size:size}),$scope.modalInstance.result.then(function(newFolderName){if(""!==newFolderName){var requestParams={companyId:$stateParams.companyId,folder:decodeURIComponent($stateParams.folderPath||"")+newFolderName};requestSvc.executeRequest("storage.createFolder",requestParams).then(function(){listSvc.refreshFilesList()})}},function(){$log.info("Modal dismissed at: "+new Date)})}}]).directive("focusMe",function($timeout){return{scope:{trigger:"@focusMe"},link:function(scope,element){scope.$watch("trigger",function(){$timeout(function(){element[0].focus()})})}}}),angular.module("medialibrary").factory("OAuthStatusService",["OAuthAuthorizationService",function(authSvc){var authPromise,service={};return service.getAuthStatus=function(){return void 0!==authPromise?authPromise:authPromise=authSvc.authorize(!0).then(function(authResult){return console.log("Application has user's oAuth permission."),authResult},function(authResult){throw console.log("Application does not have user's oAuth permission."),authResult})},service}]),angular.module("medialibrary").factory("UploadURIService",["$q","GAPIRequestService","OAuthStatusService","$stateParams","$interpolate","$translate",function($q,gapiRequestor,OAuthService,$stateParams,$interpolate,$translate){var svc={},uriFailed="storage-client.upload-uri-request-failed",uriFailedMail="storage-client.upload-uri-request-failed-mail",inactiveSubscription="storage-client.upload-inactive-subscription",verifyCompany="storage-client.upload-verify-company";return $translate([uriFailed,uriFailedMail,inactiveSubscription,verifyCompany],{email:"{{email}}"}).then(function(values){uriFailed=values[uriFailed],uriFailedMail=$interpolate(values[uriFailedMail]),inactiveSubscription=$interpolate(values[inactiveSubscription]),verifyCompany=$interpolate(values[verifyCompany])}),svc.getURI=function(file){return $stateParams.companyId&&file.name?OAuthService.getAuthStatus().then(function(){var gapiPath="storage.getResumableUploadURI",params={companyId:$stateParams.companyId,fileName:encodeURIComponent(file.name),fileType:file.type};return gapiRequestor.executeRequest(gapiPath,params)}).then(function(resp){return resp.result===!1?(resp.message="upload-inactive-subscription"===resp.message?inactiveSubscription({email:resp.userEmail}):"upload-verify-company"===resp.message?verifyCompany({email:resp.userEmail}):resp.userEmail?uriFailedMail({email:resp.userEmail}):uriFailed,$q.reject(resp.message)):resp.message}).then(null,function(resp){return $q.reject(resp||"An error ocurred attempting to begin an upload")}):$q.reject("Invalid Params")},svc}]),angular.module("medialibrary").controller("FileListCtrl",["$scope","$stateParams","$modal","$log","$location","FileListService","OAuthAuthorizationService","GAPIRequestService","OAuthStatusService","$window","STORAGE_API_URL","STORAGE_CLIENT_API","$state","$translate","FULLSCREEN",function($scope,$stateParams,$modal,$log,$location,listSvc,OAuthAuthorizationService,requestSvc,OAuthStatusService,$window,STORAGE_API_URL,STORAGE_CLIENT_API,$state,$translate,FULLSCREEN){var trashLabel,bucketName="risemedialibrary-"+$stateParams.companyId,bucketUrl=STORAGE_API_URL+bucketName+"/";$scope.$location=$location,$scope.isAuthed=!0,$scope.filesDetails=listSvc.filesDetails,$scope.statusDetails=listSvc.statusDetails,$scope.bucketCreationStatus={code:202},$scope.currentDecodedFolder=$stateParams.folderPath?decodeURIComponent($stateParams.folderPath):void 0,$scope.storageFull=FULLSCREEN,$translate("storage-client.trash").then(function(value){trashLabel=value}),$scope.dateModifiedOrderFunction=function(file){return file.updated?file.updated.value:""},$scope.isTrashFolder=function(){return"--TRASH--/"===$stateParams.folderPath},$scope.login=function(){OAuthAuthorizationService.authorize().then(function(){$scope.isAuthed=!0,listSvc.refreshFilesList()}).then(null,function(errResult){console.log(errResult)})},$scope.fileNameOrderFunction=function(file){return file.name.replace("--TRASH--/",trashLabel).toLowerCase()},$scope.orderByAttribute=$scope.fileNameOrderFunction,$scope.fileExtOrderFunction=function(file){return"/"===file.name.substr(-1)?"Folder":file.name.split(".").pop()},$scope.fileSizeOrderFunction=function(file){return Number(file.size)},OAuthStatusService.getAuthStatus().then(function(){$scope.isAuthed=!0,listSvc.refreshFilesList()},function(){$scope.isAuthed=!1}),$scope.createBucket=function(){var gapiPath="storage.createBucket";requestSvc.executeRequest(gapiPath,{companyId:$stateParams.companyId}).then(function(resp){$scope.bucketCreationStatus=resp,200===resp.code&&$state.go($state.current,$stateParams,{reload:!0})})},$scope.fileCheckToggled=function(file){"/"!==file.name.substr(-1)?$scope.filesDetails.checkedCount+=file.isChecked?1:-1:$scope.filesDetails.folderCheckedCount+=file.isChecked?1:-1,$scope.filesDetails.checkedItemsCount+=file.isChecked?1:-1},$scope.selectAllCheckboxes=function(){$scope.filesDetails.checkedCount=0,$scope.filesDetails.folderCheckedCount=0,$scope.filesDetails.checkedItemsCount=0;for(var i=0;i<$scope.filesDetails.files.length;++i)$scope.fileIsCurrentFolder($scope.filesDetails.files[i])||$scope.fileIsTrash($scope.filesDetails.files[i])||($scope.filesDetails.files[i].isChecked=$scope.selectAll,"/"!==$scope.filesDetails.files[i].name.substr(-1)?$scope.filesDetails.checkedCount+=$scope.selectAll?1:0:$scope.filesDetails.folderCheckedCount+=$scope.selectAll?1:0,$scope.filesDetails.checkedItemsCount+=$scope.selectAll?1:-1)},$scope.fileIsCurrentFolder=function(file){return file.name===$scope.currentDecodedFolder},$scope.fileIsFolder=function(file){return"/"===file.name.substr(-1)},$scope.fileIsTrash=function(file){return"--TRASH--/"===file.name},$scope.$on("FileSelectAction",function(event,file){var folderSelfLinkUrl=STORAGE_CLIENT_API+bucketName+"/o?prefix=",fileUrl="folder"===file.kind?folderSelfLinkUrl+encodeURIComponent(file.name):bucketUrl+"o/"+encodeURIComponent(file.name)+"?&alt=media",data={params:fileUrl};if($scope.fileIsFolder(file))if(listSvc.resetSelections(),$scope.fileIsCurrentFolder(file)){var folderPath=$scope.currentDecodedFolder.split("/");folderPath=folderPath.length>2?folderPath.slice(0,-2).join("/")+"/":"",$state.go(folderPath?"main.company-folders":"main.company-root",{folderPath:folderPath,companyId:$stateParams.companyId})}else $state.go("main.company-folders",{folderPath:file.name,companyId:$stateParams.companyId});else $window.parent.postMessage([fileUrl],"*"),gadgets.rpc.call("","rscmd_saveSettings",null,data)})}]),angular.module("medialibrary").factory("BandwidthService",["$q","OAuthStatusService","GAPIRequestService","$translate",function($q,OAuthStatusService,requestService,$translate){var service={},bandwidthValuesPromiseCache={};return service.getBandwidth=function(companyId){return companyId?bandwidthValuesPromiseCache.hasOwnProperty(companyId)?bandwidthValuesPromiseCache[companyId]:(bandwidthValuesPromiseCache[companyId]=OAuthStatusService.getAuthStatus().then(function(){var params={companyId:companyId};return requestService.executeRequest("storage.getBucketBandwidth",params).then(function(resp){if(!resp.message&&200!==resp.code||resp.result===!1)throw console.log("Bandwidth unavailable"),resp;return resp.message&&isNaN(resp.message)?$translate("storage-client."+resp.message):resp.message})}),bandwidthValuesPromiseCache[companyId]):$q.reject("No companyId")},service}]),angular.module("medialibrary").controller("BandwidthController",["$scope","$stateParams","BandwidthService",function($scope,$stateParams,bandwidthService){$scope.bandwidthUse=void 0,function(){bandwidthService.getBandwidth($stateParams.companyId).then(function(resp){$scope.bandwidthUse=resp})}()}]),angular.module("medialibrary").controller("UploadController",["$scope","$stateParams","$http","FileUploader","UploadURIService","FileListService","$translate",function($scope,$stateParams,$http,FileUploader,uriSvc,filesSvc,$translate){var uploader=$scope.uploader=new FileUploader;uploader.method="PUT",$scope.status={},uploader.onAfterAddingFile=function(fileItem){console.info("onAfterAddingFile",fileItem),fileItem.file.name=decodeURIComponent($stateParams.folderPath||"")+fileItem.file.name,$translate("storage-client.requesting-permission").then(function(msg){$scope.status.message=msg}),uriSvc.getURI(fileItem.file).then(function(resp){fileItem.url=resp,uploader.uploadItem(fileItem)}).then(null,function(resp){$scope.status.message=resp})},uploader.onBeforeUploadItem=function(item){$translate("storage-client.uploading",{filename:item.file.name}).then(function(msg){$scope.status.message=msg})},uploader.onCancelItem=function(item){uploader.removeFromQueue(item)},uploader.onCompleteItem=function(item){function getListItem(data){if(!data||!data.items)return void 0;for(var i=0,j=data.items.length;j>i;i+=1)if(data.items[i].name===item.file.name){listItem=data.items[i];break}return listItem}var listItem;item.isCancel||($translate("storage-client.verifying",{filename:item.file.name}).then(function(msg){$scope.status.message=msg}),$http({method:"GET",url:"https://www.googleapis.com/storage/v1/b/risemedialibrary-"+$stateParams.companyId+"/o"}).then(function(resp){return listItem=getListItem(resp.data),listItem&&parseInt(listItem.size)===item.file.size?(listItem.updated={value:Date.parse(listItem.updated).toString()},filesSvc.addFile(listItem),item.isSuccess=!0,void uploader.removeFromQueue(item)):($translate("storage-client.upload-failed").then(function(msg){$scope.status.message=msg}),void(item.isError=!0))},function(err){console.log(err),$translate("storage-client.verify-failed").then(function(msg){$scope.status.message=msg})}))}}]),angular.module("gapi").controller("gapiClientController",["gapiClientService",function(gapiSvc){this.gapiClientFullyLoaded=!1,gapiSvc.get().then(angular.bind(this,function(){console.log("Google JS client fully loaded"),this.gapiClientFullyLoaded=!0}))}]),angular.module("medialibrary").controller("SubscriptionStatusController",["$scope","STORE_PRODUCT_CODE","STORE_PRODUCT_ID","$stateParams",function($scope,STORE_PRODUCT_CODE,STORE_PRODUCT_ID,$stateParams){$scope.companyId=$stateParams.companyId,$scope.productCode=STORE_PRODUCT_CODE,$scope.productId=STORE_PRODUCT_ID,$scope.subscriptionStatus={}}]),angular.module("medialibraryFilters",["risevision.common.i18n"]).filter("lastModifiedFilter",["$translate",function($translate){var mtr=null;return $translate(["common.jan","common.feb","common.mar","common.apr","common.may","common.jun","common.jul","common.aug","common.sep","common.oct","common.nov","common.dec"]).then(function(values){mtr=values}),function(timestamp){if(!timestamp)return"";var monthNames=[mtr["common.jan"],mtr["common.feb"],mtr["common.mar"],mtr["common.apr"],mtr["common.may"],mtr["common.jun"],mtr["common.jul"],mtr["common.aug"],mtr["common.sep"],mtr["common.oct"],mtr["common.nov"],mtr["common.dec"]],oldDate=new Date;oldDate.setTime(timestamp.value);var newDate=new Date;if(newDate.getYear()>oldDate.getYear()||newDate.getMonth()>oldDate.getMonth())return oldDate.toLocaleDateString();if(newDate.getDate()>oldDate.getDate())return monthNames[oldDate.getMonth()]+" "+oldDate.getDate();var hours=oldDate.getHours();hours=hours?hours>12?hours-12:hours:12;var ampm="AM";oldDate.getHours()>11&&(ampm="PM");var minutes=oldDate.getMinutes();return 10>minutes&&(minutes="0"+minutes),hours+":"+minutes+" "+ampm}}]).filter("fileTypeFilter",["$translate",function($translate){var folderLabel="";return $translate("common.folder").then(function(value){folderLabel=value}),function(filename){var ext,re=/(?:\.([^.]+))?$/;return"/"===filename.substr(-1)?folderLabel:(ext=re.exec(filename)[1],ext&&ext.length<=4?ext=ext.toUpperCase():"")}}]).filter("fileNameFilter",["$translate",function($translate){var trash="--TRASH--/",previousFolderLabel="",trashLabel="";return $translate(["common.previous-folder","storage-client.trash"]).then(function(values){previousFolderLabel=values["common.previous-folder"],trashLabel=values["storage-client.trash"]}),function(filename,currentFolder){return currentFolder&&currentFolder.length>0?filename===currentFolder?"/"+previousFolderLabel:filename.substr(currentFolder.length):filename===trash?trashLabel:filename}}]).filter("fileSizeFilter",function(){return function(size){var sizeString="";return 0===size?"0 bytes":size?(1e3>size?sizeString=size+" bytes":size>1024&&size<Math.pow(1024,2)?sizeString=Math.floor(size/102.4)/10+" KB":size>=Math.pow(1024,2)&&size<Math.pow(1024,3)?sizeString=Math.floor(size/(Math.pow(1024,2)/10))/10+" MB":size>=Math.pow(1024,3)&&(sizeString=Math.floor(size/(Math.pow(1024,3)/10))/10+" GB"),sizeString):""}}).filter("bandwidthUseFilter",["fileSizeFilterFilter","$translate",function(fileSizeFilter,$translate){var lessThan1MB="";return $translate("storage-client.lessThan1MB").then(function(value){lessThan1MB=value}),function(bytes){return isNaN(bytes)?bytes:parseInt(bytes,10)/1e6<1?lessThan1MB:fileSizeFilter(bytes)}}]).filter("groupBy",function(){return function(items,groupedBy){if(items){for(var thisGroup,finalItems=[],i=0;i<items.length;i++)thisGroup||(thisGroup=[]),thisGroup.push(items[i]),(i+1)%groupedBy===0&&(finalItems.push(thisGroup),thisGroup=null);return thisGroup&&finalItems.push(thisGroup),finalItems}}}).filter("trashItemFilter",[function(){return function(itemName){var trash="--TRASH--/";return itemName&&0===itemName.indexOf(trash)?itemName.substr(trash.length):itemName}}]),angular.module("gapi-file",["gapi","medialibraryServices","ui.router"]).factory("FileListService",["LocalFiles","GAPIRequestService","$stateParams",function(LocalFiles,requestor,$stateParams){var svc={};return svc.filesDetails={files:[],localFiles:!1,totalBytes:0,checkedCount:0,folderCheckedCount:0,checkedItemsCount:0},svc.statusDetails={code:200},svc.addFile=function(newFile){for(var existingFileNameIndex,i=0,j=svc.filesDetails.files.length;j>i;i+=1)if(svc.filesDetails.files[i].name===newFile.name){existingFileNameIndex=i;break}existingFileNameIndex?svc.filesDetails.files.splice(existingFileNameIndex,1,newFile):svc.filesDetails.files.push(newFile)},svc.getFileNameIndex=function(fileName){for(var i=0,j=svc.filesDetails.files.length;j>i;i+=1)if(svc.filesDetails.files[i].name===fileName)return i;return-1},svc.resetSelections=function(){svc.filesDetails.files.forEach(function(val){val.isChecked=!1}),svc.filesDetails.checkedCount=0,svc.filesDetails.folderCheckedCount=0,svc.filesDetails.checkedItemsCount=0},svc.removeFiles=function(files){for(var oldFiles=svc.filesDetails.files,removedSize=0,i=oldFiles.length-1;i>=0;i--)files.indexOf(oldFiles[i])>=0&&(removedSize+=parseInt(oldFiles[i].size),oldFiles.splice(i,1));svc.filesDetails.totalBytes-=removedSize},svc.refreshFilesList=function(){function processFilesResponse(resp){var TRASH="--TRASH--/",parentFolder=decodeURIComponent($stateParams.folderPath),parentFolderFound=!1;if(resp.files=resp.files||[],0===parentFolder.indexOf(TRASH)){for(var i=0;i<resp.files.length;i++){var file=resp.files[i];if(file.name===parentFolder){parentFolderFound=!0;break}}parentFolderFound||resp.files.unshift({name:parentFolder,size:0,updated:null})}return svc.filesDetails.totalBytes=resp.files.reduce(function(prev,next){return prev+parseInt(next.size)},0),console.log(svc.filesDetails.totalBytes+" bytes in "+resp.files.length+" files"),svc.filesDetails.files=resp.files||[],svc.statusDetails.code=resp.code,$stateParams.folderPath&&parentFolder&&"/"!==parentFolder||svc.filesDetails.files.splice(1,0,{name:TRASH,size:0,updated:null}),resp}var params={companyId:$stateParams.companyId};return $stateParams.folderPath?(params.folder=decodeURIComponent($stateParams.folderPath),svc.statusDetails.folder=params.folder):svc.statusDetails.folder="/",svc.statusDetails.code=202,$stateParams.companyId?(svc.filesDetails.localFiles=!1,requestor.executeRequest("storage.files.get",params).then(function(resp){return processFilesResponse(resp)})):(svc.filesDetails.localFiles=!0,LocalFiles.query().$promise.then(function(resp){return processFilesResponse({files:resp,code:200})}))},svc}]),angular.module("medialibraryServices").factory("GAPIRequestService",["$q","gapiClientService",function($q,gapiClient){var svc={};return svc.executeRequest=function(requestPath,paramObject){return requestPath=requestPath.split("."),gapiClient.get().then(function(gapiClient){var request=gapiClient;return requestPath.forEach(function(obj){request=request[obj]}),request(paramObject)}).then(function(resp){return resp.result}).then(null,function(){return $q.reject({message:"api error"})})},svc}]);
//# sourceMappingURL=script/main.min.js.map,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery});var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},typeof noGlobal===strundefined&&(window.jQuery=window.$=jQuery),jQuery});
