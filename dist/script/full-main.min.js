...
}]),angular.module("template/tooltip/tooltip-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tooltip/tooltip-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" ng-bind="content"></div>\n</div>\n')}]),angular.module("template/popover/popover.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/popover/popover.html",'<div class="popover {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="arrow"></div>\n\n  <div class="popover-inner">\n      <h3 class="popover-title" ng-bind="title" ng-show="title"></h3>\n      <div class="popover-content" ng-bind="content"></div>\n  </div>\n</div>\n')}]),angular.module("template/progressbar/bar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/bar.html",'<div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: percent + \'%\'}" aria-valuetext="{{percent | number:0}}%" ng-transclude></div>')}]),angular.module("template/progressbar/progress.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progress.html",'<div class="progress" ng-transclude></div>')}]),angular.module("template/progressbar/progressbar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progressbar.html",'<div class="progress">\n  <div class="progress-bar" ng-class="type && \'progress-bar-\' + type" role="progressbar" aria-valuenow="{{value}}" aria-valuemin="0" aria-valuemax="{{max}}" ng-style="{width: percent + \'%\'}" aria-valuetext="{{percent | number:0}}%" ng-transclude></div>\n</div>')}]),angular.module("template/rating/rating.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/rating/rating.html",'<span ng-mouseleave="reset()" ng-keydown="onKeydown($event)" tabindex="0" role="slider" aria-valuemin="0" aria-valuemax="{{range.length}}" aria-valuenow="{{value}}">\n    <i ng-repeat="r in range track by $index" ng-mouseenter="enter($index + 1)" ng-click="rate($index + 1)" class="glyphicon" ng-class="$index < value && (r.stateOn || \'glyphicon-star\') || (r.stateOff || \'glyphicon-star-empty\')">\n        <span class="sr-only">({{ $index < value ? \'*\' : \' \' }})</span>\n    </i>\n</span>')}]),angular.module("template/tabs/tab.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tab.html",'<li ng-class="{active: active, disabled: disabled}">\n  <a ng-click="select()" tab-heading-transclude>{{heading}}</a>\n</li>\n')}]),angular.module("template/tabs/tabset.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tabset.html",'<div>\n  <ul class="nav nav-{{type || \'tabs\'}}" ng-class="{\'nav-stacked\': vertical, \'nav-justified\': justified}" ng-transclude></ul>\n  <div class="tab-content">\n    <div class="tab-pane" \n         ng-repeat="tab in tabs" \n         ng-class="{active: tab.active}"\n         tab-content-transclude="tab">\n    </div>\n  </div>\n</div>\n')}]),angular.module("template/timepicker/timepicker.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/timepicker/timepicker.html",'<table>\n	<tbody>\n		<tr class="text-center">\n			<td><a ng-click="incrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="incrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n		<tr>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidHours}">\n				<input type="text" ng-model="hours" ng-change="updateHours()" class="form-control text-center" ng-mousewheel="incrementHours()" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td>:</td>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidMinutes}">\n				<input type="text" ng-model="minutes" ng-change="updateMinutes()" class="form-control text-center" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td ng-show="showMeridian"><button type="button" class="btn btn-default text-center" ng-click="toggleMeridian()">{{meridian}}</button></td>\n		</tr>\n		<tr class="text-center">\n			<td><a ng-click="decrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="decrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n	</tbody>\n</table>\n')}]),angular.module("template/typeahead/typeahead-match.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-match.html",'<a tabindex="-1" bind-html-unsafe="match.label | typeaheadHighlight:query"></a>')}]),angular.module("template/typeahead/typeahead-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-popup.html",'<ul class="dropdown-menu" ng-show="isOpen()" ng-style="{top: position.top+\'px\', left: position.left+\'px\'}" style="display: block;" role="listbox" aria-hidden="{{!isOpen()}}">\n    <li ng-repeat="match in matches track by $index" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)" ng-click="selectMatch($index)" role="option" id="{{match.id}}">\n        <div typeahead-match index="$index" match="match" query="query" template-url="templateUrl"></div>\n    </li>\n</ul>\n')}]),angular.module("pascalprecht.translate",["ng"]).run(["$translate",function($translate){var key=$translate.storageKey(),storage=$translate.storage();storage?storage.get(key)?$translate.use(storage.get(key)):angular.isString($translate.preferredLanguage())?$translate.use($translate.preferredLanguage()):storage.set(key,$translate.use()):angular.isString($translate.preferredLanguage())&&$translate.use($translate.preferredLanguage())}]),angular.module("pascalprecht.translate").provider("$translate",["$STORAGE_KEY",function($STORAGE_KEY){var $preferredLanguage,$languageKeyAliases,$fallbackLanguage,$fallbackWasString,$uses,$nextLang,$storageFactory,$storagePrefix,$missingTranslationHandlerFactory,$interpolationFactory,$loaderFactory,$loaderOptions,$notFoundIndicatorLeft,$notFoundIndicatorRight,loaderCache,$translationTable={},$availableLanguageKeys=[],$storageKey=$STORAGE_KEY,$interpolatorFactories=[],$interpolationSanitizationStrategy=!1,$cloakClassName="translate-cloak",$postCompilingEnabled=!1,NESTED_OBJECT_DELIMITER=".",version="2.4.2",getLocale=function(){var nav=window.navigator;return((angular.isArray(nav.languages)?nav.languages[0]:nav.language||nav.browserLanguage||nav.systemLanguage||nav.userLanguage)||"").split("-").join("_")},indexOf=function(array,searchElement){for(var i=0,len=array.length;len>i;i++)if(array[i]===searchElement)return i;return-1},trim=function(){return this.replace(/^\s+|\s+$/g,"")},negotiateLocale=function(preferred){for(var avail=[],locale=angular.lowercase(preferred),i=0,n=$availableLanguageKeys.length;n>i;i++)avail.push(angular.lowercase($availableLanguageKeys[i]));if(indexOf(avail,locale)>-1)return preferred;if($languageKeyAliases){var alias;for(var langKeyAlias in $languageKeyAliases){var hasWildcardKey=!1,hasExactKey=Object.prototype.hasOwnProperty.call($languageKeyAliases,langKeyAlias)&&angular.lowercase(langKeyAlias)===angular.lowercase(preferred);if("*"===langKeyAlias.slice(-1)&&(hasWildcardKey=langKeyAlias.slice(0,-1)===preferred.slice(0,langKeyAlias.length-1)),(hasExactKey||hasWildcardKey)&&(alias=$languageKeyAliases[langKeyAlias],indexOf(avail,angular.lowercase(alias))>-1))return alias}}var parts=preferred.split("_");return parts.length>1&&indexOf(avail,angular.lowercase(parts[0]))>-1?parts[0]:preferred},translations=function(langKey,translationTable){if(!langKey&&!translationTable)return $translationTable;if(langKey&&!translationTable){if(angular.isString(langKey))return $translationTable[langKey]}else angular.isObject($translationTable[langKey])||($translationTable[langKey]={}),angular.extend($translationTable[langKey],flatObject(translationTable));return this};this.translations=translations,this.cloakClassName=function(name){return name?($cloakClassName=name,this):$cloakClassName};var flatObject=function(data,path,result,prevKey){var key,keyWithPath,keyWithShortPath,val;path||(path=[]),result||(result={});for(key in data)Object.prototype.hasOwnProperty.call(data,key)&&(val=data[key],angular.isObject(val)?flatObject(val,path.concat(key),result,key):(keyWithPath=path.length?""+path.join(NESTED_OBJECT_DELIMITER)+NESTED_OBJECT_DELIMITER+key:key,path.length&&key===prevKey&&(keyWithShortPath=""+path.join(NESTED_OBJECT_DELIMITER),result[keyWithShortPath]="@:"+keyWithPath),result[keyWithPath]=val));return result};this.addInterpolation=function(factory){return $interpolatorFactories.push(factory),this},this.useMessageFormatInterpolation=function(){return this.useInterpolation("$translateMessageFormatInterpolation")},this.useInterpolation=function(factory){return $interpolationFactory=factory,this},this.useSanitizeValueStrategy=function(value){return $interpolationSanitizationStrategy=value,this},this.preferredLanguage=function(langKey){return setupPreferredLanguage(langKey),this};var setupPreferredLanguage=function(langKey){return langKey&&($preferredLanguage=langKey),$preferredLanguage};this.translationNotFoundIndicator=function(indicator){return this.translationNotFoundIndicatorLeft(indicator),this.translationNotFoundIndicatorRight(indicator),this},this.translationNotFoundIndicatorLeft=function(indicator){return indicator?($notFoundIndicatorLeft=indicator,this):$notFoundIndicatorLeft},this.translationNotFoundIndicatorRight=function(indicator){return indicator?($notFoundIndicatorRight=indicator,this):$notFoundIndicatorRight},this.fallbackLanguage=function(langKey){return fallbackStack(langKey),this};var fallbackStack=function(langKey){return langKey?(angular.isString(langKey)?($fallbackWasString=!0,$fallbackLanguage=[langKey]):angular.isArray(langKey)&&($fallbackWasString=!1,$fallbackLanguage=langKey),angular.isString($preferredLanguage)&&indexOf($fallbackLanguage,$preferredLanguage)<0&&$fallbackLanguage.push($preferredLanguage),this):$fallbackWasString?$fallbackLanguage[0]:$fallbackLanguage};this.use=function(langKey){if(langKey){if(!$translationTable[langKey]&&!$loaderFactory)throw new Error("$translateProvider couldn't find translationTable for langKey: '"+langKey+"'");return $uses=langKey,this}return $uses};var storageKey=function(key){return key?void($storageKey=key):$storagePrefix?$storagePrefix+$storageKey:$storageKey};this.storageKey=storageKey,this.useUrlLoader=function(url,options){return this.useLoader("$translateUrlLoader",angular.extend({url:url},options))},this.useStaticFilesLoader=function(options){return this.useLoader("$translateStaticFilesLoader",options)},this.useLoader=function(loaderFactory,options){return $loaderFactory=loaderFactory,$loaderOptions=options||{},this},this.useLocalStorage=function(){return this.useStorage("$translateLocalStorage")},this.useCookieStorage=function(){return this.useStorage("$translateCookieStorage")},this.useStorage=function(storageFactory){return $storageFactory=storageFactory,this},this.storagePrefix=function(prefix){return prefix?($storagePrefix=prefix,this):prefix},this.useMissingTranslationHandlerLog=function(){return this.useMissingTranslationHandler("$translateMissingTranslationHandlerLog")},this.useMissingTranslationHandler=function(factory){return $missingTranslationHandlerFactory=factory,this},this.usePostCompiling=function(value){return $postCompilingEnabled=!!value,this},this.determinePreferredLanguage=function(fn){var locale=fn&&angular.isFunction(fn)?fn():getLocale();return $preferredLanguage=$availableLanguageKeys.length?negotiateLocale(locale):locale,this},this.registerAvailableLanguageKeys=function(languageKeys,aliases){return languageKeys?($availableLanguageKeys=languageKeys,aliases&&($languageKeyAliases=aliases),this):$availableLanguageKeys},this.useLoaderCache=function(cache){return cache===!1?loaderCache=void 0:cache===!0?loaderCache=!0:"undefined"==typeof cache?loaderCache="$translationCache":cache&&(loaderCache=cache),this},this.$get=["$log","$injector","$rootScope","$q",function($log,$injector,$rootScope,$q){var Storage,fallbackIndex,startFallbackIteration,defaultInterpolator=$injector.get($interpolationFactory||"$translateDefaultInterpolation"),pendingLoader=!1,interpolatorHashMap={},langPromises={},$translate=function(translationId,interpolateParams,interpolationId){if(angular.isArray(translationId)){var translateAll=function(translationIds){for(var results={},promises=[],translate=function(translationId){var deferred=$q.defer(),regardless=function(value){results[translationId]=value,deferred.resolve([translationId,value])};return $translate(translationId,interpolateParams,interpolationId).then(regardless,regardless),deferred.promise},i=0,c=translationIds.length;c>i;i++)promises.push(translate(translationIds[i]));return $q.all(promises).then(function(){return results})};return translateAll(translationId)}var deferred=$q.defer();translationId&&(translationId=trim.apply(translationId));var promiseToWaitFor=function(){var promise=$preferredLanguage?langPromises[$preferredLanguage]:langPromises[$uses];if(fallbackIndex=0,$storageFactory&&!promise){var langKey=Storage.get($storageKey);if(promise=langPromises[langKey],$fallbackLanguage&&$fallbackLanguage.length){var index=indexOf($fallbackLanguage,langKey);fallbackIndex=0===index?1:0,indexOf($fallbackLanguage,$preferredLanguage)<0&&$fallbackLanguage.push($preferredLanguage)}}return promise}();return promiseToWaitFor?promiseToWaitFor.then(function(){determineTranslation(translationId,interpolateParams,interpolationId).then(deferred.resolve,deferred.reject)},deferred.reject):determineTranslation(translationId,interpolateParams,interpolationId).then(deferred.resolve,deferred.reject),deferred.promise},applyNotFoundIndicators=function(translationId){return $notFoundIndicatorLeft&&(translationId=[$notFoundIndicatorLeft,translationId].join(" ")),$notFoundIndicatorRight&&(translationId=[translationId,$notFoundIndicatorRight].join(" ")),translationId},useLanguage=function(key){$uses=key,$rootScope.$emit("$translateChangeSuccess",{language:key}),$storageFactory&&Storage.set($translate.storageKey(),$uses),defaultInterpolator.setLocale($uses),angular.forEach(interpolatorHashMap,function(interpolator,id){interpolatorHashMap[id].setLocale($uses)}),$rootScope.$emit("$translateChangeEnd",{language:key})},loadAsync=function(key){if(!key)throw"No language key specified for loading.";var deferred=$q.defer();$rootScope.$emit("$translateLoadingStart",{language:key}),pendingLoader=!0;var cache=loaderCache;"string"==typeof cache&&(cache=$injector.get(cache));var loaderOptions=angular.extend({},$loaderOptions,{key:key,$http:angular.extend({},{cache:cache},$loaderOptions.$http)});return $injector.get($loaderFactory)(loaderOptions).then(function(data){var translationTable={};$rootScope.$emit("$translateLoadingSuccess",{language:key}),angular.isArray(data)?angular.forEach(data,function(table){angular.extend(translationTable,flatObject(table))}):angular.extend(translationTable,flatObject(data)),pendingLoader=!1,deferred.resolve({key:key,table:translationTable}),$rootScope.$emit("$translateLoadingEnd",{language:key})},function(key){$rootScope.$emit("$translateLoadingError",{language:key}),deferred.reject(key),$rootScope.$emit("$translateLoadingEnd",{language:key})}),deferred.promise};if($storageFactory&&(Storage=$injector.get($storageFactory),!Storage.get||!Storage.set))throw new Error("Couldn't use storage '"+$storageFactory+"', missing get() or set() method!");angular.isFunction(defaultInterpolator.useSanitizeValueStrategy)&&defaultInterpolator.useSanitizeValueStrategy($interpolationSanitizationStrategy),$interpolatorFactories.length&&angular.forEach($interpolatorFactories,function(interpolatorFactory){var interpolator=$injector.get(interpolatorFactory);interpolator.setLocale($preferredLanguage||$uses),angular.isFunction(interpolator.useSanitizeValueStrategy)&&interpolator.useSanitizeValueStrategy($interpolationSanitizationStrategy),interpolatorHashMap[interpolator.getInterpolationIdentifier()]=interpolator});var getTranslationTable=function(langKey){var deferred=$q.defer();return Object.prototype.hasOwnProperty.call($translationTable,langKey)?deferred.resolve($translationTable[langKey]):langPromises[langKey]?langPromises[langKey].then(function(data){translations(data.key,data.table),deferred.resolve(data.table)},deferred.reject):deferred.reject(),deferred.promise},getFallbackTranslation=function(langKey,translationId,interpolateParams,Interpolator){var deferred=$q.defer();return getTranslationTable(langKey).then(function(translationTable){Object.prototype.hasOwnProperty.call(translationTable,translationId)?(Interpolator.setLocale(langKey),deferred.resolve(Interpolator.interpolate(translationTable[translationId],interpolateParams)),Interpolator.setLocale($uses)):deferred.reject()},deferred.reject),deferred.promise},getFallbackTranslationInstant=function(langKey,translationId,interpolateParams,Interpolator){var result,translationTable=$translationTable[langKey];return Object.prototype.hasOwnProperty.call(translationTable,translationId)&&(Interpolator.setLocale(langKey),result=Interpolator.interpolate(translationTable[translationId],interpolateParams),Interpolator.setLocale($uses)),result},translateByHandler=function(translationId){if($missingTranslationHandlerFactory){var resultString=$injector.get($missingTranslationHandlerFactory)(translationId,$uses);return void 0!==resultString?resultString:translationId}return translationId},resolveForFallbackLanguage=function(fallbackLanguageIndex,translationId,interpolateParams,Interpolator){var deferred=$q.defer();if(fallbackLanguageIndex<$fallbackLanguage.length){var langKey=$fallbackLanguage[fallbackLanguageIndex];getFallbackTranslation(langKey,translationId,interpolateParams,Interpolator).then(deferred.resolve,function(){resolveForFallbackLanguage(fallbackLanguageIndex+1,translationId,interpolateParams,Interpolator).then(deferred.resolve)})}else deferred.resolve(translateByHandler(translationId));return deferred.promise},resolveForFallbackLanguageInstant=function(fallbackLanguageIndex,translationId,interpolateParams,Interpolator){var result;if(fallbackLanguageIndex<$fallbackLanguage.length){var langKey=$fallbackLanguage[fallbackLanguageIndex];result=getFallbackTranslationInstant(langKey,translationId,interpolateParams,Interpolator),result||(result=resolveForFallbackLanguageInstant(fallbackLanguageIndex+1,translationId,interpolateParams,Interpolator))}return result},fallbackTranslation=function(translationId,interpolateParams,Interpolator){return resolveForFallbackLanguage(startFallbackIteration>0?startFallbackIteration:fallbackIndex,translationId,interpolateParams,Interpolator)},fallbackTranslationInstant=function(translationId,interpolateParams,Interpolator){return resolveForFallbackLanguageInstant(startFallbackIteration>0?startFallbackIteration:fallbackIndex,translationId,interpolateParams,Interpolator)},determineTranslation=function(translationId,interpolateParams,interpolationId){var deferred=$q.defer(),table=$uses?$translationTable[$uses]:$translationTable,Interpolator=interpolationId?interpolatorHashMap[interpolationId]:defaultInterpolator;if(table&&Object.prototype.hasOwnProperty.call(table,translationId)){var translation=table[translationId];"@:"===translation.substr(0,2)?$translate(translation.substr(2),interpolateParams,interpolationId).then(deferred.resolve,deferred.reject):deferred.resolve(Interpolator.interpolate(translation,interpolateParams))}else{var missingTranslationHandlerTranslation;$missingTranslationHandlerFactory&&!pendingLoader&&(missingTranslationHandlerTranslation=translateByHandler(translationId)),$uses&&$fallbackLanguage&&$fallbackLanguage.length?fallbackTranslation(translationId,interpolateParams,Interpolator).then(function(translation){deferred.resolve(translation)},function(_translationId){deferred.reject(applyNotFoundIndicators(_translationId))}):$missingTranslationHandlerFactory&&!pendingLoader&&missingTranslationHandlerTranslation?deferred.resolve(missingTranslationHandlerTranslation):deferred.reject(applyNotFoundIndicators(translationId))}return deferred.promise},determineTranslationInstant=function(translationId,interpolateParams,interpolationId){var result,table=$uses?$translationTable[$uses]:$translationTable,Interpolator=interpolationId?interpolatorHashMap[interpolationId]:defaultInterpolator;if(table&&Object.prototype.hasOwnProperty.call(table,translationId)){var translation=table[translationId];result="@:"===translation.substr(0,2)?determineTranslationInstant(translation.substr(2),interpolateParams,interpolationId):Interpolator.interpolate(translation,interpolateParams)}else{var missingTranslationHandlerTranslation;$missingTranslationHandlerFactory&&!pendingLoader&&(missingTranslationHandlerTranslation=translateByHandler(translationId)),$uses&&$fallbackLanguage&&$fallbackLanguage.length?(fallbackIndex=0,result=fallbackTranslationInstant(translationId,interpolateParams,Interpolator)):result=$missingTranslationHandlerFactory&&!pendingLoader&&missingTranslationHandlerTranslation?missingTranslationHandlerTranslation:applyNotFoundIndicators(translationId)}return result};if($translate.preferredLanguage=function(langKey){return langKey&&setupPreferredLanguage(langKey),$preferredLanguage},$translate.cloakClassName=function(){return $cloakClassName},$translate.fallbackLanguage=function(langKey){if(void 0!==langKey&&null!==langKey){if(fallbackStack(langKey),$loaderFactory&&$fallbackLanguage&&$fallbackLanguage.length)for(var i=0,len=$fallbackLanguage.length;len>i;i++)langPromises[$fallbackLanguage[i]]||(langPromises[$fallbackLanguage[i]]=loadAsync($fallbackLanguage[i]));$translate.use($translate.use())}return $fallbackWasString?$fallbackLanguage[0]:$fallbackLanguage},$translate.useFallbackLanguage=function(langKey){if(void 0!==langKey&&null!==langKey)if(langKey){var langKeyPosition=indexOf($fallbackLanguage,langKey);langKeyPosition>-1&&(startFallbackIteration=langKeyPosition)}else startFallbackIteration=0},$translate.proposedLanguage=function(){return $nextLang},$translate.storage=function(){return Storage},$translate.use=function(key){if(!key)return $uses;var deferred=$q.defer();$rootScope.$emit("$translateChangeStart",{language:key});var aliasedKey=negotiateLocale(key);return aliasedKey&&(key=aliasedKey),$translationTable[key]||!$loaderFactory||langPromises[key]?(deferred.resolve(key),useLanguage(key)):($nextLang=key,langPromises[key]=loadAsync(key).then(function(translation){translations(translation.key,translation.table),deferred.resolve(translation.key),useLanguage(translation.key),$nextLang===key&&($nextLang=void 0)},function(key){$nextLang===key&&($nextLang=void 0),$rootScope.$emit("$translateChangeError",{language:key}),deferred.reject(key),$rootScope.$emit("$translateChangeEnd",{language:key})})),deferred.promise},$translate.storageKey=function(){return storageKey()},$translate.isPostCompilingEnabled=function(){return $postCompilingEnabled},$translate.refresh=function(langKey){function resolve(){deferred.resolve(),$rootScope.$emit("$translateRefreshEnd",{language:langKey})}function reject(){deferred.reject(),$rootScope.$emit("$translateRefreshEnd",{language:langKey})}if(!$loaderFactory)throw new Error("Couldn't refresh translation table, no loader registered!");var deferred=$q.defer();if($rootScope.$emit("$translateRefreshStart",{language:langKey}),langKey)$translationTable[langKey]?loadAsync(langKey).then(function(data){translations(data.key,data.table),langKey===$uses&&useLanguage($uses),resolve()},reject):reject();else{var tables=[],loadingKeys={};if($fallbackLanguage&&$fallbackLanguage.length)for(var i=0,len=$fallbackLanguage.length;len>i;i++)tables.push(loadAsync($fallbackLanguage[i])),loadingKeys[$fallbackLanguage[i]]=!0;$uses&&!loadingKeys[$uses]&&tables.push(loadAsync($uses)),$q.all(tables).then(function(tableData){angular.forEach(tableData,function(data){$translationTable[data.key]&&delete $translationTable[data.key],translations(data.key,data.table)}),$uses&&useLanguage($uses),resolve()})}return deferred.promise},$translate.instant=function(translationId,interpolateParams,interpolationId){if(null===translationId||angular.isUndefined(translationId))return translationId;if(angular.isArray(translationId)){for(var results={},i=0,c=translationId.length;c>i;i++)results[translationId[i]]=$translate.instant(translationId[i],interpolateParams,interpolationId);return results}if(angular.isString(translationId)&&translationId.length<1)return translationId;translationId&&(translationId=trim.apply(translationId));var result,possibleLangKeys=[];$preferredLanguage&&possibleLangKeys.push($preferredLanguage),$uses&&possibleLangKeys.push($uses),$fallbackLanguage&&$fallbackLanguage.length&&(possibleLangKeys=possibleLangKeys.concat($fallbackLanguage));for(var j=0,d=possibleLangKeys.length;d>j;j++){var possibleLangKey=possibleLangKeys[j];if($translationTable[possibleLangKey]&&"undefined"!=typeof $translationTable[possibleLangKey][translationId]&&(result=determineTranslationInstant(translationId,interpolateParams,interpolationId)),"undefined"!=typeof result)break}return result||""===result||(result=defaultInterpolator.interpolate(translationId,interpolateParams),$missingTranslationHandlerFactory&&!pendingLoader&&(result=translateByHandler(translationId))),result},$translate.versionInfo=function(){return version},$translate.loaderCache=function(){return loaderCache},$loaderFactory&&(angular.equals($translationTable,{})&&$translate.use($translate.use()),$fallbackLanguage&&$fallbackLanguage.length))for(var processAsyncResult=function(translation){translations(translation.key,translation.table),$rootScope.$emit("$translateChangeEnd",{language:translation.key})},i=0,len=$fallbackLanguage.length;len>i;i++)langPromises[$fallbackLanguage[i]]=loadAsync($fallbackLanguage[i]).then(processAsyncResult);return $translate}]}]),angular.module("pascalprecht.translate").factory("$translateDefaultInterpolation",["$interpolate",function($interpolate){var $locale,$translateInterpolator={},$identifier="default",$sanitizeValueStrategy=null,sanitizeValueStrategies={escaped:function(params){var result={};for(var key in params)Object.prototype.hasOwnProperty.call(params,key)&&(result[key]=angular.element("<div></div>").text(params[key]).html());return result}},sanitizeParams=function(params){var result;return result=angular.isFunction(sanitizeValueStrategies[$sanitizeValueStrategy])?sanitizeValueStrategies[$sanitizeValueStrategy](params):params};return $translateInterpolator.setLocale=function(locale){$locale=locale},$translateInterpolator.getInterpolationIdentifier=function(){return $identifier},$translateInterpolator.useSanitizeValueStrategy=function(value){return $sanitizeValueStrategy=value,this},$translateInterpolator.interpolate=function(string,interpolateParams){return $sanitizeValueStrategy&&(interpolateParams=sanitizeParams(interpolateParams)),$interpolate(string)(interpolateParams||{})},$translateInterpolator}]),angular.module("pascalprecht.translate").constant("$STORAGE_KEY","NG_TRANSLATE_LANG_KEY"),angular.module("pascalprecht.translate").directive("translate",["$translate","$q","$interpolate","$compile","$parse","$rootScope",function($translate,$q,$interpolate,$compile,$parse,$rootScope){return{restrict:"AE",scope:!0,compile:function(tElement,tAttr){var translateValuesExist=tAttr.translateValues?tAttr.translateValues:void 0,translateInterpolation=tAttr.translateInterpolation?tAttr.translateInterpolation:void 0,translateValueExist=tElement[0].outerHTML.match(/translate-value-+/i),interpolateRegExp="^(.*)("+$interpolate.startSymbol()+".*"+$interpolate.endSymbol()+")(.*)";return function(scope,iElement,iAttr){if(scope.interpolateParams={},scope.preText="",scope.postText="",iAttr.$observe("translate",function(translationId){if(angular.equals(translationId,"")||!angular.isDefined(translationId)){var interpolateMatches=iElement.text().match(interpolateRegExp);angular.isArray(interpolateMatches)?(scope.preText=interpolateMatches[1],scope.postText=interpolateMatches[3],scope.translationId=$interpolate(interpolateMatches[2])(scope.$parent)):scope.translationId=iElement.text().replace(/^\s+|\s+$/g,"")}else scope.translationId=translationId}),iAttr.$observe("translateDefault",function(value){scope.defaultText=value}),translateValuesExist&&iAttr.$observe("translateValues",function(interpolateParams){interpolateParams&&scope.$parent.$watch(function(){angular.extend(scope.interpolateParams,$parse(interpolateParams)(scope.$parent))})}),translateValueExist){var fn=function(attrName){iAttr.$observe(attrName,function(value){scope.interpolateParams[angular.lowercase(attrName.substr(14,1))+attrName.substr(15)]=value})};for(var attr in iAttr)Object.prototype.hasOwnProperty.call(iAttr,attr)&&"translateValue"===attr.substr(0,14)&&"translateValues"!==attr&&fn(attr)}var applyElementContent=function(value,scope,successful){successful||"undefined"==typeof scope.defaultText||(value=scope.defaultText),iElement.html(scope.preText+value+scope.postText);var globallyEnabled=$translate.isPostCompilingEnabled(),locallyDefined="undefined"!=typeof tAttr.translateCompile,locallyEnabled=locallyDefined&&"false"!==tAttr.translateCompile;(globallyEnabled&&!locallyDefined||locallyEnabled)&&$compile(iElement.contents())(scope)},updateTranslationFn=function(){return translateValuesExist||translateValueExist?function(){var updateTranslations=function(){scope.translationId&&scope.interpolateParams&&$translate(scope.translationId,scope.interpolateParams,translateInterpolation).then(function(translation){applyElementContent(translation,scope,!0)},function(translationId){applyElementContent(translationId,scope,!1)})};scope.$watch("interpolateParams",updateTranslations,!0),scope.$watch("translationId",updateTranslations)}:function(){var unwatch=scope.$watch("translationId",function(value){scope.translationId&&value&&$translate(value,{},translateInterpolation).then(function(translation){applyElementContent(translation,scope,!0),unwatch()},function(translationId){applyElementContent(translationId,scope,!1),unwatch()})},!0)}}(),unbind=$rootScope.$on("$translateChangeSuccess",updateTranslationFn);updateTranslationFn(),scope.$on("$destroy",unbind)}}}}]),angular.module("pascalprecht.translate").directive("translateCloak",["$rootScope","$translate",function($rootScope,$translate){return{compile:function(tElement){var applyCloak=function(){tElement.addClass($translate.cloakClassName())},removeCloak=function(){tElement.removeClass($translate.cloakClassName())},removeListener=$rootScope.$on("$translateChangeEnd",function(){removeCloak(),removeListener(),removeListener=null});return applyCloak(),function(scope,iElement,iAttr){iAttr.translateCloak&&iAttr.translateCloak.length&&iAttr.$observe("translateCloak",function(translationId){$translate(translationId).then(removeCloak,applyCloak)})}}}}]),angular.module("pascalprecht.translate").filter("translate",["$parse","$translate",function($parse,$translate){var translateFilter=function(translationId,interpolateParams,interpolation){return angular.isObject(interpolateParams)||(interpolateParams=$parse(interpolateParams)(this)),$translate.instant(translationId,interpolateParams,interpolation)};return translateFilter.$stateful=!0,translateFilter}]),angular.module("pascalprecht.translate").factory("$translateStaticFilesLoader",["$q","$http",function($q,$http){return function(options){if(!options||!angular.isString(options.prefix)||!angular.isString(options.suffix))throw new Error("Couldn't load static files, no prefix or suffix specified!");
var deferred=$q.defer();return $http(angular.extend({url:[options.prefix,options.key,options.suffix].join(""),method:"GET",params:""},options.$http)).success(function(data){deferred.resolve(data)}).error(function(){deferred.reject(options.key)}),deferred.promise}}]),angular.module("risevision.common.i18n.config",[]).constant("LOCALES_PREFIX","locales/translation_").constant("LOCALES_SUFIX",".json"),angular.module("pascalprecht.translate").factory("$translateStaticFilesLoader",["$q","$http",function($q,$http){function loadTranslationFile(options,deferred){$http(angular.extend({url:[options.prefix,options.key.toLowerCase(),options.suffix].join(""),method:"GET",params:""},options.$http)).success(function(data){deferred.resolve(data)}).error(function(){if(options.key.indexOf("_")>=0){var key=options.key.substr(0,options.key.lastIndexOf("_")),opts=angular.extend({},options,{key:key});loadTranslationFile(opts,deferred)}else deferred.resolve("{}")})}return function(options){if(!options||!angular.isString(options.prefix)||!angular.isString(options.suffix))throw new Error('Couldn"t load static files, no prefix or suffix specified!');var deferred=$q.defer();return loadTranslationFile(options,deferred),deferred.promise}}]),angular.module("risevision.common.i18n",["pascalprecht.translate","risevision.common.i18n.config"]).config(["$translateProvider","LOCALES_PREFIX","LOCALES_SUFIX",function($translateProvider,LOCALES_PREFIX,LOCALES_SUFIX){var getLocale=function(){var nav=window.navigator;return((angular.isArray(nav.languages)?nav.languages[0]:nav.language||nav.browserLanguage||nav.systemLanguage||nav.userLanguage)||"").split("-").join("_")};$translateProvider.useStaticFilesLoader({prefix:LOCALES_PREFIX,suffix:LOCALES_SUFIX}),$translateProvider.determinePreferredLanguage(getLocale).fallbackLanguage("en")}]),function(root,factory){"object"==typeof exports?module.exports=factory():"function"==typeof define&&define.amd?define(factory):root.Spinner=factory()}(this,function(){"use strict";function createEl(tag,prop){var n,el=document.createElement(tag||"div");for(n in prop)el[n]=prop[n];return el}function ins(parent){for(var i=1,n=arguments.length;n>i;i++)parent.appendChild(arguments[i]);return parent}function addAnimation(alpha,trail,i,lines){var name=["opacity",trail,~~(100*alpha),i,lines].join("-"),start=.01+i/lines*100,z=Math.max(1-(1-alpha)/trail*(100-start),alpha),prefix=useCssAnimations.substring(0,useCssAnimations.indexOf("Animation")).toLowerCase(),pre=prefix&&"-"+prefix+"-"||"";return animations[name]||(sheet.insertRule("@"+pre+"keyframes "+name+"{0%{opacity:"+z+"}"+start+"%{opacity:"+alpha+"}"+(start+.01)+"%{opacity:1}"+(start+trail)%100+"%{opacity:"+alpha+"}100%{opacity:"+z+"}}",sheet.cssRules.length),animations[name]=1),name}function vendor(el,prop){var pp,i,s=el.style;for(prop=prop.charAt(0).toUpperCase()+prop.slice(1),i=0;i<prefixes.length;i++)if(pp=prefixes[i]+prop,void 0!==s[pp])return pp;return void 0!==s[prop]?prop:void 0}function css(el,prop){for(var n in prop)el.style[vendor(el,n)||n]=prop[n];return el}function merge(obj){for(var i=1;i<arguments.length;i++){var def=arguments[i];for(var n in def)void 0===obj[n]&&(obj[n]=def[n])}return obj}function getColor(color,idx){return"string"==typeof color?color:color[idx%color.length]}function Spinner(o){this.opts=merge(o||{},Spinner.defaults,defaults)}function initVML(){function vml(tag,attr){return createEl("<"+tag+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',attr)}sheet.addRule(".spin-vml","behavior:url(#default#VML)"),Spinner.prototype.lines=function(el,o){function grp(){return css(vml("group",{coordsize:s+" "+s,coordorigin:-r+" "+-r}),{width:s,height:s})}function seg(i,dx,filter){ins(g,ins(css(grp(),{rotation:360/o.lines*i+"deg",left:~~dx}),ins(css(vml("roundrect",{arcsize:o.corners}),{width:r,height:o.width,left:o.radius,top:-o.width>>1,filter:filter}),vml("fill",{color:getColor(o.color,i),opacity:o.opacity}),vml("stroke",{opacity:0}))))}var i,r=o.length+o.width,s=2*r,margin=2*-(o.width+o.length)+"px",g=css(grp(),{position:"absolute",top:margin,left:margin});if(o.shadow)for(i=1;i<=o.lines;i++)seg(i,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(i=1;i<=o.lines;i++)seg(i);return ins(el,g)},Spinner.prototype.opacity=function(el,i,val,o){var c=el.firstChild;o=o.shadow&&o.lines||0,c&&i+o<c.childNodes.length&&(c=c.childNodes[i+o],c=c&&c.firstChild,c=c&&c.firstChild,c&&(c.opacity=val))}}var useCssAnimations,prefixes=["webkit","Moz","ms","O"],animations={},sheet=function(){var el=createEl("style",{type:"text/css"});return ins(document.getElementsByTagName("head")[0],el),el.sheet||el.styleSheet}(),defaults={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:.25,fps:20,zIndex:2e9,className:"spinner",top:"50%",left:"50%",position:"absolute"};Spinner.defaults={},merge(Spinner.prototype,{spin:function(target){this.stop();{var self=this,o=self.opts,el=self.el=css(createEl(0,{className:o.className}),{position:o.position,width:0,zIndex:o.zIndex});o.radius+o.length+o.width}if(css(el,{left:o.left,top:o.top}),target&&target.insertBefore(el,target.firstChild||null),el.setAttribute("role","progressbar"),self.lines(el,self.opts),!useCssAnimations){var alpha,i=0,start=(o.lines-1)*(1-o.direction)/2,fps=o.fps,f=fps/o.speed,ostep=(1-o.opacity)/(f*o.trail/100),astep=f/o.lines;!function anim(){i++;for(var j=0;j<o.lines;j++)alpha=Math.max(1-(i+(o.lines-j)*astep)%f*ostep,o.opacity),self.opacity(el,j*o.direction+start,alpha,o);self.timeout=self.el&&setTimeout(anim,~~(1e3/fps))}()}return self},stop:function(){var el=this.el;return el&&(clearTimeout(this.timeout),el.parentNode&&el.parentNode.removeChild(el),this.el=void 0),this},lines:function(el,o){function fill(color,shadow){return css(createEl(),{position:"absolute",width:o.length+o.width+"px",height:o.width+"px",background:color,boxShadow:shadow,transformOrigin:"left",transform:"rotate("+~~(360/o.lines*i+o.rotate)+"deg) translate("+o.radius+"px,0)",borderRadius:(o.corners*o.width>>1)+"px"})}for(var seg,i=0,start=(o.lines-1)*(1-o.direction)/2;i<o.lines;i++)seg=css(createEl(),{position:"absolute",top:1+~(o.width/2)+"px",transform:o.hwaccel?"translate3d(0,0,0)":"",opacity:o.opacity,animation:useCssAnimations&&addAnimation(o.opacity,o.trail,start+i*o.direction,o.lines)+" "+1/o.speed+"s linear infinite"}),o.shadow&&ins(seg,css(fill("#000","0 0 4px #000"),{top:"2px"})),ins(el,ins(seg,fill(getColor(o.color,i),"0 0 1px rgba(0,0,0,.1)")));return el},opacity:function(el,i,val){i<el.childNodes.length&&(el.childNodes[i].style.opacity=val)}});var probe=css(createEl("group"),{behavior:"url(#default#VML)"});return!vendor(probe,"transform")&&probe.adj?initVML():useCssAnimations=vendor(probe,"animation"),Spinner}),function(q,g,r){"use strict";function F(a){var d=[];return t(d,g.noop).chars(a),d.join("")}function m(a){var d={};a=a.split(",");var c;for(c=0;c<a.length;c++)d[a[c]]=!0;return d}function G(a,d){function c(a,b,c,h){if(b=g.lowercase(b),u[b])for(;f.last()&&v[f.last()];)e("",f.last());w[b]&&f.last()==b&&e("",b),(h=x[b]||!!h)||f.push(b);var n={};c.replace(H,function(a,b,d,c,e){n[b]=s(d||c||e||"")}),d.start&&d.start(b,n,h)}function e(a,b){var e,c=0;if(b=g.lowercase(b))for(c=f.length-1;c>=0&&f[c]!=b;c--);if(c>=0){for(e=f.length-1;e>=c;e--)d.end&&d.end(f[e]);f.length=c}}"string"!=typeof a&&(a=null===a||"undefined"==typeof a?"":""+a);var b,l,h,f=[],n=a;for(f.last=function(){return f[f.length-1]};a;){if(h="",l=!0,f.last()&&y[f.last()]?(a=a.replace(RegExp("(.*)<\\s*\\/\\s*"+f.last()+"[^>]*>","i"),function(a,b){return b=b.replace(I,"$1").replace(J,"$1"),d.chars&&d.chars(s(b)),""}),e("",f.last())):(0===a.indexOf("<!--")?(b=a.indexOf("--",4),b>=0&&a.lastIndexOf("-->",b)===b&&(d.comment&&d.comment(a.substring(4,b)),a=a.substring(b+3),l=!1)):z.test(a)?(b=a.match(z))&&(a=a.replace(b[0],""),l=!1):K.test(a)?(b=a.match(A))&&(a=a.substring(b[0].length),b[0].replace(A,e),l=!1):L.test(a)&&((b=a.match(B))?(b[4]&&(a=a.substring(b[0].length),b[0].replace(B,c)),l=!1):(h+="<",a=a.substring(1))),l&&(b=a.indexOf("<"),h+=0>b?a:a.substring(0,b),a=0>b?"":a.substring(b),d.chars&&d.chars(s(h)))),a==n)throw M("badparse",a);n=a}e()}function s(a){if(!a)return"";var d=N.exec(a);a=d[1];var c=d[3];return(d=d[2])&&(p.innerHTML=d.replace(/</g,"&lt;"),d="textContent"in p?p.textContent:p.innerText),a+d+c}function C(a){return a.replace(/&/g,"&amp;").replace(O,function(a){var c=a.charCodeAt(0);return a=a.charCodeAt(1),"&#"+(1024*(c-55296)+(a-56320)+65536)+";"}).replace(P,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function t(a,d){var c=!1,e=g.bind(a,a.push);return{start:function(a,l,f){a=g.lowercase(a),!c&&y[a]&&(c=a),c||!0!==D[a]||(e("<"),e(a),g.forEach(l,function(c,f){var k=g.lowercase(f),l="img"===a&&"src"===k||"background"===k;!0!==Q[k]||!0===E[k]&&!d(c,l)||(e(" "),e(f),e('="'),e(C(c)),e('"'))}),e(f?"/>":">"))},end:function(a){a=g.lowercase(a),c||!0!==D[a]||(e("</"),e(a),e(">")),a==c&&(c=!1)},chars:function(a){c||e(C(a))}}}var M=g.$$minErr("$sanitize"),B=/^<((?:[a-zA-Z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*(>?)/,A=/^<\/\s*([\w:-]+)[^>]*>/,H=/([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,L=/^</,K=/^<\//,I=/\x3c!--(.*?)--\x3e/g,z=/<!DOCTYPE([^>]*?)>/i,J=/<!\[CDATA\[(.*?)]]\x3e/g,O=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,P=/([^\#-~| |!])/g,x=m("area,br,col,hr,img,wbr");q=m("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),r=m("rp,rt");var w=g.extend({},r,q),u=g.extend({},q,m("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")),v=g.extend({},r,m("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),y=m("script,style"),D=g.extend({},x,u,v,w),E=m("background,cite,href,longdesc,src,usemap"),Q=g.extend({},E,m("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,target,title,type,valign,value,vspace,width")),p=document.createElement("pre"),N=/^(\s*)([\s\S]*?)(\s*)$/;g.module("ngSanitize",[]).provider("$sanitize",function(){this.$get=["$$sanitizeUri",function(a){return function(d){var c=[];return G(d,t(c,function(c,b){return!/^unsafe/.test(a(c,b))})),c.join("")}}]}),g.module("ngSanitize").filter("linky",["$sanitize",function(a){var d=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"]/,c=/^mailto:/;return function(e,b){function l(a){a&&k.push(F(a))}function f(a,c){k.push("<a "),g.isDefined(b)&&(k.push('target="'),k.push(b),k.push('" ')),k.push('href="'),k.push(a),k.push('">'),l(c),k.push("</a>")}if(!e)return e;for(var n,m,p,h=e,k=[];n=h.match(d);)m=n[0],n[2]==n[3]&&(m="mailto:"+m),p=n.index,l(h.substr(0,p)),f(m,n[0].replace(c,"")),h=h.substring(p+n[0].length);return l(h),a(k.join(""))}}])}(window,window.angular),function(window,angular){"use strict";angular.module("angularSpinner",[]).factory("usSpinnerService",["$rootScope",function($rootScope){var config={};return config.spin=function(key){$rootScope.$broadcast("us-spinner:spin",key)},config.stop=function(key){$rootScope.$broadcast("us-spinner:stop",key)},config}]).directive("usSpinner",["$window",function($window){return{scope:!0,controller:["$scope","$element","$attrs",function($scope,$element,$attrs){$scope.spinner=null,$scope.key=angular.isDefined($attrs.spinnerKey)?$attrs.spinnerKey:!1,$scope.startActive=angular.isDefined($attrs.spinnerStartActive)?$attrs.spinnerStartActive:!$scope.key,$scope.spin=function(){$scope.spinner&&$scope.spinner.spin($element[0])},$scope.stop=function(){$scope.spinner&&$scope.spinner.stop()}}],link:function(scope,element,attr){scope.$watch(attr.usSpinner,function(options){scope.stop(),scope.spinner=new $window.Spinner(options),(!scope.key||scope.startActive)&&scope.spinner.spin(element[0])},!0),scope.$on("us-spinner:spin",function(event,key){key===scope.key&&scope.spin()}),scope.$on("us-spinner:stop",function(event,key){key===scope.key&&scope.stop()}),scope.$on("$destroy",function(){scope.stop(),scope.spinner=null})}}}])}(window,window.angular),function(y,w){"use strict";function u(f,a,c){r.directive(f,["$parse","$swipe",function(m,p){var q=75,g=.3,e=30;return function(h,n,l){function k(d){if(!b)return!1;var s=Math.abs(d.y-b.y);return d=(d.x-b.x)*a,v&&q>s&&d>0&&d>e&&g>s/d}var b,v,s=m(l[f]);p.bind(n,{start:function(d){b=d,v=!0},cancel:function(){v=!1},end:function(b,a){k(b)&&h.$apply(function(){n.triggerHandler(c),s(h,{$event:a})})}})}}])}var r=w.module("ngTouch",[]);r.factory("$swipe",[function(){function f(a){var c=a.touches&&a.touches.length?a.touches:[a];return a=a.changedTouches&&a.changedTouches[0]||a.originalEvent&&a.originalEvent.changedTouches&&a.originalEvent.changedTouches[0]||c[0].originalEvent||c[0],{x:a.clientX,y:a.clientY}}return{bind:function(a,c){var m,p,q,g,e=!1;a.on("touchstart mousedown",function(a){q=f(a),e=!0,p=m=0,g=q,c.start&&c.start(q,a)}),a.on("touchcancel",function(a){e=!1,c.cancel&&c.cancel(a)}),a.on("touchmove mousemove",function(a){if(e&&q){var n=f(a);m+=Math.abs(n.x-g.x),p+=Math.abs(n.y-g.y),g=n,10>m&&10>p||(p>m?(e=!1,c.cancel&&c.cancel(a)):(a.preventDefault(),c.move&&c.move(n,a)))}}),a.on("touchend mouseup",function(a){e&&(e=!1,c.end&&c.end(f(a),a))})}}}]),r.config(["$provide",function(f){f.decorator("ngClickDirective",["$delegate",function(a){return a.shift(),a}])}]),r.directive("ngClick",["$parse","$timeout","$rootElement",function(f,a,c){function m(a,b,c){for(var d=0;d<a.length;d+=2)if(Math.abs(a[d]-b)<e&&Math.abs(a[d+1]-c)<e)return a.splice(d,d+2),!0;return!1}function p(a){if(!(Date.now()-n>g)){var b=a.touches&&a.touches.length?a.touches:[a],c=b[0].clientX,b=b[0].clientY;1>c&&1>b||k&&k[0]===c&&k[1]===b||(k&&(k=null),"label"===a.target.tagName.toLowerCase()&&(k=[c,b]),m(l,c,b)||(a.stopPropagation(),a.preventDefault(),a.target&&a.target.blur()))}}function q(c){c=c.touches&&c.touches.length?c.touches:[c];var b=c[0].clientX,e=c[0].clientY;l.push(b,e),a(function(){for(var a=0;a<l.length;a+=2)if(l[a]==b&&l[a+1]==e){l.splice(a,a+2);break}},g,!1)}var n,l,k,g=2500,e=25,h="ng-click-active";return function(a,b,e){function d(){k=!1,b.removeClass(h)}var t,r,u,x,g=f(e.ngClick),k=!1;b.on("touchstart",function(a){k=!0,t=a.target?a.target:a.srcElement,3==t.nodeType&&(t=t.parentNode),b.addClass(h),r=Date.now(),a=a.touches&&a.touches.length?a.touches:[a],a=a[0].originalEvent||a[0],u=a.clientX,x=a.clientY}),b.on("touchmove",function(){d()}),b.on("touchcancel",function(){d()}),b.on("touchend",function(a){var g=Date.now()-r,f=a.changedTouches&&a.changedTouches.length?a.changedTouches:a.touches&&a.touches.length?a.touches:[a],h=f[0].originalEvent||f[0],f=h.clientX,h=h.clientY,s=Math.sqrt(Math.pow(f-u,2)+Math.pow(h-x,2));k&&750>g&&12>s&&(l||(c[0].addEventListener("click",p,!0),c[0].addEventListener("touchstart",q,!0),l=[]),n=Date.now(),m(l,f,h),t&&t.blur(),w.isDefined(e.disabled)&&!1!==e.disabled||b.triggerHandler("click",[a])),d()}),b.onclick=function(){},b.on("click",function(b,c){a.$apply(function(){g(a,{$event:c||b})})}),b.on("mousedown",function(){b.addClass(h)}),b.on("mousemove mouseup",function(){b.removeClass(h)})}}]),u("ngSwipeLeft",-1,"swipeleft"),u("ngSwipeRight",1,"swiperight")}(window,window.angular),function(window,angular){"use strict";function isStringNumber(num){return/^-?\d+\.?\d*$/.test(num.replace(/["']/g,""))}var isDefined=angular.isDefined,isUndefined=angular.isUndefined,isNumber=angular.isNumber,isObject=angular.isObject,isArray=angular.isArray,extend=angular.extend,toJson=angular.toJson,fromJson=angular.fromJson,angularLocalStorage=angular.module("LocalStorageModule",[]);angularLocalStorage.provider("localStorageService",function(){this.prefix="ls",this.storageType="localStorage",this.cookie={expiry:30,path:"/"},this.notify={setItem:!0,removeItem:!1},this.setPrefix=function(prefix){return this.prefix=prefix,this},this.setStorageType=function(storageType){return this.storageType=storageType,this},this.setStorageCookie=function(exp,path){return this.cookie={expiry:exp,path:path},this},this.setStorageCookieDomain=function(domain){return this.cookie.domain=domain,this},this.setNotify=function(itemSet,itemRemove){return this.notify={setItem:itemSet,removeItem:itemRemove},this},this.$get=["$rootScope","$window","$document","$parse",function($rootScope,$window,$document,$parse){var webStorage,self=this,prefix=self.prefix,cookie=self.cookie,notify=self.notify,storageType=self.storageType;$document?$document[0]&&($document=$document[0]):$document=document,"."!==prefix.substr(-1)&&(prefix=prefix?prefix+".":"");var deriveQualifiedKey=function(key){return prefix+key},browserSupportsLocalStorage=function(){try{var supported=storageType in $window&&null!==$window[storageType],key=deriveQualifiedKey("__"+Math.round(1e7*Math.random()));return supported&&(webStorage=$window[storageType],webStorage.setItem(key,""),webStorage.removeItem(key)),supported}catch(e){return storageType="cookie",$rootScope.$broadcast("LocalStorageModule.notification.error",e.message),!1}}(),addToLocalStorage=function(key,value){if(isUndefined(value)?value=null:(isObject(value)||isArray(value)||isNumber(+value||value))&&(value=toJson(value)),!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),notify.setItem&&$rootScope.$broadcast("LocalStorageModule.notification.setitem",{key:key,newvalue:value,storageType:"cookie"}),addToCookies(key,value);try{(isObject(value)||isArray(value))&&(value=toJson(value)),webStorage&&webStorage.setItem(deriveQualifiedKey(key),value),notify.setItem&&$rootScope.$broadcast("LocalStorageModule.notification.setitem",{key:key,newvalue:value,storageType:self.storageType})}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),addToCookies(key,value)}return!0},getFromLocalStorage=function(key){if(!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),getFromCookies(key);var item=webStorage?webStorage.getItem(deriveQualifiedKey(key)):null;return item&&"null"!==item?"{"===item.charAt(0)||"["===item.charAt(0)||isStringNumber(item)?fromJson(item):item:null},removeFromLocalStorage=function(key){if(!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),notify.removeItem&&$rootScope.$broadcast("LocalStorageModule.notification.removeitem",{key:key,storageType:"cookie"}),removeFromCookies(key);try{webStorage.removeItem(deriveQualifiedKey(key)),notify.removeItem&&$rootScope.$broadcast("LocalStorageModule.notification.removeitem",{key:key,storageType:self.storageType})}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),removeFromCookies(key)}return!0},getKeysForLocalStorage=function(){if(!browserSupportsLocalStorage)return $rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),!1;var prefixLength=prefix.length,keys=[];for(var key in webStorage)if(key.substr(0,prefixLength)===prefix)try{keys.push(key.substr(prefixLength))}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.Description),[]}return keys},clearAllFromLocalStorage=function(regularExpression){regularExpression=regularExpression||"";var tempPrefix=prefix.slice(0,-1),testRegex=new RegExp(tempPrefix+"."+regularExpression);if(!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),clearAllFromCookies();var prefixLength=prefix.length;for(var key in webStorage)if(testRegex.test(key))try{removeFromLocalStorage(key.substr(prefixLength))}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),clearAllFromCookies()}return!0},browserSupportsCookies=function(){try{return $window.navigator.cookieEnabled||"cookie"in $document&&($document.cookie.length>0||($document.cookie="test").indexOf.call($document.cookie,"test")>-1)}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),!1}}(),addToCookies=function(key,value){if(isUndefined(value))return!1;if((isArray(value)||isObject(value))&&(value=toJson(value)),!browserSupportsCookies)return $rootScope.$broadcast("LocalStorageModule.notification.error","COOKIES_NOT_SUPPORTED"),!1;try{var expiry="",expiryDate=new Date,cookieDomain="";if(null===value?(expiryDate.setTime(expiryDate.getTime()+-864e5),expiry="; expires="+expiryDate.toGMTString(),value=""):0!==cookie.expiry&&(expiryDate.setTime(expiryDate.getTime()+24*cookie.expiry*60*60*1e3),expiry="; expires="+expiryDate.toGMTString()),key){var cookiePath="; path="+cookie.path;cookie.domain&&(cookieDomain="; domain="+cookie.domain),$document.cookie=deriveQualifiedKey(key)+"="+encodeURIComponent(value)+expiry+cookiePath+cookieDomain}}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),!1}return!0},getFromCookies=function(key){if(!browserSupportsCookies)return $rootScope.$broadcast("LocalStorageModule.notification.error","COOKIES_NOT_SUPPORTED"),!1;for(var cookies=$document.cookie&&$document.cookie.split(";")||[],i=0;i<cookies.length;i++){for(var thisCookie=cookies[i];" "===thisCookie.charAt(0);)thisCookie=thisCookie.substring(1,thisCookie.length);if(0===thisCookie.indexOf(deriveQualifiedKey(key)+"=")){var storedValues=decodeURIComponent(thisCookie.substring(prefix.length+key.length+1,thisCookie.length));try{var obj=JSON.parse(storedValues);return fromJson(obj)}catch(e){return storedValues}}}return null},removeFromCookies=function(key){addToCookies(key,null)},clearAllFromCookies=function(){for(var thisCookie=null,prefixLength=prefix.length,cookies=$document.cookie.split(";"),i=0;i<cookies.length;i++){for(thisCookie=cookies[i];" "===thisCookie.charAt(0);)thisCookie=thisCookie.substring(1,thisCookie.length);var key=thisCookie.substring(prefixLength,thisCookie.indexOf("="));removeFromCookies(key)}},getStorageType=function(){return storageType},bindToScope=function(scope,key,def,lsKey){lsKey=lsKey||key;var value=getFromLocalStorage(lsKey);return null===value&&isDefined(def)?value=def:isObject(value)&&isObject(def)&&(value=extend(def,value)),$parse(key).assign(scope,value),scope.$watch(key,function(newVal){addToLocalStorage(lsKey,newVal)},isObject(scope[key]))},lengthOfLocalStorage=function(){for(var count=0,storage=$window[storageType],i=0;i<storage.length;i++)0===storage.key(i).indexOf(prefix)&&count++;return count};return{isSupported:browserSupportsLocalStorage,getStorageType:getStorageType,set:addToLocalStorage,add:addToLocalStorage,get:getFromLocalStorage,keys:getKeysForLocalStorage,remove:removeFromLocalStorage,clearAll:clearAllFromLocalStorage,bind:bindToScope,deriveKey:deriveQualifiedKey,length:lengthOfLocalStorage,cookie:{isSupported:browserSupportsCookies,set:addToCookies,add:addToCookies,get:getFromCookies,remove:removeFromCookies,clearAll:clearAllFromCookies}}}]})}(window,window.angular),!function(){function a(a){return["$rootScope","$window",function(b,c){for(var d,e,f,g=c[a]||(console.warn("This browser does not support Web Storage!"),{}),h={$default:function(a){for(var b in a)angular.isDefined(h[b])||(h[b]=a[b]);return h},$reset:function(a){for(var b in h)"$"===b[0]||delete h[b];return h.$default(a)}},i=0;i<g.length;i++)(f=g.key(i))&&"ngStorage-"===f.slice(0,10)&&(h[f.slice(10)]=angular.fromJson(g.getItem(f)));return d=angular.copy(h),b.$watch(function(){e||(e=setTimeout(function(){if(e=null,!angular.equals(h,d)){angular.forEach(h,function(a,b){angular.isDefined(a)&&"$"!==b[0]&&g.setItem("ngStorage-"+b,angular.toJson(a)),delete d[b]});for(var a in d)g.removeItem("ngStorage-"+a);d=angular.copy(h)}},100))}),"localStorage"===a&&c.addEventListener&&c.addEventListener("storage",function(a){"ngStorage-"===a.key.slice(0,10)&&(a.newValue?h[a.key.slice(10)]=angular.fromJson(a.newValue):delete h[a.key.slice(10)],d=angular.copy(h),b.$apply())}),h}]}angular.module("ngStorage",[]).factory("$localStorage",a("localStorage")).factory("$sessionStorage",a("sessionStorage"))}(),angular.module("ngBiscuit",[]),angular.module("ngBiscuit").service("cookieStore",["$document",function(a){function b(b){return new RegExp("(?:^|;\\s*)"+encodeURIComponent(b).replace(/[\-\.\+\*]/g,"\\$&")+"\\s*\\=").test(a[0].cookie)}return{get:function(b){var c=a[0].cookie.replace(new RegExp("(?:(?:^|.*;)\\s*"+encodeURIComponent(b).replace(/[\-\.\+\*]/g,"\\$&")+"\\s*\\=\\s*([^;]*).*$)|^.*$"),"$1");return decodeURIComponent(c)||null},put:function(b,c,d){if(!b||/^(?:expires|max\-age|path|domain|secure)$/i.test(b))return!1;var e="",f=d&&d.domain||"",g=d&&d.path||"",h=d&&d.secure||!1;if(d&&d.end)switch(d.end.constructor){case Number:e=1/0===d.end?"; expires=Fri, 31 Dec 9999 23:59:59 GMT":"; max-age="+d.end;break;case String:e="; expires="+d.end;break;case Date:e="; expires="+d.end.toUTCString()}return a[0].cookie=encodeURIComponent(b)+"="+encodeURIComponent(c)+e+(f?"; domain="+f:"")+(g?"; path="+g:"")+(h?"; secure":""),!0},remove:function(c,d){if(!c||!b(c))return!1;var e=d&&d.domain||"",f=d&&d.path||"";return a[0].cookie=encodeURIComponent(c)+"=; expires=Thu, 01 Jan 1970 00:00:00 GMT"+(e?"; domain="+e:"")+(f?"; path="+f:""),!0}}}]),angular.module("ngCsv.config",[]).value("ngCsv.config",{debug:!0}).config(["$compileProvider",function($compileProvider){angular.isDefined($compileProvider.urlSanitizationWhitelist)?$compileProvider.urlSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|data):/):$compileProvider.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|data):/)}]),angular.module("ngCsv.directives",["ngCsv.services"]),angular.module("ngCsv.services",[]),angular.module("ngCsv",["ngCsv.config","ngCsv.services","ngCsv.directives","ngSanitize"]),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("auth-buttons-menu.html",'<li class="dropdown-header dropdown-title">\n  <span class="user-full-name">{{profile.firstName}} {{profile.lastName}}</span>\n</li>\n<li class="dropdown-header">\n  {{profile.email}}\n</li>\n<li class="divider" ng-show="isRiseVisionUser"></li>\n<li ng-show="isRiseVisionUser">\n  <a href="" ng-click="userSettings()" class="user-settings-button action">\n    <i class="fa fa-cogs"></i>\n    <span class="item-name">User Settings</span>\n  </a>\n</li>\n<li class="divider" ng-show="isRiseVisionUser"></li>\n<li class="divider" ng-show="false"></li>\n<li ng-show="false">\n  <a href="" class="action" ng-click="paymentMethods()">\n    <i class="fa fa-usd"></i>\n    <span class="item-name">Payment Methods</span>\n  </a>\n</li>\n<li ng-show="isLoggedIn">\n  <a href="" ng-click="logout()" class="sign-out-button action">\n    <i class="fa fa-sign-out"></i>\n    <span class="item-name">Sign Out</span>\n  </a>\n</li>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("auth-buttons.html",'<!-- Desktop and tablet -->\n<li\n  ng-show="isLoggedIn && !isRiseVisionUser && !undetermined && !loading">\n  <button type="button" href="" ng-click="register()"\n    class="register-user-menu-button action top-auth-button">\n    Create Account\n  </a>\n</li>\n<li\n  class="dropdown user-profile-dropdown desktop-menu-item"\n  ng-class="{\'hidden-xs\': isLoggedIn}"\n  ng-show="isLoggedIn"\n  >\n    <a href="" class="dropdown-toggle">\n      <img ng-src="{{userPicture}}"\n        class="profile-pic" width="30" height="30" alt="User" />\n    </a>\n    <ul class="dropdown-menu">\n      <ng-include\n        src="\'auth-buttons-menu.html\'"\n        replace-include\n      ></ng-include>\n    </ul>\n</li>\n<!-- Mobile -->\n<li\n  ng-class="{\'visible-xs-inline-block\': isLoggedIn}"\n  ng-show="isLoggedIn"\n  class=" mobile-menu-item"\n  >\n    <a href="" class="dropdown-toggle" action-sheet="\'auth-buttons-menu.html\'">\n      <img ng-src="{{userPicture}}"\n        class="profile-pic" width="30" height="30" alt="User" />\n    </a>\n</li>\n<!-- If User NOT Authenticated -->\n<li ng-show="!undetermined && isLoggedIn === false">\n  <button type="button" class="sign-in top-auth-button" ng-click="login(\'registrationComplete\')">\n    Sign In <img src="//rise-vision.github.io/style-guide/img/avatar_2x.jpg">\n  </button>\n</li>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("authorization-modal.html",'<div class="modal-header">\n  <button type="button" class="close" ng-click="closeModal()">\n  		<i class="fa fa-times"></i>\n  	</button>\n</div>\n<div class="modal-body authorization-modal"\n  rv-spinner="spinnerOptions"\n  rv-spinner-key="authenticate-button"\n  rv-spinner-start-active="0"\n>\n  <img src="//rise-vision.github.io/style-guide/img/avatar_2x.jpg" class="profile-img">\n  <p>Please authorize your Google Account to register with Rise Vision.</p>\n\n  <button type="button" class="btn btn-success btn-fixed-width btn-block authorize-button" ng-click="authenticate(true)">\n    Authorize <i class="fa fa-white fa-check icon-right"></i>\n  </button>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("close-frame-button.html",'<li class="close-frame">\n  <a href="" class="close-frame-button" ng-click="closeIFrame()">\n    <i class="fa fa-times"></i>\n  </a>\n</li>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("common-header.html",'<!-- Common Header Navbar -->\n<nav class="navbar navbar-default navbar-static-top"\n	ng-class="{\'double-margin\': isSubcompanySelected}" role="navigation">\n	<div class="container">\n\n		<div class="navbar-header" style="width: 100%;">\n			<a class="navbar-brand visible-md visible-lg"\n			  href="http://www.risevision.com/" target="_blank" ng-if="!inRVAFrame">\n				<img src="//s3.amazonaws.com/rise-common/images/logo-small.png" class="img-responsive logo-small" width="113" height="42" alt="Rise Vision">\n			</a>\n			<a class="navbar-brand hidden-md hidden-lg text-center"\n				href="" off-canvas-toggle>\n				<i class="fa fa-bars"></i>\n			</a>\n			<!-- If User Authenticated -->\n			<!-- Action Nav -->\n			<ul class="nav navbar-nav navbar-right actions-nav pull-right">\n				<!-- Notifications -->\n				<ng-include\n					replace-include\n					ng-if="!inRVAFrame"\n				  ng-controller="SystemMessagesButtonCtrl"\n					src="\'system-messages-button.html\'"\n				></ng-include>\n				<!-- Shopping Cart -->\n				<ng-include\n					replace-include\n					ng-controller="ShoppingCartButtonCtrl"\n					src="\'shoppingcart-button.html\'"\n				></ng-include>\n				<!-- Shopping Cart -->\n				<ng-include\n					replace-include\n					ng-if="inRVAFrame"\n					ng-controller="CloseFrameButtonCtrl"\n					src="\'close-frame-button.html\'"\n				></ng-include>\n				<!-- Current App -->\n				<li class="dropdown" ng-show="false">\n					<a href="" class="dropdown-toggle">\n						<i class="fa fa-th"></i>\n					</a>\n					<ul class="dropdown-menu company-menu">\n						<li class="dropdown-header dropdown-title">\n							Current App\n						</li>\n						<li class="dropdown-header">\n							<i class="fa fa-tags"></i> Store\n						</li>\n						<li class="divider"></li>\n						<li>\n							<div class="menu-box pull-left">\n								<a href="">\n									<i class="fa fa-photo"></i>\n									<span>Displays</span>\n								</a>\n							</div>\n							<div class="menu-box pull-right">\n								<a href="">\n									<i class="fa fa-photo"></i>\n									<span>Scheduler</span>\n								</a>\n							</div>\n						</li>\n						<li>\n							<div class="menu-box pull-left">\n								<a href="">\n									<i class="fa fa-photo"></i>\n									<span>Editor</span>\n								</a>\n							</div>\n							<div class="menu-box pull-right">\n								<a href="">\n									<i class="fa fa-photo"></i>\n									<span>Storage</span>\n								</a>\n							</div>\n						</li>\n						<li>\n							<div class="menu-box pull-left">\n								<a href="">\n									<i class="fa fa-photo"></i>\n									<span>Bulletin</span>\n								</a>\n							</div>\n							<div class="menu-box pull-right">\n								<a href="">\n									<i class="fa fa-photo"></i>\n									<span>Player</span>\n								</a>\n							</div>\n						</li>\n					</ul>\n				</li>\n				<!-- END Current App -->\n				<!-- Company Dropdown -->\n				<ng-include\n					replace-include\n				  ng-controller="CompanyButtonsCtrl"\n					src="\'company-buttons.html\'"\n				></ng-include>\n				<!-- Auth -->\n				<ng-include\n					replace-include\n					ng-if="!inRVAFrame"\n				  ng-controller="AuthButtonsCtr"\n					src="\'auth-buttons.html\'"\n				></ng-include>\n				<li ng-if="inRVAFrame"\n				  ng-controller="AuthButtonsCtr"></li>\n			</ul>\n			<!-- END Action Nav -->\n\n			<!-- Nav Links -->\n			<div class="navbar-collapse navbar-left hidden-xs hidden-sm">\n				<ul class="nav navbar-nav">\n					<li ng-repeat="opt in navOptions">\n						<a ng-href="{{opt.link}}" target="{{opt.target}}" ng-class="{\'selected\': opt.states && opt.states.indexOf(navSelected) > -1}">{{opt.title}}</a>\n					</li>\n					<li ng-if="!inRVAFrame && !hideHelpMenu">\n						<a href="http://www.risevision.com/help/" target="_blank">\n							Help\n						</a>\n					</li>\n				</ul>\n			</div>\n			<!-- END Nav Links -->\n		</div>\n\n		<ng-include\n		replace-include\n		ng-controller="SubcompanyBannerCtrl"\n		src="\'subcompany-banner.html\'"></ng-include>\n	</div>\n</nav>\n\n<ng-include\n	replace-include\n	ng-controller="GlobalAlertsCtrl"\n	src="\'global-alerts.html\'"></ng-include>\n\n<!-- END Common Header Navbar -->\n\n<!-- Off Canvas Version of the Nav -->\n<nav class="off-canvas-nav" off-canvas-nav>\n  <ul class="nav nav-pills nav-stacked">\n  	<li off-canvas-toggle>\n  		<i class="fa fa-times fa-2x pull-right"></i>\n  		<img src="//s3.amazonaws.com/rise-common/images/logo-small.png" class="img-responsive logo-small" width="113" height="42" alt="Rise Vision">\n  	</li>\n    <li ng-repeat="opt in navOptions">\n			<a ng-href="{{opt.link}}" target="{{opt.target}}">{{opt.title}}</a>\n		</li>\n		<li ng-if="!hideHelpMenu">\n			<a target="_blank" href="http://www.risevision.com/help">Help</a>\n		</li>\n  </ul>\n</nav>\n<iframe name="logoutFrame" id="logoutFrame" style=\'display:none\'></iframe>\n')
}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("company-buttons-menu.html",'<li class="dropdown-header dropdown-title"\n  ng-show="isRiseVisionUser">\n  Current Company\n</li>\n<li class="dropdown-header" ng-show="isRiseVisionUser">\n  <!-- home -->\n  <i ng-show="!isSubcompanySelected" class="fa fa-home"></i>\n  <!-- warning -->\n  <i ng-show="isSubcompanySelected" class="fa fa-warning glyphicon-danger"></i>\n  {{selectedCompanyName}}\n  <div ng-show="isSubcompanySelected" class="danger">This is a Sub-Company of your Company.</div>\n</li>\n<li ng-show="isSubcompanySelected" class="divider"></li>\n<li ng-show="isSubcompanySelected">\n  <a href="" ng-click="resetCompany()" class="action">\n    <i class="fa fa-home"></i>\n    <span class="item-name">Switch To My Company</span>\n  </a>\n</li>\n<li class="divider"></li>\n<li ng-show="isRiseVisionUser && !isSubcompanySelected">\n  <a href="" ng-click="switchCompany()" class="action select-subcompany-menu-button">\n    <i class="fa fa-share-square-o"></i>\n    <span class="item-name">Select Sub-Company</span>\n  </a>\n</li>\n<li ng-show="isUserAdmin || isRiseAdmin" class="divider"></li>\n<li ng-show="isUserAdmin || isRiseAdmin">\n  <a href="" ng-click="addSubCompany()" class="action add-subcompany-menu-button">\n    <i class="fa fa-plus"></i>\n    <span class="item-name">Add Sub-Company</span>\n  </a>\n</li>\n<li ng-show="isUserAdmin || isRiseAdmin" class="divider"></li>\n<li ng-show="isUserAdmin || isRiseAdmin">\n  <a href="" ng-click="companySettings()" class="action company-settings-menu-button">\n    <i class="fa fa-cog"></i>\n    <span class="item-name">Company Settings</span>\n  </a>\n</li>\n<li ng-show="isUserAdmin || isRiseAdmin" class="divider"></li>\n<li ng-show="isUserAdmin || isRiseAdmin">\n  <a href="" data-toggle="modal" ng-click="companyUsers()" class="action company-users-menu-button">\n    <i class="fa fa-users"></i>\n    <span class="item-name">Company Users</span>\n  </a>\n</li>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("company-buttons.html",'<!-- Desktop and tablet -->\n<li class="dropdown hidden-xs" ng-show="isRiseVisionUser && !inRVAFrame">\n  <a href="" class="dropdown-toggle company-buttons-icon">\n    <i class="fa fa-cog"></i>\n  </a>\n  <ul class="dropdown-menu">\n    <ng-include\n      replace-include\n      src="\'company-buttons-menu.html\'"\n    ></ng-include>\n  </ul>\n</li>\n\n<!-- Mobile -->\n<li\n ng-show="isRiseVisionUser && !inRVAFrame"\n ng-class="{\'visible-xs-inline-block\': isRiseVisionUser}">\n  <a href="" class="company-buttons-icon-mobile"\n    action-sheet="\'company-buttons-menu.html\'">\n    <i class="fa fa-cog"></i>\n  </a>\n</li>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("company-fields.html",'<div class="form-group" ng-class="{\'has-error\': forms.companyForm.name.$invalid && !forms.companyForm.name.$pristine}">\n  <label for="company-settings-name">\n    Name *\n  </label>\n  <input required id="company-settings-name" type="text" class="form-control"\n    ng-model="company.name" name="name" />\n  <p ng-show="forms.companyForm.name.$invalid && !forms.companyForm.name.$pristine"\n    class="help-block validation-error-message-name">Company name is required.</p>\n</div>\n<div class="form-group">\n  <label for="company-settings-street">\n    Street\n  </label>\n  <input id="company-settings-street" type="text" class="form-control" ng-model="company.street" />\n</div>\n<div class="form-group">\n  <label for="company-settings-unit">\n    Unit\n  </label>\n  <input id="company-settings-unit" type="text" class="form-control" ng-model="company.unit" />\n</div>\n<div class="form-group">\n  <label for="company-settings-city">\n    City\n  </label>\n  <input id="company-settings-city" type="text" class="form-control" ng-model="company.city" />\n</div>\n<div class="form-group">\n  <label for="company-settings-country">\n    Country\n  </label>\n  <select id="company-settings-country" class="form-control selectpicker"\n    ng-model="company.country" ng-options="c[1] as c[0] for c in countries">\n    <option value="">&lt; Select Country &gt;</option>\n  </select>\n</div>\n<div class="form-group">\n  <label for="company-settings-state">\n    State / Province\n  </label>\n  <input id="company-settings-state" type="text" class="form-control" ng-model="company.province" ng-hide="company.country == \'US\' || company.country == \'CA\'" />\n  <select class="form-control selectpicker" ng-model="company.province" ng-options="c[1] as c[0] for c in regionsCA" ng-show="company.country == \'CA\'">\n    <option value="">&lt; Select Province &gt;</option>\n  </select>\n  <select class="form-control selectpicker" ng-model="company.province" ng-options="c[1] as c[0] for c in regionsUS" ng-show="company.country == \'US\'">\n    <option value="">&lt; Select State &gt;</option>\n  </select>\n</div>\n<div class="form-group">\n  <label for="company-settings-zip">\n    Zip / Postal Code\n  </label>\n  <input id="company-settings-zip" type="text" class="form-control" ng-model="company.postalCode" />\n</div>\n<div class="form-group">\n  <label for="company-settings-phone">\n    Phone\n  </label>\n  <input id="company-settings-phone" type="tel" class="form-control" ng-model="company.telephone"/>\n</div>\n<div class="form-group">\n  <label for="company-settings-monitoring">\n    Send Monitoring Emails To\n  </label>\n  <input id="company-settings-monitoring"\n    type="text" class="form-control" ng-list=", "\n     ng-model="company.notificationEmails" placeholder="e.g. john.doe@company.com, jane.doe@company.com"/>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("company-selector-modal.html",'\n<form role="form">\n	<div class="modal-header">\n		<button type="button" class="close" data-dismiss="modal"\n		  aria-hidden="true" ng-click="closeModal()">\n			<i class="fa fa-times"></i>\n		</button>\n		<h2 id="switch-company" class="modal-title">\n			Select Sub-Company\n		</h2>\n	</div>\n	<div class="modal-body jfk-scrollbar">\n	  <!-- Search -->\n		<div class="input-group company-search add-bottom">\n			<input id="csSearch" type="text" class="form-control"\n				placeholder="Search Companies"\n				ng-model="search.searchString"\n				ng-enter="doSearch()">\n		    <span class="input-group-addon primary-bg" ng-click="doSearch()">\n		      <i class="fa fa-search"></i>\n		    </span>\n		</div>\n		<!-- List of Companies -->\n		<div class="list-group scrollable-list"\n		  rv-scroll-event="handleScroll($event, isEndEvent)"\n		  rv-spinner rv-spinner-key="company-selector-modal-list"\n			rv-spinner-start-active="1"\n		>\n			<div class="list-group-item"  ng-repeat="company in companies.list" ng-click="setCompany(company)">\n				<p class="list-group-item-text"><strong>{{company.name}}</strong><br/><small class="text-muted">{{company | fullAddress}}</small>\n				</p>\n			</div>\n		</div>\n	</div>\n	<div class="modal-footer">\n		<button type="button" class="btn btn-default btn-fixed-width" data-dismiss="modal" aria-hidden="true" ng-click="closeModal()">Cancel\n			<i class="fa fa-white fa-times icon-right"></i>\n		</button>\n	</div>\n</form>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("company-settings-modal.html",'<div rv-spinner\n  rv-spinner-key="company-settings-modal"\n  rv-spinner-start-active="1">\n\n<div class="modal-header">\n  <button type="button" class="close" data-dismiss="modal" aria-hidden="true" ng-click="closeModal()">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="company-settings-label" class="modal-title">Company Settings</h2>\n</div>\n<div class="modal-body company-settings-modal">\n  <form role="form" name="forms.companyForm">\n    <div ng-include="\'company-fields.html\'"></div>\n    <div class="form-group">\n      <label>\n        Authentication Key\n      </label>\n      <a class="action-link ps-reset-auth-key" href="" ng-click="resetAuthKey()">Reset</a>\n      <div clss="ps-auth-key">\n        {{company.authKey}}\n      </div>\n    </div>\n    <div class="form-group">\n      <label>\n        Claim ID\n      </label>\n      <a class="action-link ps-reset-claim-id" href="" ng-click="resetClaimId()">Reset</a>\n      <div class="ps-claim-id">\n        {{company.claimId}}\n      </div>\n    </div>\n    <div class="form-group" ng-hide="true">\n      <label>\n        Sub-Company Home Page Presentation\n      </label>\n      <a class="action-link" href="" ng-click="showSelector()">Select</a>\n      <a class="action-link" href="">Default</a>\n      <div id="presentation-name">Rise Vision Default (ID=a6789044-ae4a-48c7-b6fd-b5d4ffea2f24)</div>\n      <div class="presentation-selector" ng-show="isSelectorVisible">\n        <div class="panel panel-default">\n          <ul class="list-unstyled selector-header">\n            <li ng-class="{active : selected == \'list\'}">\n              <a href="" ng-click="showPresentationView($event, \'list\')">Search Presentations</a>\n            </li>\n            <li ng-class="{active : selected == \'search\'}">\n              <a href="" ng-click="showPresentationView($event, \'search\')">Enter Presentation ID</a>\n            </li>\n            <li class="close-button">\n              <button type="button" class="close" aria-hidden="true" ng-click="closeSelector()">\n                <i class="fa fa-times"></i>\n              </button>\n            </li>\n          </ul>\n          <div class="panel-body">\n            <div class="presentation-list" ng-show="selected == \'list\'">\n              <div class="input-group search">\n                <input type="text" class="form-control" placeholder="Search Presentations">\n                <span class="input-group-btn">\n                  <button class="btn btn-primary" type="submit">\n                    <i class="fa fa-search fa-white"></i>\n                  </button>\n                </span>\n              </div>\n              <div class="list-group scrollable-list">\n                <a href="" class="list-group-item" ng-click="setPresentation($event, \'Demo Presentation\')">\n                  Demo Presentation\n                </a>\n                <a href="" class="list-group-item" ng-click="setPresentation($event, \'My First Presentation\')">\n                  My First Presentation\n                </a>\n              </div>\n            </div>\n            <div class="presentation-search" ng-show="selected == \'search\'">\n              <form role="form">\n                <div class="form-group">\n                  <input id="presentation-id" type="text" class="form-control" placeholder="Enter Presentation ID" />\n                </div>\n                <div class="form-group">\n                  <a href="" ng-click="setPresentation($event)">Retrieve Presentation</a>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class="form-group" ng-hide="true">\n        <label for="company-settings-community-url">\n          Sub-Company Community URL\n        </label>\n        <a class="action-link" href="">Default</a>\n        <input id="company-settings-community-url" type="url" class="form-control" />\n      </div>\n      <div class="form-group" ng-hide="true">\n        <label for="company-settings-support-url">\n          Sub-Company Support URL\n        </label>\n        <a class="action-link" href="">Default</a>\n        <input id="company-settings-support-url" type="url" class="form-control" />\n      </div>\n      <div class="checkbox" ng-if="isRiseStoreAdmin">\n        <label>\n          <input type="checkbox" ng-model="company.isSeller" />\n          Registered Seller\n        </label>\n      </div>\n      <div class="form-group" ng-hide="true">\n        <label for="company-settings-status">\n          Status\n        </label>\n        <select id="company-settings-status" class="form-control selectpicker">\n          <option value="active">Active</option>\n          <option value="inactive">Inactive</option>\n        </select>\n      </div>\n    </form>\n  </div>\n  <div class="modal-footer">\n    <button type="button"\n      class="btn btn-success btn-fixed-width" ng-click="save()"\n      ng-disabled="forms.companyForm.$invalid">Save\n      <i class="fa fa-white fa-check icon-right"></i>\n    </button>\n    <button type="button" class="btn btn-danger btn-fixed-width delete-company-button"\n    ng-show="!isDeletingCompany" ng-click="deleteCompany()">\n      Delete <i class="fa fa-white fa-trash-o icon-right"></i>\n    </button>\n    <button type="button" class="btn btn-danger btn-confirm-delete" data-dismiss="modal" ng-show="isDeletingCompany" ng-click="closeModal()">\n      Confirm Deletion <i class="fa fa-white fa-warning icon-right"></i>\n    </button>\n    <button type="button"\n      class="btn btn-default btn-fixed-width close-company-settings-button" data-dismiss="modal" ng-click="closeModal()">Cancel\n      <i class="fa fa-white fa-times icon-right"></i>\n    </button>\n  </div>\n</div>\n</div> <!--spinner -->\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("company-users-modal.html",'<div rv-spinner\n  rv-spinner-key="company-users-modal"\n  rv-spinner-start-active="1">\n<div class="modal-header">\n  <button type="button" class="close" data-dismiss="modal"\n    aria-hidden="true" ng-click="closeModal()">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="company-users-label" class="modal-title">Company Users</h2>\n</div>\n<div class="modal-body company-users-modal">\n  <!-- CSV Button -->\n  <div class="row action-bar add-bottom" ng-if="false">\n    <button class="btn btn-secondary" ng-csv="users"\n      filename="users.csv">Download to CSV</button>\n  </div>\n  <!-- Search -->\n  <div class="input-group company-search add-bottom">\n    <input id="csSearch" type="text" class="form-control"\n      placeholder="Search Users"\n      ng-model="search.searchString"\n      ng-enter="doSearch()">\n      <span class="input-group-addon primary-bg" ng-click="doSearch()">\n        <i class="fa fa-search"></i>\n      </span>\n  </div>\n  <!-- List of Users -->\n  <div class="list-group scrollable-list company-users-list"\n    rv-spinner\n    rv-spinner-key="company-users-list"\n    rv-spinner-start-active="1">\n    <div class="list-group-item  company-users-list-item"\n      ng-repeat="user in users | orderBy:sort.field:sort.descending | filter:userSearchString" ng-click="editUser(user.username)">\n      <p class="list-group-item-text"><strong>{{user.firstName}} {{user.lastName}}</strong> <small class="text-muted">{{user.email}}</small></p>\n    </div>\n  </div>\n</div>\n<div class="modal-footer">\n  <button type="button" class="btn btn-success add-company-user-button"\n    ng-click="addUser()">Add User\n    <i class="fa fa-white fa-plus icon-right"></i>\n  </button>\n  <button type="button" class="btn btn-default close-company-users-button"\n    data-dismiss="modal" ng-click="closeModal()">\n    Cancel <i class="fa fa-white fa-times icon-right"></i>\n  </button>\n</div>\n</div> <!-- spinner -->\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("credit-cards-modal.html",'<div class="modal-header">\n  <button type="button" class="close" ng-click="closeModal()">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="pay-now-label" class="modal-title">Credit Cards</h2>\n</div>\n<div class="modal-body" ng-scroll-event="handleScroll($event, isEndEvent)">\n  <form role="form">\n    <div class="form-group">\n      <label for="card-number">Card Number</label>\n      <input id="card-number" data-stripe="number" class="form-control" type="text" ng-model="card.number"/>\n    </div>\n    <div class="form-group">\n      <label for="card-name">Cardholder Name</label>\n      <input id="card-name" data-stripe="name" class="form-control" type="text" ng-model="card.name"/>\n    </div>\n    <div class="row form-group">\n      <div class="col-md-3">\n        <label for="expiry-month">Exp. Month</label>\n        <select id="expiry-month" data-stripe="exp-month" class="form-control selectpicker" ng-model="card.expMonth">\n          <option value="1">01</option>\n          <option value="2">02</option>\n          <option value="3">03</option>\n          <option value="4" selected>04</option>\n          <option value="5">05</option>\n          <option value="6">06</option>\n          <option value="7">07</option>\n          <option value="8">08</option>\n          <option value="9">09</option>\n          <option value="10">10</option>\n          <option value="11">11</option>\n          <option value="12">12</option>\n        </select>\n      </div>\n      <div class="col-md-3">\n        <label for="expiry-year">Exp. Year</label>\n        <select id="expiry-year" data-stripe="exp-year" class="form-control selectpicker" ng-model="card.expYear">\n          <option value="2014" selected>2014</option>\n          <option value="2015">2015</option>\n          <option value="2016">2016</option>\n          <option value="2017">2017</option>\n          <option value="2018">2018</option>\n          <option value="2019">2019</option>\n          <option value="2020">2020</option>\n          <option value="2021">2021</option>\n          <option value="2022">2022</option>\n          <option value="2023">2023</option>\n          <option value="2024">2024</option>\n        </select>\n      </div>\n      <div class="col-md-3">\n        <label for="cvc">Security Code</label>\n        <input id="cvc" data-stripe="cvc" class="form-control" type="text" size="4" ng-model="card.cvc">\n      </div>\n    </div>\n    <!-- Address -->\n    <h3>Billing Address</h3>\n    <div class="form-group">\n      <label for="street">Street</label>\n      <input id="street" type="text" class="form-control" ng-model="addr.address1" />\n    </div>\n    <div class="form-group">\n      <label for="unit">Street (Line 2)</label>\n      <input id="unit" type="text" class="form-control" ng-model="addr.address2" />\n    </div>\n    <div class="form-group">\n      <label for="city">City</label>\n      <input id="city" type="text" class="form-control" ng-model="addr.city" />\n    </div>\n    <div class="form-group">\n      <label for="country">Country</label>\n      <select id="country" class="form-control selectpicker" ng-model="addr.country" ng-options="c[1] as c[0] for c in countries">\n        <option value="">&lt; Select Country &gt;</option>\n      </select>\n    </div>\n    <div class="form-group">\n      <label for="province">State / Province</label>\n      <!-- <input id="province" type="text" class="form-control" ng-model="addr.province" ng-hide="addr.country == \'US\' || addr.country == \'CA\'" /> -->\n      <select class="form-control selectpicker" ng-model="addr.province" ng-options="c[1] as c[0] for c in regionsCA" ng-show="addr.country == \'CA\'">\n        <option value="">&lt; Select Province &gt;</option>\n      </select>\n      <!-- <select class="form-control selectpicker" ng-model="addr.province" ng-options="c[1] as c[0] for c in regionsUS" ng-show="addr.country == \'US\'">\n        <option value="">&lt; Select State &gt;</option>\n      </select> -->\n    </div>\n    <div class="form-group">\n      <label for="zip">Zip / Postal Code</label>\n      <input id="zip" type="text" class="form-control" ng-model="addr.postalCode" />\n    </div>\n    <!-- End Address-->\n    <div class="form-group danger" ng-show="isDeletingCard">\n      Warning! If you delete this credit card from your account all subscription renewals paid on this card will fail at the time of renewal resulting in potential loss of service. Please confirm you wish to proceed with deleting this card by typing "DELETE" into the box below and clicking on the Confirm Deletion button.\n      <div class="row">\n        <div class="col-sm-4">\n          <input type="text" class="form-control" />\n        </div>\n      </div>\n    </div>\n  </form>\n</div>\n<div class="modal-footer">\n  <div class="row">\n    <div class="col-sm-3">\n      <a href="https://stripe.com/" target="_blank">\n        <img src="img/powered-by-stripe.png" class="stripe" width="119" height="26" alt="Powered by Stripe">\n      </a>\n    </div>\n    <div class="col-sm-9">\n      <button type="button" class="btn btn-success btn-fixed-width" data-dismiss="modal" ng-click="closeModal()">Save\n        <i class="fa fa-white fa-check icon-right"></i>\n      </button>\n      <button type="button" class="btn btn-danger btn-fixed-width" ng-show="!isDeletingCard" ng-click="deleteCard()">\n        Delete <i class="fa fa-white fa-trash-o icon-right"></i>\n      </button>\n      <button type="button" class="btn btn-danger btn-confirm-delete" data-dismiss="modal" ng-show="isDeletingCard" ng-click="closeModal()">\n        Confirm Deletion <i class="fa fa-white fa-warning icon-right"></i>\n      </button>\n      <button type="button" class="btn btn-default btn-fixed-width" data-dismiss="modal" ng-click="closeModal()">Cancel\n        <i class="fa fa-white fa-times icon-right"></i>\n      </button>\n    </div>\n  </div>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("global-alerts.html",'<div class="container">\n  <div class="row">\n    <div class="col-md-12">\n      <div class="alert alert-danger" role="alert" ng-repeat="msg in errors">\n        <span ng-bind-html="msg"></span>\n        <button type="button" class="close pull-right"\n          ng-click="dismiss(\'errors\', $index);">\n          <i class="fa fa-times"></i>\n        </button>\n      </div>\n    </div>\n  </div>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("move-company-modal.html",'<div rv-spinner\n  rv-spinner-key="move-company-modal"\n  rv-spinner-start-active="1">\n<div class="modal-header">\n  <button type="button" class="close" data-dismiss="modal" aria-hidden="true" ng-click="closeModal()">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="move-company-label" class="modal-title">Move Company</h2>\n</div>\n<div class="modal-body move-company-modal">\n  <form role="form">\n    <div class="form-group">\n      <label for="auth-key">\n        Enter the Authentication Key of the Company that you want to move.\n      </label>\n      <div class="row">\n        <div class="col-sm-6">\n          <input id="auth-key" type="text" class="form-control"\n          ng-model="company.authKey" />\n        </div>\n        <div class="col-sm-6">\n          <a href="" class="btn btn-secondary retrieve-company-details-button"\n          ng-disabled="!company.authKey"\n          ng-click="getCompany()">Retrieve Company Details</a>\n        </div>\n      </div>\n    </div>\n  </form>\n  <div ng-show="company.name" class="company-details-info">\n    <h3>Details of the Company You Want to Move</h3>\n    <div>\n      {{company.name}}<br>\n      {{company.address}}\n      {{company.city}}, {{company.province}}, {{company.country}} {{company.postalCode}}\n    </div>\n    <h3>Details of the Company You Are Moving the Above Company Under</h3>\n    <div class="to-company">\n      {{selectedCompany.name}}<br>\n      {{selectedCompany.address}}<br>\n      {{selectedCompany.city}}, {{selectedCompany.province}},\n      {{selectedCompany.country}} {{selectedCompany.postalCode}}\n    </div>\n  </div>\n  <div ng-show="errors.length > 0">\n    <div class="alert alert-danger" ng-repeat="error in errors">\n      {{error}}\n    </div>\n  </div>\n  <div ng-show="messages.length > 0">\n    <div class="alert alert-success" ng-repeat="message in messages">\n      {{message}}\n    </div>\n  </div>\n</div>\n<div class="modal-footer">\n  <button type="button"\n    class="btn btn-success move-company-button"\n    ng-show="company.name && !moveSuccess" ng-click="moveCompany()">Move Company\n    <i class="fa fa-white fa-check icon-right"></i>\n  </button>\n  <button type="button" class="btn btn-primary close-move-company-button" data-dismiss="modal" ng-click="closeModal()">\n    {{dismissButtonText}} <i class="fa fa-white fa-times icon-right"></i>\n  </button>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("payment-methods-modal.html",'<div class="modal-header">\n  <button type="button" class="close" ng-click="closeModal()">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="user-settings-label" class="modal-title">Payment Methods</h2>\n</div>\n<div class="modal-body">\n  <div class="container-fluid">\n    <div class="list-group">\n      <div class="row list-group-item">\n        <div class="col-sm-10">\n          Visa - 123\n          <span class="expiry">Expires - 02/15</span>\n        </div>\n        <div class="col-sm-2 edit">\n          <a href="" ng-click="creditCards()">\n            Edit\n          </a>\n        </div>\n      </div>\n      <div class="row list-group-item">\n        <div class="col-sm-10">\n          Amex - 123\n          <span class="expiry">Expires - 02/15</span>\n        </div>\n        <div class="col-sm-2 edit">\n          <a href="" ng-click="creditCards()">\n            Edit\n          </a>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n<div class="modal-footer">\n  <div class="row">\n    <div class="col-sm-3 stripe">\n      <a href="https://stripe.com/" target="_blank">\n        <img src="img/powered-by-stripe.png" width="119" height="26" alt="Powered by Stripe">\n      </a>\n    </div>\n    <div class="col-sm-9">\n      <button type="button" class="btn btn-default" ng-click="closeModal()">\n        Cancel <i class="fa fa-white fa-times icon-right"></i>\n      </button>\n    </div>\n  </div>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("registration-modal.html",'<div rv-spinner\nrv-spinner-key="registration-modal"\nrv-spinner-start-active="1">\n<div class="modal-header">\n  <button type="button" class="close" data-dismiss="modal" aria-hidden="true" ng-click="closeModal()">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 class="modal-title">Welcome To Rise Vision</h2>\n</div>\n<div class="modal-body registration-modal">\n  <p>We require an email address that we can reliably reach you at\n  for system notices and other critical information. We promise,\n   only system notices, we won\'t send you anything else unless you\n  sign up for the newsletter below, and we won\'t share your email address\n  with anyone else.</p>\n\n  <form novalidate role="form" name="forms.registrationForm">\n    <!-- First Name -->\n    <div class="form-group" ng-class="{ \'has-error\' : forms.registrationForm.firstName.$invalid && !forms.registrationForm.firstName.$pristine }">\n      <label for="firstName">First Name</label>\n      <input type="text" class="form-control firstName"\n      name="firstName"\n      id="firstName" required\n      ng-model="profile.firstName">\n      <p ng-show="forms.registrationForm.firstName.$invalid && !forms.registrationForm.firstName.$pristine"\n        class="help-block validation-error-message-first-name">Enter First Name.</p>\n    </div>\n    <!-- Last Name -->\n    <div class="form-group" ng-class="{ \'has-error\' : forms.registrationForm.lastName.$invalid && !forms.registrationForm.lastName.$pristine }">\n      <label for="lastName">Last Name</label>\n      <input type="text" class="form-control lastName"\n      name="lastName"\n      id="lastName" required\n      ng-model="profile.lastName">\n      <p ng-show="forms.registrationForm.lastName.$invalid && !forms.registrationForm.lastName.$pristine"\n        class="help-block validation-error-message-last-name">Enter Last Name.</p>\n    </div>\n    <!-- Email -->\n    <div class="form-group" ng-class="{ \'has-error\' : forms.registrationForm.email.$invalid && !forms.registrationForm.email.$pristine }">\n      <label for="email">Email</label>\n      <input type="email" class="form-control email"\n      name="email"\n      id="email" required\n      ng-model="profile.email">\n      <p ng-show="forms.registrationForm.email.$invalid && !forms.registrationForm.email.$pristine"\n        class="help-block validation-error-message-email">Enter a valid email.</p>\n    </div>\n    <!-- Terms of Service and Privacy -->\n    <div class="checkbox form-group" ng-class="{ \'has-error\' : forms.registrationForm.accepted.$invalid && !userForm.accepted.$pristine }">\n      <label>\n      <input type="checkbox" name="accepted"\n        ng-model="profile.accepted"\n        class="accept-terms-checkbox" required />\n      I accept the terms of <a href="http://www.risevision.com/terms-service-privacy/" target="_blank">Service and Privacy</a>\n      <p ng-show="forms.registrationForm.accepted.$invalid && !forms.registrationForm.accepted.$pristine"\n        class="help-block validation-error-message-accepted">You must accept terms and condtions.</p>\n      </label>\n    </div>\n    <!-- Newsletter -->\n    <div class="checkbox form-group">\n      <label>\n        <input type="checkbox" class="sign-up-newsletter-checkbox" ng-model="profile.mailSyncEnabled"> Sign up for our newsletter\n      </label>\n    </div>\n    <div class="form-group">\n      <button ng-click="save()"\n        type="button"\n        class="btn btn-success btn-fixed-width registration-save-button"\n        ng-disabled="registering">\n        Save <i class="fa fa-white fa-check icon-right"></i>\n      </button>\n      <button type="button" class="btn btn-default btn-fixed-width registration-cancel-button"\n      ng-disabled="registering"\n      ng-click="closeModal()">\n        Cancel <i class="fa fa-white fa-times icon-right"></i>\n      </button>\n    </div>\n  </form>\n</div>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("shoppingcart-button.html",'<li class="shopping-cart" ng-show="!hideShoppingCart && isRiseVisionUser">\n<a href="{{shoppingCartUrl}}" class="shopping-cart-button">\n  <i class="fa fa-shopping-cart"></i>\n  <span id="cartBadge" class="label label-primary" ng-show="cart.items.length">\n    {{cart.items.length | surpressZero}}</span>\n</a>\n</li>\n')
}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("signout-modal.html",'<div class="modal-header">\n  <button type="button" class="close" ng-click="closeModal()" aria-hidden="true">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="sign-out-label" class="modal-title">Sign Out</h2>\n</div>\n<div class="modal-body sign-out-modal">\n  <form role="form">\n    <p>\n      Signing out does not sign you out of your Google Account.\n    </p>\n    <p>\n      If you are on a shared computer you should sign out of your Google Account.\n    </p>\n    <p>\n      <button type="button" class="btn btn-default sign-out-rv-only-button" ng-click="signOut(false)">Sign Out\n        <i class="fa fa-sign-out fa-lg icon-right"></i>\n      </button>\n    </p>\n      <button type="button" class="btn btn-default sign-out-google-account" ng-click="signOut(true)">Sign Out of your Google Account\n        <i class="fa fa-google-plus-square fa-lg icon-right"></i>\n      </button>\n    <p>\n    </p>\n  </form>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("subcompany-banner.html",'<div ng-show="isSubcompanySelected && !inRVAFrame"\n  class="sub-company-alert">\n  You\'re in Sub-Company {{selectedCompanyName}}&nbsp;\n  <a href="" ng-click="switchToMyCompany()" class="link-button">Switch to My Company</a>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("subcompany-modal.html",'<div rv-spinner\n  rv-spinner-key="add-subcompany-modal"\n  rv-spinner-start-active="1">\n<div class="modal-header">\n  <button type="button" class="close" ng-click="closeModal()" aria-hidden="true">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="sub-company-label" class="modal-title">Add Sub-Company</h2>\n</div>\n<div class="modal-body select-subcompany-modal pt-add-subcompany-modal">\n  <form role="form" name="forms.companyForm">\n    <div ng-include="\'company-fields.html\'"></div>\n    <div class="form-group">\n      <a href="" data-dismiss="modal" data-toggle="modal" class="move-subcompany-button"\n        ng-click="moveCompany()">Move a Company Under Your Company</a>\n    </div>\n  </form>\n</div>\n<div class="modal-footer">\n  <button type="button"\n    class="btn btn-success btn-fixed-width add-subcompany-save-button"\n    ng-click="save()" ng-disabled="forms.companyForm.$invalid">Save\n    <i class="fa fa-white fa-check icon-right"></i>\n  </button>\n  <button type="button" class="btn btn-default btn-fixed-width cancel-add-subcompany-button" ng-click="closeModal()">Cancel\n    <i class="fa fa-white fa-times icon-right"></i>\n  </button>\n</div>\n</div>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("system-messages-button-menu.html",'<li class="dropdown-header dropdown-title system-message">\n  Notifications\n</li>\n<li class="divider"></li>\n<li class="system-message"\n  ng-repeat="message in messages"\n  ng-bind-html="renderHtml(message.text)">\n</li>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("system-messages-button.html",'<!-- Desktop and tablet -->\n<li class="dropdown system-messages hidden-xs"\nng-show="isRiseVisionUser && messages.length > 0">\n  <a href="" class="dropdown-toggle system-messages-button">\n    <i class="fa fa-bell"></i>\n    <span class="label label-danger system-messages-badge">{{messages.length | surpressZero}}</span>\n  </a>\n  <ul class="dropdown-menu system-messages system-message-list">\n    <ng-include\n      src="\'system-messages-button-menu.html\'"\n    ></ng-include>\n  </ul>\n</li>\n\n<!-- Mobile -->\n<li\n  class="system-messages"\n  ng-show="isRiseVisionUser  && messages.length > 0"\n  ng-class="{\'visible-xs-inline-block\': isRiseVisionUser && messages.length > 0}">\n    <a href=""\n      class="system-messages-button"\n      action-sheet="\'system-messages-button-menu.html\'"\n      action-sheet-class="system-message-list">\n        <i class="fa fa-bell"></i>\n        <span class="label label-danger system-messages-badge">{{messages.length}}</span>\n    </a>\n</li>\n')}])}(),function(){try{app=angular.module("risevision.common.header.templates")}catch(err){app=angular.module("risevision.common.header.templates",[])}app.run(["$templateCache",function($templateCache){"use strict";$templateCache.put("user-settings-modal.html",'<div rv-spinner="spinnerOptions"\nrv-spinner-key="user-settings-modal"\nrv-spinner-start-active="1">\n<div class="modal-header">\n  <button type="button" class="close" data-dismiss="modal" aria-hidden="true" ng-click="closeModal()">\n    <i class="fa fa-times"></i>\n  </button>\n  <h2 id="user-settings-label" class="modal-title">\n  <span ng-if="!isAdd">User Settings</span>\n  <span ng-if="isAdd">Add User</span>\n  </h2>\n</div>\n<div class="modal-body user-settings-modal">\n  <form role="form" novalidate name="forms.userSettingsForm">\n    <div class="form-group"\n      ng-class="{ \'has-error\' : forms.userSettingsForm.username.$invalid && !forms.userSettingsForm.username.$pristine }"\n    >\n      <label>\n        Username *\n      </label>\n      <div ng-if="!isAdd">{{user.username}}</div>\n      <input id="user-settings-username"\n        type="email" required name="username"\n        class="form-control"\n        ng-if="isAdd"\n        ng-model="user.username"\n        />\n        <p ng-show="forms.userSettingsForm.username.$invalid && !forms.userSettingsForm.username.$pristine"\n          class="help-block validation-error-message-email">User name must be a valid email address.</p>\n    </div>\n    <div class="form-group"\n      ng-class="{ \'has-error\' : forms.userSettingsForm.firstName.$invalid && !forms.userSettingsForm.firstName.$pristine }">\n      <label for="user-settings-first-name">\n        First Name *\n      </label>\n      <input id="user-settings-first-name"\n        type="text" required name="firstName"\n        class="form-control"\n        ng-model="user.firstName"\n        />\n        <p ng-show="forms.userSettingsForm.firstName.$invalid && !forms.userSettingsForm.firstName.$pristine"\n          class="help-block validation-error-message-firstName">First Name is required.</p>\n    </div>\n    <div class="form-group"\n      ng-class="{ \'has-error\' : forms.userSettingsForm.lastName.$invalid && !forms.userSettingsForm.lastName.$pristine }">\n      <label for="user-settings-last-name">\n        Last Name *\n      </label>\n      <input id="user-settings-last-name"\n        type="text" required name="lastName"\n        class="form-control"\n        ng-model="user.lastName"\n        />\n        <p ng-show="forms.userSettingsForm.lastName.$invalid && !forms.userSettingsForm.lastName.$pristine"\n          class="help-block validation-error-message-lastName">Last Name is required.</p>\n    </div>\n    <div class="form-group">\n      <label for="user-settings-phone">\n        Phone\n      </label>\n      <input\n        id="user-settings-phone"\n        type="tel"\n        class="form-control"\n        ng-model="user.telephone"\n         />\n    </div>\n    <div class="form-group"\n      ng-class="{ \'has-error\' : forms.userSettingsForm.email.$invalid && !forms.userSettingsForm.email.$pristine }">\n      <label for="user-settings-email">\n        Email *\n      </label>\n      <input\n        id="user-settings-email"\n        type="email" required name="email"\n        class="form-control"\n        ng-model="user.email"\n        />\n        <p ng-show="forms.userSettingsForm.email.$invalid && !forms.userSettingsForm.email.$pristine"\n          class="help-block validation-error-message-email">A valid email address is required.</p>\n    </div>\n    <div class="checkbox">\n      <label>\n        <input type="checkbox"\n          id="user-settings-newsletter"\n          ng-model="user.mailSyncEnabled">\n          Subscribe To Email Updates\n      </label>\n    </div>\n    <div class="form-group">\n      <label>\n        Roles\n      </label>\n      <div class="checkbox" ng-repeat="role in availableRoles"\n        ng-show="editRoleVisible(role)">\n        <label>\n          <input type="checkbox"\n            id="user-settings-{{role.key}}"\n            checklist-model="user.roles"\n            ng-disabled="!editRoleAllowed(role)"\n            checklist-value="role.key"> {{role.name}}\n        </label>\n      </div>\n    </div>\n    <div class="form-group" ng-if="user.lastLogin">\n      <label>\n        Last Login\n      </label>\n      <div>{{user.lastLogin | humanReadableDateTime}}</div>\n    </div>\n    <div class="form-group" ng-if="!editingYourself && !isAdd">\n      <label for="user-settings-status">\n        Status\n      </label>\n      <select id="user-settings-status"\n        class="form-control selectpicker" ng-model="user.status">\n        <option value="1">Active</option>\n        <option value="0">Inactive</option>\n      </select>\n    </div>\n  </form>\n</div>\n<div class="modal-footer">\n  <button type="button"\n    class="btn btn-success btn-fixed-width"\n    data-dismiss="modal"\n    ng-click="save()" id="save-button">\n    Save <i class="fa fa-white fa-check icon-right"></i>\n  </button>\n  <button type="button" class="btn btn-danger btn-fixed-width"\n    ng-if="!isAdd" ng-click="deleteUser()">\n    Delete <i class="fa fa-white fa-trash-o icon-right"></i>\n  </button>\n  <button type="button" class="btn btn-default btn-fixed-width" ng-click="closeModal()">\n    Cancel <i class="fa fa-white fa-times icon-right"></i>\n  </button>\n</div>\n</div>\n')}])}(),angular.module("risevision.common.header",["risevision.common.userstate","risevision.common.account","risevision.common.gapi","risevision.core.cache","risevision.core.company","risevision.common.company","risevision.common.localstorage","risevision.common.header.templates","risevision.common.loading","risevision.common.userstate","risevision.ui-flow","risevision.common.systemmessages","risevision.core.systemmessages","risevision.core.oauth2","risevision.common.geodata","risevision.store.data-gadgets","risevision.common.util","risevision.core.userprofile","risevision.common.registration","risevision.common.shoppingcart","checklist-model","ui.bootstrap","ngSanitize","rvScrollEvent","ngCsv","ngTouch"]).factory("bindToScopeWithWatch",[function(){return function(fnToWatch,scopeVar,scope){scope.$watch(function(){return fnToWatch.call()},function(val){scope[scopeVar]=val})}}]).directive("commonHeader",["$modal","$rootScope","$q","$loading","$interval","oauth2APILoader","$log","$templateCache","userState","$location","bindToScopeWithWatch","$document",function($modal,$rootScope,$q,$loading,$interval,oauth2APILoader,$log,$templateCache,userState,$location,bindToScopeWithWatch,$document){return{restrict:"E",template:$templateCache.get("common-header.html"),scope:!1,link:function($scope,element,attr){$scope.navCollapsed=!0,$scope.inRVAFrame=userState.inRVAFrame(),$scope[attr.navOptions]||($scope.navOptions=[{title:"Home",link:"#/"},{title:"Store",link:""},{title:"Account",link:""},{title:"Sellers",link:""},{title:"Platform",link:"http://rva.risevision.com/",target:"_blank"}]),$scope.hideShoppingCart=attr.hideShoppingCart&&"0"!==attr.hideShoppingCart&&"false"!==attr.hideShoppingCart,$scope.hideHelpMenu=attr.hideHelpMenu&&"0"!==attr.hideHelpMenu&&"false"!==attr.hideHelpMenu,bindToScopeWithWatch(userState.isRiseVisionUser,"isRiseVisionUser",$scope),$rootScope.$on("$stateChangeSuccess",function(){$scope.inRVAFrame&&$location.search("inRVA",$scope.inRVAFrame)});var viewPortTag=$document[0].createElement("meta");viewPortTag.id="viewport",viewPortTag.name="viewport",viewPortTag.content="width=device-width, initial-scale=1, user-scalable=no",$document[0].getElementsByTagName("head")[0].appendChild(viewPortTag)}}}]).directive("ngEnter",function(){return function(scope,element,attrs){element.bind("keydown keypress",function(event){13===event.which&&(scope.$apply(function(){scope.$eval(attrs.ngEnter)}),event.preventDefault())})}}),angular.module("risevision.common.header").controller("GlobalAlertsCtrl",["$scope","$rootScope",function($scope,$rootScope){$scope.errors=[],$scope.$on("risevision.user.authorized",function(){$scope.errors.length=0}),$rootScope.$on("risevision.common.globalError",function(event,message){$scope.errors.push(message)}),$scope.dismiss=function(messageType,index){$scope[messageType].splice(index,1)}}]),angular.module("risevision.common.header").controller("AuthButtonsCtr",["$scope","$modal","$templateCache","userState","$loading","cookieStore","$log","uiFlowManager","oauth2APILoader","bindToScopeWithWatch",function($scope,$modal,$templateCache,userState,$loading,cookieStore,$log,uiFlowManager,oauth2APILoader,bindToScopeWithWatch){window.$loading=$loading,$scope.spinnerOptions={color:"#999",hwaccel:!0,radius:10},$scope.register=function(){cookieStore.remove("surpressRegistration"),uiFlowManager.invalidateStatus("registrationComplete")},$scope.$on("risevision.user.signedOut",function(){cookieStore.remove("surpressRegistration")}),$scope.$on("risevision.uiStatus.validationCancelled",function(){cookieStore.remove("surpressRegistration")}),$scope.$watch(function(){return uiFlowManager.isStatusUndetermined()},function(undetermined){$scope.undetermined=undetermined,$scope.loading=undetermined}),$scope.$watch(function(){return uiFlowManager.getStatus()},function(newStatus,oldStatus){newStatus&&($log.debug("status changed from",oldStatus,"to",newStatus),"registeredAsRiseVisionUser"===newStatus?(!userState.registrationModalInstance&&userState.isLoggedIn()&&(userState.registrationModalInstance=$modal.open({template:$templateCache.get("registration-modal.html"),controller:"RegistrationModalCtrl",backdrop:"static",resolve:{account:["getUserProfile","getAccount",function(getUserProfile,getAccount){return getUserProfile(userState.getUsername()).then(null,function(resp){return resp&&"User has not yet accepted the Terms of Service"===resp.message?getAccount():null}).catch(function(){return null})}]}})),userState.registrationModalInstance.result.finally(function(){userState.registrationModalInstance=null,uiFlowManager.invalidateStatus()})):"signedInWithGoogle"===newStatus&&$scope.login())}),$scope.$watch(function(){return userState.isLoggedIn()},function(loggedIn){$scope.isLoggedIn=loggedIn,loggedIn===!0&&($scope.userPicture=userState.getUserPicture())}),bindToScopeWithWatch(userState.isRiseVisionUser,"isRiseVisionUser",$scope),$scope.$watch(function(){return userState.getUsername()},function(username){username&&($scope.profile=userState.getCopyOfProfile())}),$scope.login=function(endStatus){$loading.startGlobal("auth-buttons-login"),userState.authenticate(!0).then().finally(function(){$loading.stopGlobal("auth-buttons-login"),uiFlowManager.invalidateStatus(endStatus)})},$scope.logout=function(){$scope.confirmSignOut()},$scope.confirmSignOut=function(size){var modalInstance=$modal.open({template:$templateCache.get("signout-modal.html"),controller:"SignOutModalCtrl",size:size});modalInstance.result.finally(function(){uiFlowManager.invalidateStatus("registrationComplete")})},$scope.userSettings=function(size){$modal.open({template:$templateCache.get("user-settings-modal.html"),controller:"UserSettingsModalCtrl",size:size,resolve:{username:function(){return userState.getUsername()},add:function(){return!1}}})},$scope.paymentMethods=function(size){$modal.open({template:$templateCache.get("payment-methods-modal.html"),controller:"PaymentMethodsModalCtrl",size:size})},$loading.startGlobal("auth-buttons-silent"),oauth2APILoader().then().finally(function(){userState.authenticate(!1).then().finally(function(){$loading.stopGlobal("auth-buttons-silent"),uiFlowManager.isStatusUndetermined()||uiFlowManager.invalidateStatus("registrationComplete")})})}]),angular.module("risevision.common.header").controller("CompanyButtonsCtrl",["$scope","$modal","$templateCache","userState","getCompany","$location","selectedCompanyUrlHandler",function($scope,$modal,$templateCache,userState,getCompany,$location,selectedCompanyUrlHandler){$scope.inRVAFrame=userState.inRVAFrame(),$scope.$watch(function(){return userState.getSelectedCompanyId()},function(newCompanyId){newCompanyId&&($scope.isSubcompanySelected=userState.isSubcompanySelected(),selectedCompanyUrlHandler.updateUrl())}),$scope.$watch(function(){return userState.getSelectedCompanyName()},function(selectedCompanyName){selectedCompanyName&&($scope.selectedCompanyName=userState.getSelectedCompanyName())}),$scope.$watch(function(){return userState.isRiseVisionUser()},function(isRvUser){$scope.isRiseVisionUser=isRvUser,isRvUser===!0&&($scope.isUserAdmin=userState.isUserAdmin(),$scope.isPurchaser=userState.isPurchaser())}),$scope.$watch(function(){return userState.isRiseAdmin()},function(isRvAdmin){$scope.isRiseVisionAdmin=isRvAdmin}),$scope.$watch(function(){return userState.getUserCompanyId()},function(is){is&&selectedCompanyUrlHandler.init()}),$scope.$on("$stateChangeSuccess",selectedCompanyUrlHandler.updateSelectedCompanyFromUrl),$scope.$on("$routeChangeSuccess",selectedCompanyUrlHandler.updateSelectedCompanyFromUrl),$scope.addSubCompany=function(size){$modal.open({template:$templateCache.get("subcompany-modal.html"),controller:"SubCompanyModalCtrl",size:size})},$scope.companySettings=function(companyId,size){$modal.open({template:$templateCache.get("company-settings-modal.html"),controller:"CompanySettingsModalCtrl",size:size,resolve:{companyId:function(){return userState.getSelectedCompanyId()}}})},$scope.companyUsers=function(size){$modal.open({template:$templateCache.get("company-users-modal.html"),controller:"CompanyUsersModalCtrl",size:size,backdrop:!0,resolve:{company:function(){return userState.getCopyOfSelectedCompany()}}})},$scope.switchCompany=function(){var modalInstance=$modal.open({template:$templateCache.get("company-selector-modal.html"),controller:"companySelectorCtr",backdrop:!0,resolve:{companyId:function(){return userState.getSelectedCompanyId()}}});modalInstance.result.then(userState.switchCompany)},$scope.moveCompany=function(size){$modal.open({template:$templateCache.get("move-company-modal.html"),controller:"MoveCompanyModalCtrl",size:size})},$scope.resetCompany=function(){userState.resetCompany()}}]),angular.module("risevision.common.header").filter("surpressZero",function(){return function(num){return num?num:""}}).controller("ShoppingCartButtonCtrl",["$scope","shoppingCart","userState","$log","STORE_URL",function($scope,shoppingCart,userState,$log,STORE_URL){$scope.shoppingCartUrl=STORE_URL+"#/shopping-cart",$scope.cart={},$scope.cart.items=shoppingCart.getItems(),$scope.$watch(function(){return userState.isRiseVisionUser()},function(isRvUser){$scope.isRiseVisionUser=isRvUser}),$scope.$on("risevision.user.signedOut",function(){shoppingCart.destroy()})}]),angular.module("risevision.common.header").controller("CloseFrameButtonCtrl",["$scope","$log","gadgetsService",function($scope,$log,gadgetsService){$scope.closeIFrame=function(){$log.debug("gadgetsService.closeIFrame"),gadgetsService.closeIFrame()}}]),angular.module("risevision.common.header").controller("SystemMessagesButtonCtrl",["$scope","userState","$log","$sce","getCoreSystemMessages","systemMessages",function($scope,userState,$log,$sce,getCoreSystemMessages,systemMessages){$scope.messages=systemMessages,$scope.$watch(function(){return userState.isRiseVisionUser()},function(isRvUser){$scope.isRiseVisionUser=isRvUser}),$scope.renderHtml=function(html_code){return $sce.trustAsHtml(html_code)},systemMessages.registerRetriever(function(){return getCoreSystemMessages(userState.getSelectedCompanyId())}),$scope.$watch(function(){return userState.getSelectedCompanyId()},function(newCompanyId){null!==newCompanyId?systemMessages.resetAndGetMessages().then($scope.apply):systemMessages.clear()})}]),angular.module("risevision.common.header").controller("PaymentMethodsModalCtrl",["$scope","$modalInstance","$modal","$templateCache",function($scope,$modalInstance,$modal,$templateCache){$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.creditCards=function(size){$modal.open({template:$templateCache.get("credit-cards-modal.html"),controller:"CreditCardsModalCtrl",size:size})}}]).controller("CreditCardsModalCtrl",["$scope","$modalInstance",function($scope,$modalInstance){$scope.closeModal=function(){$modalInstance.dismiss("cancel")}}]),angular.module("risevision.common.header").controller("RegistrationModalCtrl",["$scope","$modalInstance","$loading","registerAccount","$log","cookieStore","userState","pick","uiFlowManager","humanReadableError","agreeToTermsAndUpdateUser","account",function($scope,$modalInstance,$loading,registerAccount,$log,cookieStore,userState,pick,uiFlowManager,humanReadableError,agreeToTermsAndUpdateUser,account){var newUser=!account,copyOfProfile=account?account:userState.getCopyOfProfile()||{};cookieStore.remove("surpressRegistration"),$scope.profile=pick(copyOfProfile,"email","mailSyncEnabled","firstName","lastName"),$scope.registering=!1,$scope.profile.accepted=angular.isDefined(copyOfProfile.termsAcceptanceDate)&&null!==copyOfProfile.termsAcceptanceDate,angular.isDefined($scope.profile.mailSyncEnabled)||($scope.profile.mailSyncEnabled=!1),$scope.closeModal=function(){cookieStore.put("surpressRegistration",!0),$modalInstance.dismiss("cancel")};var watch=$scope.$watch(function(){return uiFlowManager.isStatusUndetermined()},function(undetermined){undetermined===!0?$loading.start("registration-modal"):undetermined===!1&&("registrationComplete"===uiFlowManager.getStatus()&&($modalInstance.close("success"),watch()),$loading.stop("registration-modal"))});$scope.save=function(){if($scope.forms.registrationForm.accepted.$pristine=!1,$scope.forms.registrationForm.firstName.$pristine=!1,$scope.forms.registrationForm.lastName.$pristine=!1,$scope.forms.registrationForm.email.$pristine=!1,!$scope.forms.registrationForm.$invalid){$scope.registering=!0,$loading.start("registration-modal");var action;action=newUser?registerAccount(userState.getUsername(),$scope.profile):agreeToTermsAndUpdateUser(userState.getUsername(),$scope.profile),action.then(function(){userState.authenticate(!1).then().finally(function(){$modalInstance.close("success"),$loading.stop("registration-modal")})},function(err){alert("Error: "+humanReadableError(err)),$log.error(err)}).finally(function(){$scope.registering=!1,userState.authenticate(!1)})}},$scope.forms={}}]),angular.module("risevision.common.header").controller("MoveCompanyModalCtrl",["$scope","$modalInstance","moveCompany","lookupCompany","userState","$loading",function($scope,$modalInstance,moveCompany,lookupCompany,userState,$loading){$scope.company={},$scope.errors=[],$scope.messages=[],$scope.$watch("loading",function(loading){loading?$loading.start("move-company-modal"):$loading.stop("move-company-modal")}),$scope.selectedCompany=userState.getCopyOfSelectedCompany(),$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.moveCompany=function(){$scope.messages=[],$scope.loading=!0,moveCompany($scope.company.authKey,userState.getSelectedCompanyId()).then(function(){$scope.messages.push("Success. The company has been moved under your company."),$scope.moveSuccess=!0},function(err){$scope.errors.push("Error: "+JSON.stringify(err))}).finally(function(){$scope.loading=!1})},$scope.getCompany=function(){$scope.errors=[],$scope.messages=[],$scope.loading=!0,lookupCompany($scope.company.authKey).then(function(resp){angular.extend($scope.company,resp)},function(resp){$scope.errors.push("Failed to retrieve company. "+resp.message)}).finally(function(){$scope.loading=!1})},$scope.$watch("moveSuccess",function(moveSuccess){$scope.dismissButtonText=moveSuccess?"Close":"Cancel"})}]),angular.module("risevision.common.header").controller("CompanySettingsModalCtrl",["$scope","$modalInstance","updateCompany","companyId","COUNTRIES","REGIONS_CA","REGIONS_US","getCompany","regenerateCompanyField","$window","$loading","humanReadableError","userState","deleteCompany",function($scope,$modalInstance,updateCompany,companyId,COUNTRIES,REGIONS_CA,REGIONS_US,getCompany,regenerateCompanyField,$window,$loading,humanReadableError,userState,deleteCompany){function setSellerId(){$scope.company.sellerId=$scope.isRiseStoreAdmin?$scope.company.isSeller?"yes":null:void 0}$scope.company={id:companyId},$scope.countries=COUNTRIES,$scope.regionsCA=REGIONS_CA,$scope.regionsUS=REGIONS_US,$scope.isRiseStoreAdmin=userState.isRiseStoreAdmin(),$scope.$watch("loading",function(loading){loading?$loading.start("company-settings-modal"):$loading.stop("company-settings-modal")}),$scope.loading=!1,$scope.forms={},companyId&&($scope.loading=!0,getCompany(companyId).then(function(company){$scope.company=company,$scope.company.isSeller=company&&company.sellerId?!0:!1},function(resp){alert("An error has occurred. "+humanReadableError(resp))}).finally(function(){$scope.loading=!1})),$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.save=function(){$scope.loading=!0,setSellerId(),updateCompany($scope.company.id,$scope.company).then(function(){userState.updateCompanySettings($scope.company),$modalInstance.close("success")}).catch(function(error){alert("Error(s): "+humanReadableError(error))}).finally(function(){$scope.loading=!1})},$scope.deleteCompany=function(){confirm("Are you sure you want to delete this company?")&&($scope.loading=!0,deleteCompany($scope.company.id).then(function(){userState.getUserCompanyId()===$scope.company.id?userState.signOut():userState.getSelectedCompanyId()===$scope.company.id&&userState.resetCompany(),$modalInstance.close("success")}).catch(function(error){alert("Error(s): "+humanReadableError(error))}).finally(function(){$scope.loading=!1}))},$scope.resetAuthKey=function(){$window.confirm("Resetting the Company Authentication Key will cause existing Data Gadgets to no longer report data until they are updated with the new Key.")&&($loading.start("company-settings-modal"),regenerateCompanyField($scope.company.id,"authKey").then(function(resp){$scope.company.authKey=resp.item,alert("Successfully changed authentication key.")},function(error){alert("Error: "+humanReadableError(error))}).finally(function(){$loading.stop("company-settings-modal")}))},$scope.resetClaimId=function(){$window.confirm("Resetting the Company Claim Id will cause existing installations to no longer be associated with your Company.")&&($loading.start("company-settings-modal"),regenerateCompanyField($scope.company.id,"claimId").then(function(resp){$scope.company.claimId=resp.item,alert("Successfully changed Claim ID.")},function(error){alert("Error: "+humanReadableError(error))}).finally(function(){$loading.stop("company-settings-modal")}))}}]),angular.module("risevision.common.header").controller("SubCompanyModalCtrl",["$scope","$modalInstance","$modal","$templateCache","createCompany","COUNTRIES","REGIONS_CA","REGIONS_US","userState","$loading","humanReadableError",function($scope,$modalInstance,$modal,$templateCache,createCompany,COUNTRIES,REGIONS_CA,REGIONS_US,userState,$loading,humanReadableError){$scope.company={},$scope.countries=COUNTRIES,$scope.regionsCA=REGIONS_CA,$scope.regionsUS=REGIONS_US,$scope.forms={},$scope.$watch("loading",function(loading){loading?$loading.start("add-subcompany-modal"):$loading.stop("add-subcompany-modal")}),$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.save=function(){$scope.loading=!0,createCompany(userState.getSelectedCompanyId(),$scope.company).then(function(){$modalInstance.close("success")},function(err){alert("Error: "+humanReadableError(err))}).finally(function(){$scope.loading=!1})},$scope.moveCompany=function(size){$modal.open({template:$templateCache.get("move-company-modal.html"),controller:"MoveCompanyModalCtrl",size:size})}}]),angular.module("risevision.common.header").controller("companySelectorCtr",["$scope","$modalInstance","companyService","companyId","BaseList","$loading",function($scope,$modalInstance,companyService,companyId,BaseList,$loading){function loadCompanies(){$scope.companies.endOfList||($scope.loading=!0,companyService.getCompanies(companyId,$scope.search.searchString,$scope.companies.cursor,DB_MAX_COUNT,null).then(function(result){result&&result.items&&$scope.companies.add(result.items,result.cursor)}).finally(function(){$scope.loading=!1}))}var DB_MAX_COUNT=20;$scope.companies=new BaseList(DB_MAX_COUNT),$scope.search={searchString:""},$scope.$watch("loading",function(loading){loading?($loading.start("company-selector-modal"),$loading.start("company-selector-modal-list")):($loading.stop("company-selector-modal"),$loading.stop("company-selector-modal-list"))}),$scope.closeModal=function(){$modalInstance.dismiss("cancel")},0===$scope.companies.list.length&&loadCompanies(),$scope.doSearch=function(){$scope.companies.clear(),loadCompanies()},$scope.setCompany=function(company){$modalInstance.close(company)},$scope.handleScroll=function(event,isEndEvent){isEndEvent&&event.target.scrollHeight-event.target.clientHeight-event.target.scrollTop<20&&loadCompanies()}}]),angular.module("risevision.common.header").controller("SubcompanyBannerCtrl",["$scope","$modal","$loading","userState",function($scope,$modal,$loading,userState){$scope.inRVAFrame=userState.inRVAFrame(),$scope.$watch(function(){return userState.getSelectedCompanyId()},function(selectedCompanyId){selectedCompanyId&&($scope.isSubcompanySelected=userState.isSubcompanySelected(),$scope.selectedCompanyName=userState.getSelectedCompanyName())}),$scope.switchToMyCompany=function(){userState.resetCompany()}}]),angular.module("risevision.common.header").filter("roleLabel",["userRoleMap",function(userRoleMap){return function(key){return userRoleMap[key]}}]).controller("CompanyUsersModalCtrl",["$scope","$modalInstance","$modal","$templateCache","company","getUsers","$loading",function($scope,$modalInstance,$modal,$templateCache,company,getUsers,$loading){$scope.$watch("loading",function(loading){loading?($loading.start("company-users-modal"),$loading.start("company-users-list")):($loading.stop("company-users-modal"),$loading.stop("company-users-list"))}),$scope.sort={field:"username",descending:!1},$scope.search={searchString:""},$scope.changeSorting=function(field){var sort=$scope.sort;sort.field===field?sort.descending=!sort.descending:(sort.field=field,sort.descending=!1)};var loadUsers=function(){$scope.loading=!0,getUsers({companyId:company.id,search:$scope.search.searchString}).then(function(users){$scope.users=users}).finally(function(){$scope.loading=!1})};loadUsers(),$scope.addUser=function(size){var instance=$modal.open({template:$templateCache.get("user-settings-modal.html"),controller:"AddUserModalCtrl",size:size,resolve:{companyId:function(){return company.id}}});instance.result.finally(loadUsers)},$scope.editUser=function(username,size){var instance=$modal.open({template:$templateCache.get("user-settings-modal.html"),controller:"UserSettingsModalCtrl",size:size,resolve:{username:function(){return username},add:function(){return!1}}});instance.result.finally(loadUsers)},$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.doSearch=function(){$scope.users=[],loadUsers()
}}]),angular.module("risevision.common.header").filter("humanReadableDateTime",[function(){return function(d){return d?(d=new Date(d),d.getMonth()+1+"/"+d.getDate()+"/"+d.getFullYear()+" at "+d.toLocaleTimeString()+" EST"):""}}]).controller("AddUserModalCtrl",["$scope","addUser","$modalInstance","companyId","userState","userRoleMap","humanReadableError","$loading","$timeout",function($scope,addUser,$modalInstance,companyId,userState,userRoleMap,humanReadableError,$loading){$scope.user={mailSyncEnabled:!1},$scope.isAdd=!0,$scope.availableRoles=[],angular.forEach(userRoleMap,function(v,k){$scope.availableRoles.push({key:k,name:v})}),$scope.$watch("user.status",function(status){"string"==typeof $scope.user.status&&($scope.user.status=parseInt(status))}),$scope.$watch("loading",function(loading){loading?$loading.start("user-settings-modal"):$loading.stop("user-settings-modal")}),$scope.save=function(){$scope.forms.userSettingsForm.email.$pristine=!1,$scope.forms.userSettingsForm.username.$pristine=!1,$scope.forms.userSettingsForm.firstName.$pristine=!1,$scope.forms.userSettingsForm.lastName.$pristine=!1,$scope.forms.userSettingsForm.$invalid||($scope.loading=!0,addUser(companyId,$scope.user.username,$scope.user).then(function(){$modalInstance.close("success")},function(error){alert("Error"+humanReadableError(error))}).finally(function(){$scope.loading=!1}))},$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.editRoleAllowed=function(role){return userState.isRiseAdmin()?!0:userState.isUserAdmin()?"sa"===role.key||"ba"===role.key?!1:!0:!1},$scope.editRoleVisible=function(role){return userState.isRiseAdmin()?!0:userState.isUserAdmin()||userState.isRiseVisionUser()?"sa"===role.key||"ba"===role.key?!1:!0:!1},$scope.forms={}}]).controller("UserSettingsModalCtrl",["$scope","$modalInstance","updateUser","getUserProfile","deleteUser","addUser","username","userRoleMap","$log","$loading","userState","uiFlowManager","humanReadableError",function($scope,$modalInstance,updateUser,getUserProfile,deleteUser,addUser,username,userRoleMap,$log,$loading,userState,uiFlowManager,humanReadableError){$scope.user={},$scope.$watch("loading",function(loading){loading?$loading.start("user-settings-modal"):$loading.stop("user-settings-modal")}),$scope.availableRoles=[],angular.forEach(userRoleMap,function(v,k){$scope.availableRoles.push({key:k,name:v})}),$scope.$watch("user.status",function(status){"string"==typeof $scope.user.status&&($scope.user.status=parseInt(status))}),$scope.isUserAdmin=userState.isUserAdmin(),$scope.username=username,$scope.loading=!0,getUserProfile(username).then(function(user){$scope.user=user,$scope.editingYourself=userState.getUsername()===user.username}).finally(function(){$scope.loading=!1}),$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.deleteUser=function(){confirm("Are you sure you want to delete this user?")&&deleteUser($scope.username).then(function(){$scope.username===userState.getUsername()&&userState.signOut().then().finally(function(){uiFlowManager.invalidateStatus("registrationComplete")})}).finally(function(){$modalInstance.dismiss("deleted")})},$scope.save=function(){$scope.forms.userSettingsForm.email.$pristine=!1,$scope.forms.userSettingsForm.firstName.$pristine=!1,$scope.forms.userSettingsForm.lastName.$pristine=!1,$scope.forms.userSettingsForm.$invalid||($scope.loading=!0,updateUser(username,$scope.user).then(function(){$modalInstance.close("success")},function(error){$log.debug(error),alert("Error: "+humanReadableError(error))}).finally(function(){username===userState.getUsername()&&userState.refreshProfile(),$scope.loading=!1}))},$scope.editRoleAllowed=function(role){return userState.isRiseAdmin()?!0:userState.isUserAdmin()?"sa"===role.key||"ba"===role.key?!1:"ua"===role.key&&userState.getUsername()===$scope.user.username?!1:!0:!1},$scope.editRoleVisible=function(role){return userState.isRiseAdmin()?!0:userState.isUserAdmin()||userState.isRiseVisionUser()?"sa"===role.key||"ba"===role.key?!1:!0:!1},$scope.forms={}}]),angular.module("risevision.common.header").controller("SignOutModalCtrl",["$scope","$modalInstance","$log","userState",function($scope,$modalInstance,$log,userState){$scope.closeModal=function(){$modalInstance.dismiss("cancel")},$scope.signOut=function(signOutGoogle){userState.signOut(signOutGoogle).then(function(){$log.debug("user signed out")},function(err){$log.error("sign out failed",err)}).finally(function(){$modalInstance.dismiss("success")})}}]),angular.module("risevision.common.header").service("offCanvas",["$window",function($window){var service={visible:!1,enabled:!1};return service.enabled=angular.element($window).width()<=1200?!0:!1,service.toggle=function(event){event&&event.stopPropagation(),(service.enabled||service.visible)&&(service.visible=!service.visible,service.visible?service.nav.addClass("is-off-canvas-opened"):service.nav.removeClass("is-off-canvas-opened"))},service.registerNav=function(nav){service.nav=nav,service.nav.addClass("off-canvas--container")},window.onresize=function(){service.enabled=angular.element($window).width()<=1200?!0:!1},service}]).directive("offCanvasContent",["offCanvas","$swipe",function(offCanvas,$swipe){return{restrict:"A",link:function(scope,iElement){var startCoords;$swipe.bind(iElement,{start:function(coords){startCoords=coords},end:function(coords){coords.x-startCoords.x>0&&offCanvas.toggle()}})}}}]).directive("offCanvasNav",["offCanvas","$swipe",function(offCanvas,$swipe){return{restrict:"A",link:function(scope,iElement){iElement.addClass("off-canvas--nav"),offCanvas.registerNav(iElement);var startCoords;$swipe.bind(iElement,{start:function(coords){startCoords=coords},end:function(coords){coords.x-startCoords.x<0&&offCanvas.toggle()}}),iElement.bind("tap",offCanvas.toggle),iElement.bind("click",offCanvas.toggle)}}}]).directive("offCanvasToggle",["offCanvas",function(offCanvas){return{restrict:"A",link:function(scope,iElement){iElement.bind("tap",offCanvas.toggle),iElement.bind("click",offCanvas.toggle)}}}]),angular.module("risevision.common.header").directive("actionSheet",["$document","$compile","$timeout",function($document,$compile,$timeout){return{restrict:"A",link:function(scope,iElement,iAttrs){var body=$document.find("body").eq(0),isVisible=!1,backdropDomEl=document.getElementById("action-sheet-backdrop");angular.isObject(backdropDomEl)?backdropDomEl=angular.element(backdropDomEl):(backdropDomEl=angular.element('<div id="action-sheet-backdrop" class="modal-backdrop"></div>'),body.append(backdropDomEl)),scope.templateUrl=scope.$eval(iAttrs.actionSheet),scope.title=scope.$eval(iAttrs.title);var angularDomEl=angular.element('<div class="action-sheet is-action-sheet-closed"><ng-include src="templateUrl"></ng-include></div>'),actionSheetDomEl=$compile(angularDomEl)(scope);body.append(actionSheetDomEl);var toggle=function(){isVisible=!isVisible,isVisible?(actionSheetDomEl.toggleClass("is-action-sheet-closed"),$timeout(function(){actionSheetDomEl.toggleClass("is-action-sheet-opened"),backdropDomEl.toggleClass("is-action-sheet-opened")})):(actionSheetDomEl.toggleClass("is-action-sheet-opened"),backdropDomEl.toggleClass("is-action-sheet-opened"),$timeout(function(){actionSheetDomEl.toggleClass("is-action-sheet-closed")},500)),isVisible?(backdropDomEl.bind("tap",toggle),backdropDomEl.bind("click",toggle)):(backdropDomEl.unbind("tap"),backdropDomEl.unbind("click"))};iAttrs.actionSheetClass&&iAttrs.actionSheetClass.split(" ").forEach(function(cls){actionSheetDomEl.addClass(cls)}),iElement.bind("tap",toggle),iElement.bind("click",toggle),angularDomEl.bind("tap",toggle),angularDomEl.bind("click",toggle)}}}]).directive("replaceInclude",function(){return{require:"ngInclude",restrict:"A",link:function(scope,el){el.replaceWith(el.children())}}}),function(angular){"use strict";var INTERVAL_DELAY=150;angular.module("rvScrollEvent",[]).directive("rvScrollEvent",["$parse","$window",function($parse,$window){return{scope:!1,link:function(scope,element,attr){var interval,handler,fn=$parse(attr.rvScrollEvent),el=element[0],scrollEvent="scroll",scrollPosition={x:0,y:0},bindScroll=function(){handler=function(event){scrollPosition.x=el.scrollLeft,scrollPosition.y=el.scrollTop,startInterval(event),unbindScroll(),scrollTrigger(event,!1)},element.bind(scrollEvent,handler)},startInterval=function(event){interval=$window.setInterval(function(){scrollPosition.x===el.scrollLeft&&scrollPosition.y===el.scrollTop?($window.clearInterval(interval),bindScroll(),scrollTrigger(event,!0)):(scrollPosition.x=el.scrollLeft,scrollPosition.y=el.scrollTop)},INTERVAL_DELAY)},unbindScroll=function(){element.unbind(scrollEvent,handler)},scrollTrigger=function(event,isEndEvent){scope.$apply(function(){fn(scope,{$event:event,isEndEvent:isEndEvent})})};bindScroll()}}}])}(angular),function(angular){"use strict";angular.module("risevision.common.util",[]).value("humanReadableError",function(resp){var message;return message=resp.message?resp.message:resp.error?resp.error.message?resp.message:resp.error:resp,JSON.stringify(message)}).value("BaseList",function(maxCount){this.list=[],this.maxCount=maxCount?maxCount:20,this.cursor=null,this.endOfList=!1,this.searchString="",this.clear=function(){this.list=[],this.cursor=null,this.endOfList=!1},this.append=function(items){for(var i=0;i<items.length;i++)this.list.push(items[i])},this.concat=function(items){this.list=this.list.concat(items)},this.add=function(items,cursor){this.cursor=cursor,this.endOfList=items.length<maxCount,this.concat(items)},this.remove=function(index){this.list.splice(index,1)}}).factory("dateIsInRange",[function(){return function(date,strStartDate,strEndDate){var re,dt,res=!0;try{strStartDate&&(re=strStartDate.match(/(\d{4})\-(\d{2})\-(\d{2})/),dt=new Date(re[1],parseInt(re[2])-1,re[3],0,0,0,0),res=date>=dt),res&&strEndDate&&(re=strEndDate.match(/(\d{4})\-(\d{2})\-(\d{2})/),dt=new Date(re[1],parseInt(re[2])-1,re[3],0,0,0,0),res=dt>=date)}catch(e){res=!1}return res}}])}(angular),angular.module("risevision.common.geodata",[]).value("COUNTRIES",[["Afghanistan","AF"],["Albania","AL"],["Algeria","DZ"],["American Samoa","AS"],["Andorra","AD"],["Angola","AO"],["Anguilla","AI"],["Antarctica","AQ"],["Antigua and Barbuda","AG"],["Argentina","AR"],["Armenia","AM"],["Aruba","AW"],["Australia","AU"],["Austria","AT"],["Azerbaijan","AZ"],["Bahamas","BS"],["Bahrain","BH"],["Bangladesh","BD"],["Barbados","BB"],["Belarus","BY"],["Belgium","BE"],["Belize","BZ"],["Benin","BJ"],["Bermuda","BM"],["Bhutan","BT"],["Bolivia","BO"],["Bosnia and Herzegovina","BA"],["Botswana","BW"],["Bouvet Island","BV"],["Brazil","BR"],["British Indian Ocean Territory","IO"],["British Virgin Islands","VG"],["Brunei Darussalam","BN"],["Bulgaria","BG"],["Burkina Faso","BF"],["Burundi","BI"],["Cambodia","KH"],["Cameroon","CM"],["Canada","CA"],["Cape Verde","CV"],["Cayman Islands","KY"],["Central African Republic","CF"],["Chad","TD"],["Chile","CL"],["China","CN"],["Christmas Island","CX"],["Cocos","CC"],["Colombia","CO"],["Comoros","KM"],["Congo","CG"],["Cook Islands","CK"],["Costa Rica","CR"],["Croatia","HR"],["Cuba","CU"],["Cyprus","CY"],["Czech Republic","CZ"],["Denmark","DK"],["Djibouti","DJ"],["Dominica","DM"],["Dominican Republic","DO"],["East Timor","TP"],["Ecuador","EC"],["Egypt","EG"],["El Salvador","SV"],["Equatorial Guinea","GQ"],["Eritrea","ER"],["Estonia","EE"],["Ethiopia","ET"],["Falkland Islands","FK"],["Faroe Islands","FO"],["Fiji","FJ"],["Finland","FI"],["France","FR"],["French Guiana","GF"],["French Polynesia","PF"],["French Southern Territories","TF"],["Gabon","GA"],["Gambia","GM"],["Georgia","GE"],["Germany","DE"],["Ghana","GH"],["Gibraltar","GI"],["Greece","GR"],["Greenland","GL"],["Grenada","GD"],["Guadeloupe","GP"],["Guam","GU"],["Guatemala","GT"],["Guinea","GN"],["Guinea-Bissau","GW"],["Guyana","GY"],["Haiti","HT"],["Heard and McDonald Islands","HM"],["Honduras","HN"],["Hong Kong","HK"],["Hungary","HU"],["Iceland","IS"],["India","IN"],["Indonesia","ID"],["Iran","IR"],["Iraq","IQ"],["Ireland","IE"],["Israel","IL"],["Italy","IT"],["Ivory Coast","CI"],["Jamaica","JM"],["Japan","JP"],["Jordan","JO"],["Kazakhstan","KZ"],["Kenya","KE"],["Kiribati","KI"],["Kuwait","KW"],["Kyrgyzstan","KG"],["Laos","LA"],["Latvia","LV"],["Lebanon","LB"],["Lesotho","LS"],["Liberia","LR"],["Libya","LY"],["Liechtenstein","LI"],["Lithuania","LT"],["Luxembourg","LU"],["Macau","MO"],["Macedonia","MK"],["Madagascar","MG"],["Malawi","MW"],["Malaysia","MY"],["Maldives","MV"],["Mali","ML"],["Malta","MT"],["Marshall Islands","MH"],["Martinique","MQ"],["Mauritania","MR"],["Mauritius","MU"],["Mayotte","YT"],["Mexico","MX"],["Micronesia","FM"],["Moldova","MD"],["Monaco","MC"],["Mongolia","MN"],["Montserrat","MS"],["Morocco","MA"],["Mozambique","MZ"],["Myanmar","MM"],["Namibia","NA"],["Nauru","NR"],["Nepal","NP"],["Netherlands","NL"],["Netherlands Antilles","AN"],["New Caledonia","NC"],["New Zealand","NZ"],["Nicaragua","NI"],["Niger","NE"],["Nigeria","NG"],["Niue","NU"],["Norfolk Island","NF"],["North Korea","KP"],["Northern Mariana Islands","MP"],["Norway","NO"],["Oman","OM"],["Pakistan","PK"],["Palau","PW"],["Panama","PA"],["Papua New Guinea","PG"],["Paraguay","PY"],["Peru","PE"],["Philippines","PH"],["Pitcairn","PN"],["Poland","PL"],["Portugal","PT"],["Puerto Rico","PR"],["Qatar","QA"],["Reunion","RE"],["Romania","RO"],["Russian Federation","RU"],["Rwanda","RW"],["S. Georgia and S. Sandwich Islands","GS"],["Saint Kitts and Nevis","KN"],["Saint Lucia","LC"],["Saint Vincent and The Grenadines","VC"],["Samoa","WS"],["San Marino","SM"],["Sao Tome and Principe","ST"],["Saudi Arabia","SA"],["Senegal","SN"],["Seychelles","SC"],["Sierra Leone","SL"],["Singapore","SG"],["Slovakia","SK"],["Slovenia","SI"],["Solomon Islands","SB"],["Somalia","SO"],["South Africa","ZA"],["South Korea","KR"],["Soviet Union","SU"],["Spain","ES"],["Sri Lanka","LK"],["St. Helena","SH"],["St. Pierre and Miquelon","PM"],["Sudan","SD"],["Suriname","SR"],["Svalbard and Jan Mayen Islands","SJ"],["Swaziland","SZ"],["Sweden","SE"],["Switzerland","CH"],["Syria","SY"],["Taiwan","TW"],["Tajikistan","TJ"],["Tanzania","TZ"],["Thailand","TH"],["Togo","TG"],["Tokelau","TK"],["Tonga","TO"],["Trinidad and Tobago","TT"],["Tunisia","TN"],["Turkey","TR"],["Turkmenistan","TM"],["Turks and Caicos Islands","TC"],["Tuvalu","TV"],["Uganda","UG"],["Ukraine","UA"],["United Arab Emirates","AE"],["United Kingdom","UK"],["United States","US"],["Uruguay","UY"],["US Minor Outlying Islands","UM"],["US Virgin Islands","VI"],["Uzbekistan","UZ"],["Vanuatu","VU"],["Venezuela","VE"],["Viet Nam","VN"],["Wallis and Futuna Islands","WF"],["Western Sahara","EH"],["Yemen","YE"],["Yugoslavia","YU"],["Zaire","ZR"],["Zambia","ZM"],["Zimbabwe","ZW"]]).value("REGIONS_CA",[["Alberta","AB"],["British Columbia","BC"],["Manitoba","MB"],["New Brunswick","NB"],["Newfoundland and Labrador","NL"],["Northwest Territories","NT"],["Nova Scotia","NS"],["Nunavut","NV"],["Ontario","ON"],["Prince Edward Island","PE"],["Quebec","QC"],["Saskatchewan","SK"],["Yukon Territory","YT"]]).value("REGIONS_US",[["Alabama","AL"],["Alaska","AK"],["Arizona","AZ"],["Arkansas","AR"],["California","CA"],["Colorado","CO"],["Connecticut","CT"],["Delaware","DE"],["District of Columbia","DC"],["Florida","FL"],["Georgia","GA"],["Hawaii","HI"],["Idaho","ID"],["Illinois","IL"],["Indiana","IN"],["Iowa","IA"],["Kansas","KS"],["Kentucky","KY"],["Louisiana","LA"],["Maine","ME"],["Maryland","MD"],["Massachusetts","MA"],["Michigan","MI"],["Minnesota","MN"],["Mississippi","MS"],["Missouri","MO"],["Montana","MT"],["Nebraska","NE"],["Nevada","NV"],["New Hampshire","NH"],["New Jersey","NJ"],["New Mexico","NM"],["New York","NY"],["North Carolina","NC"],["North Dakota","ND"],["Ohio","OH"],["Oklahoma","OK"],["Oregon","OR"],["Pennsylvania","PA"],["Rhode Island","RI"],["South Carolina","SC"],["South Dakota","SD"],["Tennessee","TN"],["Texas","TX"],["Utah","UT"],["Vermont","VT"],["Virginia","VA"],["Washington","WA"],["West Virginia","WV"],["Wisconsin","WI"],["Wyoming","WY"]]),function(angular){"use strict";angular.module("risevision.common.popupdetector",[]).factory("popupTest",["$q","$window","$timeout",function($q,$window,$timeout){return function(){var deferred=$q.defer(),errorMsg="<strong>Sign In Pop-Up Blocked</strong> - Allow pop-ups from store.risevision.com in the browser settings and Sign In again.";return $timeout(function(){var popup=$window.open("","","width=50, height=50",!0);$timeout(function(){try{popup&&0!==popup.outerHeight?(popup.close(),deferred.resolve(!0)):deferred.reject(errorMsg)}catch(e){deferred.reject(errorMsg);try{popup.close()}catch(e1){}}},25)},2500),deferred.promise}}])}(angular),function(angular){"use strict";var _userStateReady,stripLeadingSlash=function(str){return"/"===str[0]&&(str=str.slice(1)),str},parseParams=function(str){var params={};return str.split("&").forEach(function(fragment){var fragmentArray=fragment.split("=");params[fragmentArray[0]]=fragmentArray[1]}),params};angular.module("risevision.common.userstate",["risevision.common.gapi","risevision.common.localstorage","risevision.common.config","risevision.core.cache","risevision.core.oauth2","ngBiscuit","risevision.core.util","risevision.core.userprofile","risevision.core.company","risevision.common.loading","LocalStorageModule","risevision.ui-flow"]).value("DEFAULT_PROFILE_PICTURE","http://api.randomuser.me/portraits/med/men/33.jpg").value("OAUTH2_SCOPES","https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile").value("GOOGLE_OAUTH2_URL","https://accounts.google.com/o/oauth2/auth").factory("userStateReady",[function(){return _userStateReady.promise}]).run(["$q",function($q){_userStateReady=$q.defer()}]).run(["$location","userState","$log","gapiLoader",function($location,userState,$log,gapiLoader){var path=$location.path(),params=parseParams(stripLeadingSlash(path)),resolveHandled=!1;if($log.debug("URL params",params),params.access_token&&(resolveHandled=!0,gapiLoader().then(function(gApi){$log.debug("Setting token",params.access_token),gApi.auth.setToken({access_token:params.access_token}),userState._setUserToken(params.access_token),userState.authenticate().then().finally(_userStateReady.resolve)})),userState._restoreState(),params.state){var state=JSON.parse(params.state);state.u&&$location.path(state.u)}resolveHandled||_userStateReady.resolve()}]).factory("userState",["$q","$log","$location","CLIENT_ID","gapiLoader","cookieStore","OAUTH2_SCOPES","userInfoCache","getOAuthUserInfo","getUserProfile","getCompany","$rootScope","$interval","$loading","$window","GOOGLE_OAUTH2_URL","localStorageService","$document","uiFlowManager",function($q,$log,$location,CLIENT_ID,gapiLoader,cookieStore,OAUTH2_SCOPES,userInfoCache,getOAuthUserInfo,getUserProfile,getCompany,$rootScope,$interval,$loading,$window,GOOGLE_OAUTH2_URL,localStorageService,$document,uiFlowManager){var _readRvToken=function(){return cookieStore.get("rv-token")},_state={profile:{},user:{},userCompany:{},selectedCompany:{},roleMap:{},userToken:_readRvToken(),inRVAFrame:angular.isDefined($location.search().inRVA)},_accessTokenRefreshHandler=null,_detectUserOrAuthChange=function(){var tocken=_readRvToken();tocken!==_state.userToken?$window.location.reload():_state.userToken&&($loading.startGlobal("risevision.user.authenticate"),authenticate(!1).finally(function(){_state.userToken||($log.debug("Authentication failed. Reloading..."),$window.location.reload())}))},_addEventListenerVisibilityAPI=function(){var visibilityState,visibilityChange,document=$document[0];"undefined"!=typeof document.hidden?(visibilityChange="visibilitychange",visibilityState="visibilityState"):"undefined"!=typeof document.mozHidden?(visibilityChange="mozvisibilitychange",visibilityState="mozVisibilityState"):"undefined"!=typeof document.msHidden?(visibilityChange="msvisibilitychange",visibilityState="msVisibilityState"):"undefined"!=typeof document.webkitHidden&&(visibilityChange="webkitvisibilitychange",visibilityState="webkitVisibilityState"),document.addEventListener(visibilityChange,function(){$log.debug("visibility: "+document[visibilityState]),"visible"===document[visibilityState]&&_detectUserOrAuthChange()})};_addEventListenerVisibilityAPI();var _follow=function(source){var Follower=function(){};return Follower.prototype=source,new Follower},_getUserId=function(){return _state.user?_state.user.userId:null},_setUserToken=function(){_state.userToken=_getUserId(),_writeRvToken(_state.userToken)},_clearUserToken=function(){return $log.debug("Clearing user token..."),_cancelAccessTokenAutoRefresh(),_state.userToken=null,_clearRvToken(),gapiLoader().then(function(gApi){gApi.auth.setToken()})},_scheduleAccessTokenAutoRefresh=function(){$interval.cancel(_accessTokenRefreshHandler),_accessTokenRefreshHandler=$interval(function(){$interval.cancel(_accessTokenRefreshHandler),_authorize(!0)},33e5)},_cancelAccessTokenAutoRefresh=function(){$interval.cancel(_accessTokenRefreshHandler),_accessTokenRefreshHandler=null},_looksLikeIp=function(addr){return/^([0-9])+\.([0-9])+\.([0-9])+\.([0-9])+$/.test(addr)?!0:!1},_getBaseDomain=function(){var result;if(!result){var hostname=$location.host();if(_looksLikeIp(hostname))result=hostname;else{var parts=hostname.split(".");result=parts.length>1?parts.slice(parts.length-2).join("."):hostname}$log.debug("baseDomain",result)}return result},_clearObj=function(obj){for(var member in obj)delete obj[member]},_clearAndCopy=function(src,dest){_clearObj(dest),angular.extend(dest,src)},_resetUserState=function(){_clearObj(_state.user),_clearObj(_state.selectedCompany),_clearObj(_state.profile),_clearObj(_state.userCompany),_state.roleMap={},$log.debug("User state has been reset.")},refreshProfile=function(){var deferred=$q.defer();return getOAuthUserInfo().then(function(oauthUserInfo){getUserProfile(_state.user.username,!0).then(function(profile){_clearAndCopy(angular.extend({username:oauthUserInfo.email},profile),_state.profile),_state.roleMap={},_state.profile.roles&&_state.profile.roles.forEach(function(val){_state.roleMap[val]=!0}),deferred.resolve()},deferred.reject)},deferred.reject),deferred.promise},_authorize=function(attemptImmediate){var authorizeDeferred=$q.defer(),opts={client_id:CLIENT_ID,scope:OAUTH2_SCOPES,cookie_policy:$location.protocol()+"://"+_getBaseDomain()};return attemptImmediate?opts.immediate=!0:opts.prompt="select_account",gapiLoader().then(function(gApi){gApi.auth.authorize(opts,function(authResult){$log.debug("authResult",authResult),authResult&&!authResult.error?(_scheduleAccessTokenAutoRefresh(),getOAuthUserInfo().then(function(oauthUserInfo){_state.user.username&&_state.profile.username&&_state.user.username===oauthUserInfo.email?authorizeDeferred.resolve(authResult):(_clearAndCopy({userId:oauthUserInfo.id,username:oauthUserInfo.email,picture:oauthUserInfo.picture},_state.user),_setUserToken(),refreshProfile().then(function(){return getCompany().then(function(company){_clearAndCopy(company,_state.userCompany)},function(){_clearObj(_state.userCompany)}).finally(function(){authorizeDeferred.resolve(authResult),$rootScope.$broadcast("risevision.user.authorized"),attemptImmediate||$rootScope.$broadcast("risevision.user.userSignedIn")})},function(){authorizeDeferred.resolve(authResult),$rootScope.$broadcast("risevision.user.authorized"),attemptImmediate||$rootScope.$broadcast("risevision.user.userSignedIn")}))},function(err){_clearObj(_state.user),authorizeDeferred.reject(err)})):(_clearObj(_state.user),authorizeDeferred.reject("not authorized"))})},authorizeDeferred.reject),authorizeDeferred.promise},authenticateRedirect=function(forceAuth){if(forceAuth){var loc=$window.location.href.substr(0,$window.location.href.indexOf("#"))||$window.location.href;localStorageService.set("risevision.common.userState",_state),uiFlowManager.persist(),$window.location=GOOGLE_OAUTH2_URL+"?response_type=token&scope="+encodeURIComponent(OAUTH2_SCOPES)+"&client_id="+CLIENT_ID+"&redirect_uri="+encodeURIComponent(loc)+"&prompt=select_account&state="+encodeURIComponent(JSON.stringify({u:$location.path()}));var deferred=$q.defer();return deferred.promise}return authenticate(forceAuth)},authenticate=function(forceAuth){var authenticateDeferred=$q.defer();$log.debug("authentication called");var _proceed=function(){forceAuth&&(_resetUserState(),userInfoCache.removeAll()),gapiLoader().then(function(){var userAuthed=angular.isDefined(_state.userToken)&&null!==_state.userToken;if($log.debug("userAuthed",userAuthed),forceAuth||userAuthed===!0)_authorize(!forceAuth).then(function(authResult){authResult&&!authResult.error?authenticateDeferred.resolve():(_clearUserToken(),$log.debug("Authentication Error: "+authResult.error),authenticateDeferred.reject("Authentication Error: "+authResult.error))},function(){_clearUserToken(),authenticateDeferred.reject()}).finally(function(){$loading.stopGlobal("risevision.user.authenticate")});else{var msg="user is not authenticated";$log.debug(msg),authenticateDeferred.reject(msg),_clearObj(_state.user),$loading.stopGlobal("risevision.user.authenticate")}})};return _proceed(),forceAuth&&$loading.startGlobal("risevision.user.authenticate"),authenticateDeferred.promise},signOut=function(signOutGoogle){var deferred=$q.defer();return userInfoCache.removeAll(),gapiLoader().then(function(gApi){signOutGoogle&&($window.logoutFrame.location="https://accounts.google.com/Logout"),gApi.auth.signOut(),_clearUserToken().then(function(){_resetUserState(),_clearObj(_state.user),$rootScope.$broadcast("risevision.user.signedOut"),$log.debug("User is signed out."),deferred.resolve()},function(){deferred.reject()})}),deferred.promise},isLoggedIn=function(){return _state.user.username?!0:!1},isRiseVisionUser=function(){return null!==_state.profile.username&&void 0!==_state.profile.username},hasRole=function(role){return angular.isDefined(_state.roleMap[role])},getAccessToken=function(){return $window.gapi?$window.gapi.auth.getToken():null},_writeRvToken=function(value){var baseDomain=_getBaseDomain();"localhost"===baseDomain?cookieStore.put("rv-token",value):cookieStore.put("rv-token",value,{domain:baseDomain,path:"/"})},_clearRvToken=function(){var baseDomain=_getBaseDomain();"localhost"===baseDomain?cookieStore.remove("rv-token"):cookieStore.remove("rv-token",{domain:baseDomain,path:"/"})},_restoreState=function(){var sFromStorage=localStorageService.get("risevision.common.userState");sFromStorage&&(angular.extend(_state,sFromStorage),localStorageService.remove("risevision.common.userState"),$log.debug("userState restored with",sFromStorage))},userState={getUserCompanyId:function(){return _state.userCompany&&_state.userCompany.id||null},getSelectedCompanyId:function(){return _state.selectedCompany&&_state.selectedCompany.id||null},getSelectedCompanyName:function(){return _state.selectedCompany&&_state.selectedCompany.name||null},updateCompanySettings:function(company){company&&_state.selectedCompany&&(_clearAndCopy(company,_state.selectedCompany),_state.userCompany.id===_state.selectedCompany.id&&_clearAndCopy(company,_state.userCompany))},getSelectedCompanyCountry:function(){return _state.selectedCompany&&_state.selectedCompany.country||null},getUsername:function(){return _state.user&&_state.user.username||null},getUserEmail:function(){return _state.profile.email},getCopyOfProfile:function(){return _follow(_state.profile)},resetCompany:function(){_clearAndCopy(_state.userCompany,_state.selectedCompany)},getCopyOfUserCompany:function(){return _follow(_state.userCompany)},getCopyOfSelectedCompany:function(){return _follow(_state.selectedCompany)},switchCompany:function(company){_clearAndCopy(company,_state.selectedCompany)},isSubcompanySelected:function(){return _state.selectedCompany&&_state.selectedCompany.id!==(_state.userCompany&&_state.userCompany.id)},getUserPicture:function(){return _state.user.picture},hasRole:hasRole,inRVAFrame:function(){return _state.inRVAFrame},isRiseAdmin:function(){return hasRole("sa")},isRiseStoreAdmin:function(){return hasRole("ba")},isUserAdmin:function(){return hasRole("ua")},isPurchaser:function(){return hasRole("pu")},isSeller:function(){return _state.selectedCompany&&_state.selectedCompany.sellerId?!0:!1},isRiseVisionUser:isRiseVisionUser,isLoggedIn:isLoggedIn,authenticate:_state.inRVAFrame?authenticate:authenticateRedirect,signOut:signOut,refreshProfile:refreshProfile,getAccessToken:getAccessToken,_restoreState:_restoreState,_setUserToken:function(token){_state.userToken=token}};return window.userState=userState,userState}])}(angular),function(angular){"use strict";angular.module("risevision.ui-flow",["LocalStorageModule"]).constant("uiStatusDependencies",{_dependencies:{},_retries:{},addDependencies:function(deps){angular.extend(this._dependencies,deps)},setMaximumRetryCount:function(status,num){if(1>num)throw"Retry count for "+status+" must be equal to or greater than 1.";void 0===this._retries[status]&&(this._retries[status]=num)}}).factory("uiFlowManager",["$log","$q","$injector","uiStatusDependencies","$rootScope","localStorageService",function($log,$q,$injector,uiStatusDependencies,$rootScope,localStorageService){var _status,_goalStatus,deferred,_retriesLeft=null,_dependencyMap=uiStatusDependencies._dependencies,genedateDummyStatus=function(){return function(){var deferred=$q.defer();return deferred.resolve(!0),deferred.promise}},_getOrCreateDummyFactory=function(status){var factory;try{factory=$injector.get(status)}catch(e){$log.debug("Generating dummy status",status),factory=genedateDummyStatus()}return factory},_attemptStatus=function(status){var lastD;$log.debug("Attempting to reach status",status,"...");var dependencies=_dependencyMap[status];if(dependencies){dependencies instanceof Array||(dependencies=[dependencies]);var prevD=$q.defer(),firstD=prevD;angular.forEach(dependencies,function(dep){var currentD=$q.defer();prevD.promise.then(currentD.resolve,function(){_attemptStatus(dep).then(function(){_dependencyMap[dep]&&$log.debug("Deps for status",dep,"satisfied."),_getOrCreateDummyFactory(status)().then(function(){$log.debug("Status",status,"satisfied."),currentD.resolve(!0)},function(){$log.debug("Status",status,"not satisfied."),currentD.reject(status)})},function(lastRej){_dependencyMap[dep]?($log.debug("Failed to reach status",dep," because its dependencies are not satisfied. Last rejected dep: ",lastRej),currentD.reject(lastRej)):currentD.reject(dep)})}),lastD=prevD=currentD}),firstD.reject()}else lastD=$q.defer(),_getOrCreateDummyFactory(status)().then(function(){$log.debug("Termination status",status,"satisfied."),lastD.resolve(!0)},function(){$log.debug("Termination status",status,"not satisfied."),lastD.reject(status)});return lastD.promise},final=!0,_recheckStatus=function(desiredStatus){if(!desiredStatus&&!_goalStatus){var d=$q.defer();return d.resolve(),d.promise}return!_goalStatus&&final&&(_goalStatus=desiredStatus,_retriesLeft=angular.copy(uiStatusDependencies._retries),deferred=$q.defer(),final=!1),_goalStatus&&(deferred=$q.defer(),_attemptStatus(_goalStatus).then(function(s){_goalStatus&&(_status=_goalStatus),deferred.resolve(s),_goalStatus=null,final=!0},function(status){_status=status,void 0!==_retriesLeft[status]&&(0===_retriesLeft[status]?($log.debug("Maximum allowed retries for status",status,"reached. Validation will cancel."),cancelValidation()):_retriesLeft[status]--),final=!0,deferred.reject(status)})),deferred&&deferred.promise},invalidateStatus=function(desiredStatus){return _status="pendingCheck",_recheckStatus(desiredStatus)},persist=function(){localStorageService.set("risevision.ui-flow.state",{goalStatus:_goalStatus,retriesLeft:_retriesLeft})},cancelValidation=function(){_status="",_goalStatus="",_retriesLeft=null,final=!0,$rootScope.$broadcast("risevision.uiStatus.validationCancelled"),$log.debug("UI status validation cancelled.")};if(localStorageService.get("risevision.ui-flow.state")){var state=localStorageService.get("risevision.ui-flow.state");state&&state.goalStatus&&(_goalStatus=state.goalStatus,$log.debug("uiFlowManager.goalStatus restored to",state.goalStatus,state.retriesLeft),_retriesLeft=state.retriesLeft,deferred=$q.defer(),final=!1),localStorageService.remove("risevision.ui-flow.state")
}var manager={invalidateStatus:invalidateStatus,cancelValidation:cancelValidation,getStatus:function(){return _status},isStatusUndetermined:function(){return"pendingCheck"===_status},persist:persist};return manager}])}(angular),function(angular){"use strict";angular.module("risevision.common.account",["risevision.common.gapi","risevision.core.oauth2","risevision.common.company","risevision.core.cache"]).factory("agreeToTerms",["$q","riseAPILoader","$log","userInfoCache",function($q,riseAPILoader,$log,userInfoCache){return function(){$log.debug("agreeToTerms called.");var deferred=$q.defer();return riseAPILoader().then(function(riseApi){var request=riseApi.account.agreeToTerms();request.execute(function(resp){$log.debug("agreeToTerms resp",resp),userInfoCache.removeAll(),resp.error?deferred.reject(resp.error):deferred.resolve()})}),deferred.promise}}]).factory("agreeToTermsAndUpdateUser",["$q","$log","createCompany","agreeToTerms","updateUser",function($q,$log,createCompany,agreeToTerms,updateUser){return function(username,basicProfile){$log.debug("registerAccount called.",username,basicProfile);var deferred=$q.defer();return agreeToTerms().then().finally(function(){updateUser(username,basicProfile).then(function(resp){resp.result?deferred.resolve():deferred.reject()},deferred.reject).finally("registerAccount ended")}),deferred.promise}}]).factory("registerAccount",["$q","$log","createCompany","addAccount","updateUser",function($q,$log,createCompany,addAccount,updateUser){return function(username,basicProfile){$log.debug("registerAccount called.",username,basicProfile);var deferred=$q.defer();return addAccount().then().finally(function(){updateUser(username,basicProfile).then(function(resp){resp.result?deferred.resolve():deferred.reject()},deferred.reject).finally("registerAccount ended")}),deferred.promise}}]).factory("addAccount",["$q","riseAPILoader","$log",function($q,riseAPILoader,$log){return function(){$log.debug("addAccount called.");var deferred=$q.defer();return riseAPILoader().then(function(riseApi){var request=riseApi.account.add();request.execute(function(resp){$log.debug("addAccount resp",resp),resp.result?deferred.resolve():deferred.reject("addAccount")})}),deferred.promise}}]).factory("getAccount",["$q","riseAPILoader","$log",function($q,riseAPILoader,$log){return function(){$log.debug("getAccount called.");var deferred=$q.defer();return riseAPILoader().then(function(riseApi){var request=riseApi.account.get();request.execute(function(resp){$log.debug("getAccount resp",resp),resp.item?deferred.resolve(resp.item):deferred.reject("getAccount")})}),deferred.promise}}])}(angular),function(angular){"use strict";angular.module("risevision.common.registration",["risevision.common.userstate","risevision.ui-flow","risevision.core.userprofile","risevision.common.gapi"]).config(["uiStatusDependencies",function(uiStatusDependencies){uiStatusDependencies.addDependencies({registerdAsRiseVisionUser:"signedInWithGoogle",registeredAsRiseVisionUser:"signedInWithGoogle",registrationComplete:["notLoggedIn","registeredAsRiseVisionUser"]}),uiStatusDependencies.setMaximumRetryCount("signedInWithGoogle",1)}]).factory("signedInWithGoogle",["$q","getOAuthUserInfo","userState",function($q,getOAuthUserInfo,userState){return function(){var deferred=$q.defer();return userState.isLoggedIn()?deferred.resolve():deferred.reject("signedInWithGoogle"),deferred.promise}}]).factory("notLoggedIn",["$q","$log","signedInWithGoogle",function($q,$log,signedInWithGoogle){return function(){var deferred=$q.defer();return signedInWithGoogle().then(function(){deferred.reject("notLoggedIn")},deferred.resolve),deferred.promise}}]).factory("registeredAsRiseVisionUser",["$q","getUserProfile","cookieStore","$log","userState",function($q,getUserProfile,cookieStore,$log,userState){return function(){var deferred=$q.defer();return getUserProfile(userState.getUsername()).then(function(profile){angular.isDefined(profile.email)&&angular.isDefined(profile.mailSyncEnabled)?deferred.resolve(profile):cookieStore.get("surpressRegistration")?deferred.resolve({}):deferred.reject("registeredAsRiseVisionUser")},function(err){cookieStore.get("surpressRegistration")?deferred.resolve({}):($log.debug("registeredAsRiseVisionUser rejected",err),deferred.reject("registeredAsRiseVisionUser"))}),deferred.promise}}])}(angular),function(angular){"use strict";angular.module("risevision.core.cache",[]).value("rvStorage",sessionStorage).factory("userInfoCache",["$cacheFactory",function($cacheFactory){return $cacheFactory("user-info-cache")}])}(angular),function(angular){"use strict";angular.module("risevision.core.util",[]).factory("pick",function(){var ArrayProto=Array.prototype,slice=ArrayProto.slice,concat=ArrayProto.concat,createCallback=function(func,context,argCount){if(void 0===context)return func;switch(null===argCount?3:argCount){case 1:return function(value){return func.call(context,value)};case 2:return function(value,other){return func.call(context,value,other)};case 3:return function(value,index,collection){return func.call(context,value,index,collection)};case 4:return function(accumulator,value,index,collection){return func.call(context,accumulator,value,index,collection)}}return function(){return func.apply(context,arguments)}};return function(obj,iteratee,context){var key,result={};if(null===obj)return result;if(angular.isFunction(iteratee)){iteratee=createCallback(iteratee,context);for(key in obj){var value=obj[key];iteratee(value,key,obj)&&(result[key]=value)}}else{var keys=concat.apply([],slice.call(arguments,1));obj=new Object(obj);for(var i=0,length=keys.length;length>i;i++)key=keys[i],key in obj&&(result[key]=obj[key])}return result}})}(angular),function(angular){"use strict";angular.module("risevision.core.userprofile",["risevision.common.gapi","risevision.core.oauth2"]).value("userRoleMap",{ce:"Content Editor",cp:"Content Publisher",da:"Display Administrator",ua:"System Administrator",pu:"Store Purchaser",sa:"Rise System Administrator",ba:"Rise Store Administrator"}).factory("getUserProfile",["oauth2APILoader","coreAPILoader","$q","$log",function(oauth2APILoader,coreAPILoader,$q,$log){var _username,_cachedPromises={};return function(username,clearCache){var deferred;if(username===_username&&!clearCache&&null!==_cachedPromises[username])return _cachedPromises[username].promise;if(_username=username,_cachedPromises[username]=deferred=$q.defer(),username){var criteria={};username&&(criteria.username=username),$log.debug("getUserProfile called",criteria),$q.all([oauth2APILoader(),coreAPILoader()]).then(function(results){var coreApi=results[1];coreApi.user.get(criteria).execute(function(resp){resp.error||!resp.result?deferred.reject(resp):($log.debug("getUser resp",resp),deferred.resolve(resp.item))})},deferred.reject)}else deferred.reject("getUserProfile failed: username param is required."),$log.debug("getUserProfile failed: username param is required.");return deferred.promise}}]).factory("updateUser",["$q","coreAPILoader","$log","getUserProfile","pick",function($q,coreAPILoader,$log,getUserProfile,pick){return function(username,profile){var deferred=$q.defer();return profile=pick(profile,"mailSyncEnabled","email","firstName","lastName","telephone","roles","status"),$log.debug("updateUser called",username,profile),coreAPILoader().then(function(coreApi){var request=coreApi.user.patch({username:username,data:profile});request.execute(function(resp){$log.debug("updateUser resp",resp),resp.error?deferred.reject(resp):resp.result?getUserProfile(username,!0).then(function(){deferred.resolve(resp)}):deferred.reject("updateUser")})},deferred.reject),deferred.promise}}]).factory("addUser",["$q","coreAPILoader","$log","pick",function($q,coreAPILoader,$log,pick){return function(companyId,username,profile){var deferred=$q.defer();return coreAPILoader().then(function(coreApi){profile=pick(profile,"mailSyncEnabled","email","firstName","lastName","telephone","roles","status");var request=coreApi.user.add({username:username,companyId:companyId,data:profile});request.execute(function(resp){$log.debug("addUser resp",resp),resp.result?deferred.resolve(resp):deferred.reject(resp)})}),deferred.promise}}]).factory("deleteUser",["$q","coreAPILoader","$log",function($q,coreAPILoader,$log){return function(username){var deferred=$q.defer();return coreAPILoader().then(function(coreApi){var request=coreApi.user.delete({username:username});request.execute(function(resp){$log.debug("deleteUser resp",resp),resp.result?deferred.resolve(resp):deferred.reject("deleteUser")})}),deferred.promise}}]).factory("getUsers",["$q","coreAPILoader","$log",function($q,coreAPILoader,$log){return function(criteria){$log.debug("getUsers",criteria);var deferred=$q.defer();return coreAPILoader().then(function(coreApi){var request=coreApi.user.list(criteria);request.execute(function(resp){$log.debug("getUsers resp",resp),resp.result?deferred.resolve(resp.items):deferred.reject("getUsers")})},deferred.reject),deferred.promise}}])}(angular),function(angular){"use strict";angular.module("risevision.core.company",["risevision.common.gapi","risevision.core.cache","risevision.core.util"]).constant("COMPANY_WRITABLE_FIELDS",["name","street","unit","city","province","country","postalCode","timeZoneOffset","telephone","fax","companyStatus","notificationEmails","mailSyncEnabled","sellerId"]).factory("createCompany",["$q","coreAPILoader","COMPANY_WRITABLE_FIELDS","pick",function($q,coreAPILoader,COMPANY_WRITABLE_FIELDS,pick){return function(parentCompanyId,company){var deferred=$q.defer();return coreAPILoader().then(function(coreApi){var fields=pick.apply(this,[company].concat(COMPANY_WRITABLE_FIELDS)),request=coreApi.company.add({parentId:parentCompanyId,data:fields});request.execute(function(resp){resp.result?deferred.resolve(resp.item):deferred.reject(resp)},deferred.reject)}),deferred.promise}}]).factory("getCompany",["coreAPILoader","$q","$log",function(coreAPILoader,$q,$log){return function(id){$log.debug("getCompany called",id);var deferred=$q.defer();return coreAPILoader().then(function(coreApi){var criteria={};id&&(criteria.id=id);var request=coreApi.company.get(criteria);request.execute(function(resp){$log.debug("getCompany resp",resp),resp.result?deferred.resolve(resp.item):deferred.reject(resp)})}),deferred.promise}}]).factory("lookupCompany",["coreAPILoader","$q","$log",function(coreAPILoader,$q,$log){return function(authKey){$log.debug("lookupCompany called",authKey);var deferred=$q.defer();return coreAPILoader().then(function(coreApi){var request=coreApi.company.lookup({authKey:authKey});request.execute(function(resp){$log.debug("lookupCompany resp",resp),resp.result?deferred.resolve(resp.item):deferred.reject(resp)})}),deferred.promise}}]).factory("moveCompany",["coreAPILoader","$q","$log",function(coreAPILoader,$q,$log){return function(authKey,newParentId){var deferred=$q.defer();return coreAPILoader().then(function(coreApi){var request=coreApi.company.move({authKey:authKey,newParentId:newParentId});request.execute(function(resp){$log.debug("moveCompany resp",resp),resp.result?deferred.resolve(resp.item):deferred.reject(resp)})}),deferred.promise}}]).factory("updateCompany",["$q","$log","coreAPILoader","pick","COMPANY_WRITABLE_FIELDS",function($q,$log,coreAPILoader,pick,COMPANY_WRITABLE_FIELDS){return function(companyId,fields){var deferred=$q.defer();return fields=pick.apply(this,[fields].concat(COMPANY_WRITABLE_FIELDS)),$log.debug("updateCompany called",companyId,fields),coreAPILoader().then(function(coreApi){var request=coreApi.company.patch({id:companyId,data:fields});request.execute(function(resp){$log.debug("updateCompany resp",resp),resp.result?deferred.resolve(resp):deferred.reject(resp)})}),deferred.promise}}]).factory("regenerateCompanyField",["$q","$log","coreAPILoader",function($q,$log,coreAPILoader){return function(companyId,fieldName){var deferred=$q.defer();return $log.debug("regenerateField called",companyId,fieldName),coreAPILoader().then(function(coreApi){var request=coreApi.company.regenerateField({id:companyId,fieldName:fieldName});request.execute(function(resp){$log.debug("regenerateField resp",resp),resp.error?deferred.reject(resp.message):deferred.resolve(resp)},function(resp){deferred.reject("call failed "+resp)})}),deferred.promise}}]).factory("deleteCompany",["coreAPILoader","$q","$log",function(coreAPILoader,$q,$log){return function(id){$log.debug("deleteCompany called",id);var deferred=$q.defer();return coreAPILoader().then(function(coreApi){var criteria={};id&&(criteria.id=id);var request=coreApi.company.delete(criteria);request.execute(function(resp){$log.debug("deleteCompany resp",resp),resp.result?deferred.resolve(resp.item):deferred.reject(resp)})}),deferred.promise}}]).service("companyService",["coreAPILoader","$q","$log","getCompany",function(coreAPILoader,$q,$log,getCompany){this.getCompanies=function(companyId,search,cursor,count,sort){var deferred=$q.defer(),obj={companyId:companyId,search:search,cursor:cursor,count:count,sort:sort};return $log.debug("getCompanies called with",obj),coreAPILoader().then(function(coreApi){var request=coreApi.company.list(obj);request.execute(function(resp){$log.debug("getCompanies resp",resp),deferred.resolve(resp)})}),deferred.promise},this.loadSelectedCompany=function(selectedCompanyId,userCompany){var deferred=$q.defer();return selectedCompanyId&&selectedCompanyId!==userCompany.id?getCompany(selectedCompanyId).then(function(res){deferred.resolve(0===res.code&&res.item?res.item:userCompany)}):deferred.resolve(userCompany),deferred.promise},this.validateAddressSimple=function(company,contact){var errors=[];if(contact)if(contact.firstName||errors.push("Missing First Name"),contact.lastName||errors.push("Missing Last Name"),contact.email){var re=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;re.test(contact.email)||errors.push("Invalid Email")}else errors.push("Missing Email");return company.street||errors.push("Missing Address (Line 1)"),company.city||errors.push("Missing City"),company.country||errors.push("Missing Country"),company.province||errors.push("Missing State / Province"),company.postalCode||errors.push("Missing Zip / Postal Code"),errors}}]).filter("fullAddress",function(){return function(company){var res=(company.street?company.street+", ":"")+(company.city?company.city+", ":"")+(company.province?company.province+", ":"")+(company.country?company.country+", ":"")+(company.postalCode?company.postalCode+", ":"");return res&&(res=res.substr(0,res.length-2)),res}})}(angular),function(angular){"use strict";angular.module("risevision.core.oauth2",["risevision.common.gapi","risevision.core.cache"]).factory("getOAuthUserInfo",["oauth2APILoader","$q","userInfoCache","$log",function(oauth2APILoader,$q,userInfoCache,$log){return function(){var resp,deferred=$q.defer();return(resp=userInfoCache.get("oauth2UserInfo"))?resp.error?deferred.reject(resp.error):deferred.resolve(resp):oauth2APILoader().then(function(oauth2){oauth2.userinfo.get().execute(function(resp){$log.debug("getOAuthUserInfo oauth2.userinfo.get() resp",resp),resp?resp.hasOwnProperty("error")?(userInfoCache.remove("oauth2UserInfo"),deferred.reject(resp.error)):(userInfoCache.put("oauth2UserInfo",resp),deferred.resolve(resp)):(userInfoCache.remove("oauth2UserInfo"),deferred.reject())})},deferred.reject),deferred.promise}}])}(angular),function(angular){"use strict";angular.module("risevision.core.systemmessages",["risevision.common.gapi"]).factory("getCoreSystemMessages",["gapiLoader","$q","$log",function(gapiLoader,$q,$log){return function(companyId){var deferred=$q.defer();return gapiLoader().then(function(gApi){var request=gApi.client.core.systemmessage.list({companyId:companyId});request.execute(function(resp){var items=resp;items instanceof Array||!items.items||(items=items.items),$log.debug("getCoreSystemMessage resp",items),deferred.resolve(items)})}),deferred.promise}}])}(angular),angular.module("risevision.common.fastpass",[]).factory("loadFastpass",["$q","$http","$document","$timeout","GSFP_URL","$log",function($q,$http,$document,$timeout,GSFP_URL,$log){var loadScript=function(src){var deferred=$q.defer(),script=$document[0].createElement("script");return script.onload=script.onreadystatechange=function(e){deferred.resolve(e)},script.onerror=function(e){deferred.reject(e)},script.src=src,$document[0].body.appendChild(script),deferred.promise};return function(username,email){var deferred=$q.defer();$log.debug("loadFastpass called",username,email);var rejected=function(rej){$log.error("loadFastpass rejected",rej),deferred.reject("loadFastpass rejected "+rej)};return $http.get(GSFP_URL+"/geturl?userEmail="+email+"&userName="+username).then(function(res){loadScript(res.data).then(function(result){$log.debug("loadFastpass result",result),deferred.resolve(!0)},rejected).catch(rejected)},deferred.reject),deferred.promise}}]),angular.module("risevision.common.header").directive("fastpass",["loadFastpass","userState",function(loadFastpass,userState){return{restrict:"AE",scope:{},link:function($scope){$scope.$watch(function(){return userState.getUserEmail()},function(email){email&&loadFastpass(userState.getUsername(),userState.getUserEmail())})}}}]),function(angular){"use strict";angular.module("risevision.common.company",["risevision.core.company","risevision.common.userstate"]).service("selectedCompanyUrlHandler",["$location","userState","getCompany","$rootScope","$log","$q",function($location,userState,getCompany,$rootScope,$log,$q){var that=this;$location.search().cid&&!userState.isLoggedIn()&&($log.debug("cid",$location.search().cid,"saved for later processing."),this.pendingSelectedCompany=$location.search().cid),$rootScope.$on("risevision.user.userSignedIn",function(){that.pendingSelectedCompany&&($location.search("cid",that.pendingSelectedCompany),delete that.pendingSelectedCompany,that.updateSelectedCompanyFromUrl())}),this.init=function(){that.updateSelectedCompanyFromUrl().finally(function(){userState.getSelectedCompanyId()||userState.resetCompany()})},this.updateUrl=function(){var selectedCompanyId=userState.getSelectedCompanyId();selectedCompanyId&&selectedCompanyId!==userState.getUserCompanyId()?$location.search().cid!==selectedCompanyId&&$location.search("cid",selectedCompanyId):$location.search().cid&&$location.search({cid:null})},this.updateSelectedCompanyFromUrl=function(){var deferred=$q.defer(),newCompanyId=$location.search().cid;return newCompanyId&&userState.getUserCompanyId()&&newCompanyId!==userState.getSelectedCompanyId()?getCompany(newCompanyId).then(function(company){userState.switchCompany(company)}).finally(deferred.resolve):(!newCompanyId&&userState.getSelectedCompanyId()&&userState.getSelectedCompanyId()!==userState.getUserCompanyId()&&($location.search("cid",userState.getSelectedCompanyId()),$location.replace()),deferred.reject()),deferred.promise}}])}(angular),function(angular){"use strict";angular.module("risevision.common.shoppingcart",["risevision.common.userstate"]).factory("shoppingCart",["rvStorage","$log","$q","userState",function(rvStorage,$log,$q,userState){var _items=[],itemsMap={},readFromStorage=function(){var storedCartContents=rvStorage.getItem("rvStore_OrderProducts");if($log.debug("read storedCartContents",storedCartContents),storedCartContents){var res=JSON.parse(storedCartContents);if(res&&res.items&&res.itemsMap){for(;_items.length>0;)_items.pop();for(var i=0;i<res.items.length;i++)_items.push(res.items[i]);itemsMap=res.itemsMap,$log.debug(_items.length,"items pushed to cart.")}}},persistToStorage=function(){rvStorage.setItem("rvStore_OrderProducts",JSON.stringify({items:_items,itemsMap:itemsMap}));var storedCartContents=rvStorage.getItem("rvStore_OrderProducts");$log.debug("written storedCartContents",storedCartContents)},loadReady=$q.defer(),cartManager={loadReady:loadReady.promise,getSubTotal:function(isCAD){var shipping=0,subTotal=0;if(_items)for(var i=0;i<_items.length;i++){var shippingCost=isCAD?_items[i].selected.shippingCAD:_items[i].selected.shippingUSD,productCost=isCAD?_items[i].selected.priceCAD:_items[i].selected.priceUSD;"Metered"!==_items[i].paymentTerms&&(shipping+=shippingCost*_items[i].qty||0,subTotal+=productCost*_items[i].qty||0)}return subTotal+shipping},getShippingTotal:function(isCAD){var shipping=0;if(_items)for(var i=0;i<_items.length;i++)if("Metered"!==_items[i].paymentTerms){var shippingCost=isCAD?_items[i].selected.shippingCAD:_items[i].selected.shippingUSD;shipping+=shippingCost*_items[i].qty||0}return shipping},clear:function(){for(;_items.length>0;)_items.pop();for(var key in itemsMap)delete itemsMap[key];persistToStorage(),$log.debug("Shopping cart cleared.")},destroy:function(){return this.clear(),persistToStorage(),_items},getItems:function(){return _items},setItems:function(items){for($log.debug("Setting cart items",items);_items.length>0;)_items.pop();for(var i=0;i<items.length;i++)_items.push(items[i]);persistToStorage()},initialize:function(){return readFromStorage(),loadReady.resolve(),_items},getItemCount:function(){return null!==_items?_items.length:0},removeItem:function(itemToRemove){if(itemToRemove&&itemsMap[itemToRemove.productId]){delete itemsMap[itemToRemove.productId];for(var i=0;i<_items.length;i++)if(_items[i].productId===itemToRemove.productId){_items.splice(i,1),delete itemsMap[itemToRemove.productId];break}persistToStorage()}},adjustItemQuantity:function(itemToAdjust,qty){itemToAdjust&&$.isNumeric(qty)&&itemsMap[itemToAdjust.id]&&(qty>0?(itemsMap[itemToAdjust.id].quantity=qty,itemsMap[itemToAdjust.id].item.qty=qty,persistToStorage()):this.removeItem(itemToAdjust))},addItem:function(itemToAdd,qty,pricingIndex){userState.isRiseVisionUser()&&(!itemsMap[itemToAdd.productId]||"Subscription"!==itemToAdd.paymentTerms&&"Metered"!==itemToAdd.paymentTerms)&&itemToAdd&&$.isNumeric(qty)&&itemToAdd.orderedPricing.length>pricingIndex&&(itemsMap[itemToAdd.productId]?itemsMap[itemToAdd.productId].qty=parseInt(itemsMap[itemToAdd.productId].qty)+parseInt(qty):(itemsMap[itemToAdd.productId]=angular.copy(itemToAdd),itemsMap[itemToAdd.productId].qty=qty,_items.push(itemsMap[itemToAdd.productId])),itemsMap[itemToAdd.productId].selected=itemToAdd.orderedPricing[pricingIndex],persistToStorage())},itemExists:function(item){return userState.isRiseVisionUser()&&item&&itemsMap[item.productId]?!0:!1}};return cartManager.initialize(),cartManager}])}(angular),function(angular){"use strict";try{angular.module("risevision.common.config")}catch(err){angular.module("risevision.common.config",[])}angular.module("risevision.common.config").value("CORE_URL","https://rvaserver2.appspot.com/_ah/api").value("STORE_URL","https://store.risevision.com").value("STORE_ENDPOINT_URL","https://store-dot-rvaserver2.appspot.com/_ah/api").value("GSFP_URL","https://gsfp-dot-rvaserver2.appspot.com/fp")}(angular);try{angular.module("risevision.common.config")}catch(err){angular.module("risevision.common.config",[])}angular.module("risevision.common.config").value("CLIENT_ID","614513768474.apps.googleusercontent.com");var gapiLoadingStatus=null,handleClientJSLoad=function(){gapiLoadingStatus="loaded",console.debug("ClientJS is loaded.");var evt=document.createEvent("Events");evt.initEvent("gapi.loaded",!0,!0),window.dispatchEvent(evt)};angular.module("risevision.common.gapi",[]).factory("gapiLoader",["$q","$window",function($q,$window){var deferred=$q.defer();return function(){var gapiLoaded;if("loaded"===$window.gapiLoadingStatus)deferred.resolve($window.gapi);else if(!$window.gapiLoadingStatus){$window.gapiLoadingStatus="loading";var src=$window.gapiSrc||"//apis.google.com/js/client.js?onload=handleClientJSLoad",fileref=document.createElement("script");fileref.setAttribute("type","text/javascript"),fileref.setAttribute("src",src),"undefined"!=typeof fileref&&document.getElementsByTagName("body")[0].appendChild(fileref),gapiLoaded=function(){deferred.resolve($window.gapi),$window.removeEventListener("gapi.loaded",gapiLoaded,!1)},$window.addEventListener("gapi.loaded",gapiLoaded,!1)}return deferred.promise}}]).factory("gapiClientLoaderGenerator",["$q","gapiLoader","$log",function($q,gapiLoader,$log){return function(libName,libVer,baseUrl){return function(){var deferred=$q.defer();return gapiLoader().then(function(gApi){gApi.client[libName]?deferred.resolve(gApi.client[libName]):gApi.client.load.apply(this,[libName,libVer].concat([function(){if(gApi.client[libName])$log.debug(libName+"."+libVer+" Loaded"),deferred.resolve(gApi.client[libName]);else{var errMsg=libName+"."+libVer+" Load Failed";$log.error(errMsg),deferred.reject(errMsg)}},baseUrl]))}),deferred.promise}}}]).factory("oauth2APILoader",["gapiClientLoaderGenerator",function(gapiClientLoaderGenerator){return gapiClientLoaderGenerator("oauth2","v2")}]).factory("coreAPILoader",["CORE_URL","gapiClientLoaderGenerator","$location",function(CORE_URL,gapiClientLoaderGenerator,$location){var baseUrl=$location.search().core_api_base_url?$location.search().core_api_base_url+"/_ah/api":CORE_URL;return gapiClientLoaderGenerator("core","v1",baseUrl)}]).factory("riseAPILoader",["CORE_URL","gapiClientLoaderGenerator","$location",function(CORE_URL,gapiClientLoaderGenerator,$location){var baseUrl=$location.search().core_api_base_url?$location.search().core_api_base_url+"/_ah/api":CORE_URL;return gapiClientLoaderGenerator("rise","v0",baseUrl)}]).factory("storeAPILoader",["STORE_ENDPOINT_URL","gapiClientLoaderGenerator","$location",function(STORE_ENDPOINT_URL,gapiClientLoaderGenerator,$location){var baseUrl=$location.search().store_api_base_url?$location.search().store_api_base_url+"/_ah/api":STORE_ENDPOINT_URL;return gapiClientLoaderGenerator("store","v0.01",baseUrl)}]).factory("discoveryAPILoader",["CORE_URL","gapiClientLoaderGenerator","$location",function(CORE_URL,gapiClientLoaderGenerator,$location){var baseUrl=$location.search().core_api_base_url?$location.search().core_api_base_url+"/_ah/api":CORE_URL;return gapiClientLoaderGenerator("discovery","v1",baseUrl)}]),function(angular){"use strict";angular.module("risevision.common.localstorage",["ngStorage"]).factory("localStorageService",["$localStorage","$sessionStorage",function($localStorage,$sessionStorage){var storageImpl=localStorage?localStorage:sessionStorage,storageImplWrapper=localStorage?$localStorage:$sessionStorage,factory={};return factory.getStorage=function(){return storageImplWrapper},factory.setItemImmediate=function(key,value){storageImpl.setItem(key,value)},factory.removeItemImmediate=function(key){storageImpl.removeItem(key)},factory.getItem=function(key){return storageImpl.getItem(key)},factory}])}(angular),function(angular){"use strict";angular.module("risevision.common.systemmessages",[]).factory("systemMessages",["$log","$q",function($log,$q){function pushMessage(m,list){$log.debug("pushing message",m),list.push(m)}var messages=[],_retrievers=[];return messages.addMessages=function(newMessages){newMessages&&newMessages instanceof Array&&(newMessages=function(items){var _newItems=[],currentTime=new Date;return angular.forEach(items,function(msg){var endTime=new Date(msg.endDate||"2199-12-31"),startTime=new Date(msg.startDate||0);endTime.setDate(endTime.getDate()+1),currentTime>startTime&&endTime>currentTime&&_newItems.push(msg)}),_newItems}(newMessages),newMessages.forEach(function(m){var duplicate=!1;messages.forEach(function(um){um.text===m.text&&(duplicate=!0)}),duplicate||pushMessage(m,messages)}),messages.sort(function(a,b){return!a.startDate||a.startDate>b.startDate?1:a.startDate&&a.startDate===b.startDate?0:-1}).reverse())},messages.clear=function(){messages.length=0,$log.debug("System message cleared.")},messages.registerRetriever=function(func){_retrievers.push(func)},messages.resetAndGetMessages=function(){messages.clear();var promises=_retrievers.map(function(func){return func.call()});return $q.all(promises).then(function(messageArrays){messageArrays.forEach(messages.addMessages)})},messages}])}(angular),angular.module("risevision.store.data-gadgets",[]).service("gadgetsService",["$q",function($q){this.closeIFrame=function(){var deferred=$q.defer();return gadgets.rpc.call("","rscmd_closeSettings",function(){deferred.resolve(!0)}),deferred.promise},this.sendProductCode=function(productCode){var deferred=$q.defer(),data={params:productCode};return gadgets.rpc.call("","rscmd_saveSettings",function(){deferred.resolve(!0)},data),deferred.promise}}]),angular.module("risevision.common.loading",["angularSpinner"]).value("_rvGlobalSpinnerRegistry",[]).service("$loading",["$q","$rootScope","$document","_rvGlobalSpinnerRegistry",function($q,$rootScope,$document,_rvGlobalSpinnerRegistry){function _addKeyToRegistry(key){_rvGlobalSpinnerRegistry.indexOf(key)<0&&_rvGlobalSpinnerRegistry.push(key)}function _removeKeyFromRegistry(key){var index;(index=_rvGlobalSpinnerRegistry.indexOf(key))>=0&&_rvGlobalSpinnerRegistry.splice(index,1)}var self=this;this.start=function(spinnerKeys){spinnerKeys=angular.isArray(spinnerKeys)?spinnerKeys:[spinnerKeys];for(var i=0;i<spinnerKeys.length;i++)$rootScope.$broadcast("rv-spinner:start",spinnerKeys[i])},this.stop=function(spinnerKeys){spinnerKeys=angular.isArray(spinnerKeys)?spinnerKeys:[spinnerKeys];for(var i=0;i<spinnerKeys.length;i++)$rootScope.$broadcast("rv-spinner:stop",spinnerKeys[i])},angular.element($document[0].body).append('<div rv-global-spinner class="ng-hide" style="position: fixed; width: 100%; height: 100%; top: 0; left: 0; z-index: 1040; "></div>'),this.startGlobal=function(spinnerKeys){spinnerKeys=angular.isArray(spinnerKeys)?spinnerKeys:[spinnerKeys],angular.forEach(spinnerKeys,function(key){_addKeyToRegistry(key)})},this.stopGlobal=function(spinnerKeys){spinnerKeys=angular.isArray(spinnerKeys)?spinnerKeys:[spinnerKeys],angular.forEach(spinnerKeys,function(key){_removeKeyFromRegistry(key)})},this.stopSpinnerAfterPromise=function(spinnerKeys,promises){spinnerKeys=angular.isArray(spinnerKeys)?spinnerKeys:[spinnerKeys];var stop=function(){for(var i=0;i<spinnerKeys.length;i++)$rootScope.$broadcast("rv-spinner:stop",spinnerKeys[i])},promise=angular.isArray(promises)?$q.all(promises):promises;promise.then(function(){stop()},function(){stop()})},this.getDefaultSpinnerOptions=function(){return self.defaultSpinnerOptions},this.defaultSpinnerOptions={lines:13,length:20,width:10,radius:30,corners:1,rotate:0,direction:1,color:"#555",speed:1,trail:60,shadow:!1,hwaccel:!1,className:"spinner",zIndex:2e9,top:"50%",left:"50%"}}]).directive("rvGlobalSpinner",["usSpinnerService","$compile","_rvGlobalSpinnerRegistry","$timeout","$rootScope",function(usSpinnerService,$compile,_rvGlobalSpinnerRegistry,$timeout,$rootScope){return{scope:!0,link:function(scope,$element){var tpl='<div ng-show="active" class="spinner-backdrop fade" ng-class="{in: active}" us-spinner="rvSpinnerOptions" spinner-key="_rv-global-spinner" ng-focus="spinnerFocused()"></div>';$element.prepend($compile(tpl)(scope)),scope.rvSpinnerOptions={lines:13,length:20,width:10,radius:30,corners:1,rotate:0,direction:1,color:"#555",speed:1,trail:60,shadow:!1,hwaccel:!1,className:"spinner",zIndex:2e9,top:"50%",left:"50%"},scope.registry=_rvGlobalSpinnerRegistry,scope.$watchCollection("registry",function(){scope.active=scope.registry.length>0?!0:!1}),scope.$watch("active",function(active){active?$element.removeClass("ng-hide"):$element.addClass("ng-hide")}),scope.spinnerFocused=function(){$rootScope.$broadcast("rv-spinner:global:focused")},$timeout(function(){usSpinnerService.spin("_rv-global-spinner")}),scope.active=!0}}}]).directive("rvSpinner",["usSpinnerService","$compile",function(usSpinnerService,$compile){return{scope:{backdropClass:"@rvSpinnerBackdropClass",rvSpinnerKey:"@rvSpinnerKey",rvSpinnerStartActive:"=?rvSpinnerStartActive",rvSpinnerOptions:"=rvSpinner"},link:function(scope,$element,iAttrs){scope.active=angular.isDefined(iAttrs.rvSpinnerStartActive)&&"1"===iAttrs.rvSpinnerStartActive;
var tpl='<div ng-show="active" class="spinner-backdrop fade {{backdropClass}}" ng-class="{in: active}" us-spinner="rvSpinnerOptions" spinner-key="{{rvSpinnerKey}}"';tpl+=iAttrs.rvSpinnerStartActive&&"1"===iAttrs.rvSpinnerStartActive?' spinner-start-active="1"></div>':"></div>",$element.prepend($compile(tpl)(scope)),scope.$on("rv-spinner:start",function(event,key){key===scope.rvSpinnerKey&&(usSpinnerService.spin(key),scope.active=!0)}),scope.$on("rv-spinner:stop",function(event,key){key===scope.rvSpinnerKey&&(usSpinnerService.stop(key),scope.active=!1)})}}}]),angular.module("checklist-model",[]).directive("checklistModel",["$parse","$compile",function($parse,$compile){function contains(arr,item){if(angular.isArray(arr))for(var i=0;i<arr.length;i++)if(angular.equals(arr[i],item))return!0;return!1}function add(arr,item){arr=angular.isArray(arr)?arr:[];for(var i=0;i<arr.length;i++)if(angular.equals(arr[i],item))return arr;return arr.push(item),arr}function remove(arr,item){if(angular.isArray(arr))for(var i=0;i<arr.length;i++)if(angular.equals(arr[i],item)){arr.splice(i,1);break}return arr}function postLinkFn(scope,elem,attrs){$compile(elem)(scope);var getter=$parse(attrs.checklistModel),setter=getter.assign,value=$parse(attrs.checklistValue)(scope.$parent);scope.$watch("checked",function(newValue,oldValue){if(newValue!==oldValue){var current=getter(scope.$parent);newValue===!0?setter(scope.$parent,add(current,value)):setter(scope.$parent,remove(current,value))}}),scope.$parent.$watch(attrs.checklistModel,function(newArr){scope.checked=contains(newArr,value)},!0)}return{restrict:"A",priority:1e3,terminal:!0,scope:!0,compile:function(tElement,tAttrs){if("INPUT"!==tElement[0].tagName||!tElement.attr("type","checkbox"))throw'checklist-model should be applied to `input[type="checkbox"]`.';if(!tAttrs.checklistValue)throw"You should provide `checklist-value`.";return tElement.removeAttr("checklist-model"),tElement.attr("ng-model","checked"),postLinkFn}}}]),angular.module("risevision.common.config").value("GAPI_CLIENT_ID","614513768474.apps.googleusercontent.com").value("GAPI_SCOPES","https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile").value("COOKIE_CHECK_URL","http://storage-dot-rvacore-test.appspot.com").value("STORAGE_URL","https://storage-dot-rvacore-test.appspot.com/_ah/api").value("STORAGE_API_URL","https://www.googleapis.com/download/storage/v1/b/").value("STORE_PRODUCT_CODE","b0cba08a4baa0c62b8cdc621b6f6a124f89a03db").value("STORE_PRODUCT_ID","24").value("STORAGE_CLIENT_API","https://www.googleapis.com/storage/v1/b/"),angular.module("storageFull",["angularSpinner","risevision.common.config","risevision.common.header","risevision.common.loading","risevision.common.i18n"]),angular.module("storageFull").controller("FullScreenController",["$scope","$location","$timeout","userState","usSpinnerService",function($scope,$location,$timeout,userState,usSpinnerService){$scope.userState=userState,$scope.currentState=null,$scope.navOptions=[{title:"Platform",link:"http://rva.risevision.com/",target:"_blank"},{title:"Help",link:"http://help.risevision.com/#/user/storage/what-is-storage",target:"_blank"}],$scope.$on("risevision.user.signedOut",function(){$location.path("/")}),$scope.$watch(function(){return userState.isLoggedIn()},function(loggedIn){loggedIn&&(usSpinnerService.spin("spn-stg-full"),$scope.currentState="loggingIn",$location.path("/"))}),$scope.$watch(function(){return userState.getSelectedCompanyId()},function(companyId){companyId?(usSpinnerService.stop("spn-stg-full"),$scope.currentState=null,$scope.loadStorageModal(companyId)):$scope.clearStorageContainer()}),$scope.clearStorageContainer=function(){$scope.backDrop&&($scope.storageModal.parentNode.removeChild($scope.storageModal),$scope.backDrop.parentNode.removeChild($scope.backDrop))},$scope.loadStorageModal=function(companyId){$scope.clearStorageContainer(),$scope.backDrop=document.createElement("div"),document.body.appendChild($scope.backDrop),$scope.storageModal=document.createElement("iframe"),$scope.storageModal.id="storage-modal-embedded",$scope.storageModal.name="storage-modal-embedded",$scope.storageModal.src="storage-modal.html#/files/"+companyId+"?storageFullscreen=true",$scope.storageModal.className="storage-selector-iframe-full",document.body.appendChild($scope.storageModal)}}]),angular.module("storageFull").directive("analytics",function(){return{restrict:"E",scope:{analyticsAccountId:"="},link:function(){!function(i,s,o,g,r,a,m){i.GoogleAnalyticsObject=r,i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date,a=s.createElement(o),m=s.getElementsByTagName(o)[0],a.async=1,a.src=g,m.parentNode.insertBefore(a,m)}(window,document,"script","//www.google-analytics.com/analytics.js","ga")},controller:["$scope","$window",function($scope,$window){$scope.$watch("analyticsAccountId",function(newId){newId&&$window.ga("create",$scope.analyticsAccountId,"auto")})}]}}),function(window,angular){"use strict";function isStringNumber(num){return/^-?\d+\.?\d*$/.test(num.replace(/["']/g,""))}var isDefined=angular.isDefined,isUndefined=angular.isUndefined,isNumber=angular.isNumber,isObject=angular.isObject,isArray=angular.isArray,extend=angular.extend,toJson=angular.toJson,fromJson=angular.fromJson,angularLocalStorage=angular.module("LocalStorageModule",[]);angularLocalStorage.provider("localStorageService",function(){this.prefix="ls",this.storageType="localStorage",this.cookie={expiry:30,path:"/"},this.notify={setItem:!0,removeItem:!1},this.setPrefix=function(prefix){return this.prefix=prefix,this},this.setStorageType=function(storageType){return this.storageType=storageType,this},this.setStorageCookie=function(exp,path){return this.cookie={expiry:exp,path:path},this},this.setStorageCookieDomain=function(domain){return this.cookie.domain=domain,this},this.setNotify=function(itemSet,itemRemove){return this.notify={setItem:itemSet,removeItem:itemRemove},this},this.$get=["$rootScope","$window","$document","$parse",function($rootScope,$window,$document,$parse){var webStorage,self=this,prefix=self.prefix,cookie=self.cookie,notify=self.notify,storageType=self.storageType;$document?$document[0]&&($document=$document[0]):$document=document,"."!==prefix.substr(-1)&&(prefix=prefix?prefix+".":"");var deriveQualifiedKey=function(key){return prefix+key},browserSupportsLocalStorage=function(){try{var supported=storageType in $window&&null!==$window[storageType],key=deriveQualifiedKey("__"+Math.round(1e7*Math.random()));return supported&&(webStorage=$window[storageType],webStorage.setItem(key,""),webStorage.removeItem(key)),supported}catch(e){return storageType="cookie",$rootScope.$broadcast("LocalStorageModule.notification.error",e.message),!1}}(),addToLocalStorage=function(key,value){if(isUndefined(value)?value=null:(isObject(value)||isArray(value)||isNumber(+value||value))&&(value=toJson(value)),!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),notify.setItem&&$rootScope.$broadcast("LocalStorageModule.notification.setitem",{key:key,newvalue:value,storageType:"cookie"}),addToCookies(key,value);try{(isObject(value)||isArray(value))&&(value=toJson(value)),webStorage&&webStorage.setItem(deriveQualifiedKey(key),value),notify.setItem&&$rootScope.$broadcast("LocalStorageModule.notification.setitem",{key:key,newvalue:value,storageType:self.storageType})}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),addToCookies(key,value)}return!0},getFromLocalStorage=function(key){if(!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),getFromCookies(key);var item=webStorage?webStorage.getItem(deriveQualifiedKey(key)):null;return item&&"null"!==item?"{"===item.charAt(0)||"["===item.charAt(0)||isStringNumber(item)?fromJson(item):item:null},removeFromLocalStorage=function(key){if(!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),notify.removeItem&&$rootScope.$broadcast("LocalStorageModule.notification.removeitem",{key:key,storageType:"cookie"}),removeFromCookies(key);try{webStorage.removeItem(deriveQualifiedKey(key)),notify.removeItem&&$rootScope.$broadcast("LocalStorageModule.notification.removeitem",{key:key,storageType:self.storageType})}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),removeFromCookies(key)}return!0},getKeysForLocalStorage=function(){if(!browserSupportsLocalStorage)return $rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),!1;var prefixLength=prefix.length,keys=[];for(var key in webStorage)if(key.substr(0,prefixLength)===prefix)try{keys.push(key.substr(prefixLength))}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.Description),[]}return keys},clearAllFromLocalStorage=function(regularExpression){regularExpression=regularExpression||"";var tempPrefix=prefix.slice(0,-1),testRegex=new RegExp(tempPrefix+"."+regularExpression);if(!browserSupportsLocalStorage||"cookie"===self.storageType)return browserSupportsLocalStorage||$rootScope.$broadcast("LocalStorageModule.notification.warning","LOCAL_STORAGE_NOT_SUPPORTED"),clearAllFromCookies();var prefixLength=prefix.length;for(var key in webStorage)if(testRegex.test(key))try{removeFromLocalStorage(key.substr(prefixLength))}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),clearAllFromCookies()}return!0},browserSupportsCookies=function(){try{return $window.navigator.cookieEnabled||"cookie"in $document&&($document.cookie.length>0||($document.cookie="test").indexOf.call($document.cookie,"test")>-1)}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),!1}}(),addToCookies=function(key,value){if(isUndefined(value))return!1;if((isArray(value)||isObject(value))&&(value=toJson(value)),!browserSupportsCookies)return $rootScope.$broadcast("LocalStorageModule.notification.error","COOKIES_NOT_SUPPORTED"),!1;try{var expiry="",expiryDate=new Date,cookieDomain="";if(null===value?(expiryDate.setTime(expiryDate.getTime()+-864e5),expiry="; expires="+expiryDate.toGMTString(),value=""):0!==cookie.expiry&&(expiryDate.setTime(expiryDate.getTime()+24*cookie.expiry*60*60*1e3),expiry="; expires="+expiryDate.toGMTString()),key){var cookiePath="; path="+cookie.path;cookie.domain&&(cookieDomain="; domain="+cookie.domain),$document.cookie=deriveQualifiedKey(key)+"="+encodeURIComponent(value)+expiry+cookiePath+cookieDomain}}catch(e){return $rootScope.$broadcast("LocalStorageModule.notification.error",e.message),!1}return!0},getFromCookies=function(key){if(!browserSupportsCookies)return $rootScope.$broadcast("LocalStorageModule.notification.error","COOKIES_NOT_SUPPORTED"),!1;for(var cookies=$document.cookie&&$document.cookie.split(";")||[],i=0;i<cookies.length;i++){for(var thisCookie=cookies[i];" "===thisCookie.charAt(0);)thisCookie=thisCookie.substring(1,thisCookie.length);if(0===thisCookie.indexOf(deriveQualifiedKey(key)+"=")){var storedValues=decodeURIComponent(thisCookie.substring(prefix.length+key.length+1,thisCookie.length));try{var obj=JSON.parse(storedValues);return fromJson(obj)}catch(e){return storedValues}}}return null},removeFromCookies=function(key){addToCookies(key,null)},clearAllFromCookies=function(){for(var thisCookie=null,prefixLength=prefix.length,cookies=$document.cookie.split(";"),i=0;i<cookies.length;i++){for(thisCookie=cookies[i];" "===thisCookie.charAt(0);)thisCookie=thisCookie.substring(1,thisCookie.length);var key=thisCookie.substring(prefixLength,thisCookie.indexOf("="));removeFromCookies(key)}},getStorageType=function(){return storageType},bindToScope=function(scope,key,def,lsKey){lsKey=lsKey||key;var value=getFromLocalStorage(lsKey);return null===value&&isDefined(def)?value=def:isObject(value)&&isObject(def)&&(value=extend(def,value)),$parse(key).assign(scope,value),scope.$watch(key,function(newVal){addToLocalStorage(lsKey,newVal)},isObject(scope[key]))},lengthOfLocalStorage=function(){for(var count=0,storage=$window[storageType],i=0;i<storage.length;i++)0===storage.key(i).indexOf(prefix)&&count++;return count};return{isSupported:browserSupportsLocalStorage,getStorageType:getStorageType,set:addToLocalStorage,add:addToLocalStorage,get:getFromLocalStorage,keys:getKeysForLocalStorage,remove:removeFromLocalStorage,clearAll:clearAllFromLocalStorage,bind:bindToScope,deriveKey:deriveQualifiedKey,length:lengthOfLocalStorage,cookie:{isSupported:browserSupportsCookies,set:addToCookies,add:addToCookies,get:getFromCookies,remove:removeFromCookies,clearAll:clearAllFromCookies}}}]})}(window,window.angular);
//# sourceMappingURL=script/full-main.min.js.map